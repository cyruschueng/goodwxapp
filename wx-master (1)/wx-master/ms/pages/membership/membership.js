...
Page({
  ...
  onShow: function () {
    ...
    if (wx.getStorageSync("userToMember")) {
      ...
      if (wx.getStorageSync("order") == 7 ) {
        that.setData({
          sort: "account"
        })
      } else if (wx.getStorageSync("order") == 6) {
        that.setData({
          sort: "two_sdl"
        })
      } else if (wx.getStorageSync("order") ==5) {
        that.setData({
          sort: "one_sdl"
        })
      } else if (wx.getStorageSync("order") ==4) {
        that.setData({
          sort: "two_jms"
        })
      } else if (wx.getStorageSync("order") == 3) {
      ...
      } else if (wx.getStorageSync("order") == 0) {
        that.setData({
          sort: "one_shr"
        })
      }
