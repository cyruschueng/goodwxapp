...
Page({
  data: {
    ...
    bot:[
      {
        "url": "",
        "src": "../../images/index/fk.png",
        "txt": "银行风控",
        "txt1": "确保账户安全"
      },
      {
        "url": "",
        "src": "../../images/index/picc.png",
        "txt": "中国人保",
        "txt1": "承保账户安全"
      },
      {
        "url": "",
        "src": "../../images/index/qw.png",
        "txt": "权威便捷",
        "txt1": "阿里系战略合作"
      }
    ],
    ...
    nav1: [
      ...
      {
        "url": "kami",
        "src": "../../images/index/kami.png",
        "txt": "分发卡觅"
      },
      {
        "url": "applyCard",
        "src": "../../images/index/applyCard.png",
        "txt": "申请信用卡"
      },
       {
        "url": "qd",
        "src": "../../images/index/qd.png",
        "txt": "敬请期待"
      }
    ]
  },
  ...
  onSkip: function (e) {
    ...
    if (wx.getStorageSync("uid")) {
      if (wx.getStorageSync("userData").realname) {
        //限制进入智能账单,合作伙伴
        if (title == "smartBill" && that.data.method == 1 || title == "qd" || title == "tutorial") {
          wx.showToast({
            title: '敬请期待',
  ...
  onShow: function () {
    ...
    //查询个人详情
    urlData.personaInfo(that, wx.getStorageSync("uid"), that.data.userData, that.data.display, that.data.phone, that.data.mer, that.data.show,that.data.sort)
    //公告---暂时不要
