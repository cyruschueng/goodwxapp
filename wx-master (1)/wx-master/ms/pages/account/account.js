...
Page({
  ...
  data: {
    ...
    func : [
      ...
      {
        "url": "baodan",
        "src": "../../images/account/baodan.png",
        "txt": "我的保单",
        "arrowSrc": "../../images/account/5.png"
      },
      {
        "url": "about",
        "src": "../../images/account/6.png",
        "txt": "关于觅舒",
        "arrowSrc": "../../images/account/5.png"
      },
      {
        "url": "yinan",
        "src": "../../images/account/yinan.png",
        "txt": "疑难解答",
        "arrowSrc": "../../images/account/5.png"
      },
      ...
      {
        "url": "center",
        "src": "../../images/account/10.png",
        "txt": "推广中心",
        "arrowSrc": "../../images/account/5.png"
      },
      {
        "url": "tele",
        "src": "../../images/account/9.png",
        "txt": "400电话",
        "arrowSrc": "../../images/account/5.png"
      }
    ...
    if (wx.getStorageSync("uid")){
      if (wx.getStorageSync("realName")) {
        if(title=="tele"){
          wx.showModal({
            title: '提示',
            content: "您是否拨打4001166311",
            success: function (res) {
              if (res.confirm) {
                console.log('用户点击确定')
                wx.makePhoneCall({
                  phoneNumber: "4001166311",
                  success: function (res) {
                    console.log(res)
                  }
                })
