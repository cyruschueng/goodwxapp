...
Page({
  data: {
    ...
    nav1: [
      {
        "url": "bill",
        "src": "../../images/index/my_repayment.png",
        "txt": "我的还款"
      },
      {
        "url": "detailOrder",
      ...
      {
        "url": "card",
        "src": "../../images/index/mangeCard.png",
        "txt": "信用卡管理"
      },

      {
        "url": "Instructions",
        "src": "../../images/index/Instructions.png",
        "txt": "使用教程"
      },
      {
        "url": "partner",
        "src": "../../images/index/partner.png",
        "txt": "合作伙伴"
      },
      {
        "url": "news",
  ...
  onSkip: function (e) {
    ...
    if (wx.getStorageSync("uid")) {
      if (wx.getStorageSync("userData").realname) {
        //限制进入智能账单,合作伙伴
        if (title == "Instructions" || title == "partner" || title =="news") {
          wx.showToast({
            title: '敬请期待',
            image: "../../images/icon/s.png",
            duration: 1000,
          ...
          wx.setStorageSync("navOrder",index)
        }
