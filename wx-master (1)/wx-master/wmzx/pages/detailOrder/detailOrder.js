      ...
      if (res.data.CODE == "00") {
        ...
        if (res.data.data.length) {
          for (var i = 0; i < res.data.data.length; i++) {
            ...
            var length = res.data.data[i].bankCard.length
            res.data.data[i].bankCard = res.data.data[i].bankCard.slice(length - 4, length)
          }
          if (that.data.page <= 1) {
            that.setData({
...
var Money = function(that){
  console.log(that.data.detailOrderList)
  console.log(that.data.index)
  console.log(that.data.detailOrderList[that.data.index].id)
  var str = {
    "OperationType": "10035",
    "BO_ID": that.data.detailOrderList[that.data.index].id
  }
