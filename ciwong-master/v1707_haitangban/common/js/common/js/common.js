...
var $common = {
	...
	shareUrl:function(score){
		...
		ciwongPlugin && ciwongPlugin.createEvent('GetShareInfo' , [{source:3,url:url,title:document.title,moduleId:moduleId,score:score||0}] ,function( response ){
			log = '返回分享链接'
