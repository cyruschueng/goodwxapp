...
require.config({
    ...
    paths: {
        ko: ["knockout-3.0.1"],
        ciwong: ["ciwong.extends"],
        jquery: ["jquery-1.8.0.min"],
        paper: ["epaper.onlinepaper"],
        question: ["epaper.question"],
        questionDoTemplate: ["./template/question.do.template"],
        questionResultTemplate: ["./template/question.result.template"],
        correct: ["epaper.question.correct"],
        cordova: ["../cordova"]
    },
    nodeIdCompat: 7,
    urlArgs: ""
