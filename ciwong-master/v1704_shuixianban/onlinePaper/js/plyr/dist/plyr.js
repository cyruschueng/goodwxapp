        ...
        function _buildControls() {
            ...
            if (_inArray(config.controls, 'fast-forward')) {
                html.push(
                    ...
                    '<i class="plyr plyr-fastforward"></i>',
            ...
            if (_inArray(config.controls, 'mute')) {
                html.push(
                    ...
                    '<i class="icon--muted plyr plyr-muted"></i>',
                    '<i class="plyr plyr-volume"></i>',
            ...
            if (_inArray(config.controls, 'captions')) {
                html.push(
                    ...
                    '<i class="plyr plyr-captionson icon--captions-on"></i>',
                    '<i class="plyr plyr-captionsoff"></i>',
            ...
            if (_inArray(config.controls, 'fullscreen')) {
                html.push(
                    ...
                    '<i class="plyr plyr-exitfullscreen icon--exit-fullscreen"></i>',
                    '<i class="plyr plyr-enterfullscreen"></i>',
