...
function onlineLoadComponent(Vue){
        ...
        <div v-for="data in attachments">\
            <div v-if="data.file_url">\
                ...
                <div class="video pr mt30" v-if="data.file_type == 3 && data.file_url.indexOf(\'letv://\')>-1">\
                    <iframe style="width:6.7rem;height:3.77rem;" :src="\'http://yuntv.letv.com/bcloud.html?uu=2bfc338ed7&vu=\'+data.file_url.replace(\'letv://\',\'\')+\'&width=100%&height=100%&pu=B6999F08EC\'" frameborder=0 allowfullscreen></iframe>\
                </div>\
            </div>\
        </div>\
        ',props:['attachments']})
        ...
        <div>\
            <div class="mt30 plr30 bdt1-f1f0ec" v-if="showrefanswers && question.ref_info && question.ref_info.answers && question.ref_info.answers.length>0">\
                ...
                <div class="green mt20">\
                    ...
                    <div class="inline" v-if="question.qtype==3" v-for="val in question.ref_info.answers">{{$index!=0? \'；\':\'\'}}<div class="inline" v-html="val | fillingRefAnswer"></div></div>\
    ...
    Vue.component('assesshtml',{template:'\
        <div><div class="tit2 mt30" v-if="!hidescore">\
            ...
            <span class="fs-24 col-808080" v-else>(<span class="col-red" v-html="parseFloat( (question.userAnswer && question.userAnswer.score).toFixed(2) ) || 0"></span>分/{{parseFloat(question.question_ref_sorce)}}分)</span>\
        </div></div>\
        ...
        <div>\
            <div class="mlr30">\
                ...
                <div v-for="option in question.options">\
                    <div class="anw" v-if="option.answerType==3"><div class="photoanswer"></div><img class="photoanswer-img" :src="option.content" onclick="hammerClass(this)" alt=""/></div>\
                    <textarea class="anw" readonly="readonly" v-else v-html="option.content"></textarea>\
                </div>\
            </div>\
            <refinfo :question="question" :showrefanswers="showrefanswers"></refinfo>\
        </div>\
