function AudioClass(audioBox){
    var ProgressBar = $(audioBox).children('.taskBoxLinks').get(0);
    var timer,
    _self = this,
    isPlay=false,
    firstPlay=true,
    ...
    // 点击播放
    audioBox.addEventListener('touchstart',function(e){
        // if(!canClick) return;
        // canClick=false;
        // setTimeout(function(){canClick=true},1000)
        // alert(1)
        audioBtn.hasClass('audio-loading') && audioBtn.removeClass('audio-loading');
        // 暂停所有audio
