function AudioClass(ProgressBar){
    ...
    _self.play = function(){
        ...
        timer = setTimeout(function(){
            if(!currAudio.isLoaded) _self.playNext(index);
        },10000)
    }
    // 暂停
    ...
    function removeLoadListener(index){
        setTimeout(function(){
            _list[index] && _list[index].removeEventListener('error',loadError,false)
        },5000)
    }
