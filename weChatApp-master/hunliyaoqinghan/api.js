...
function yaoqinghanget(id,successCB,failCB) {
  var key = 'cache_yaoqinghan';
  if(wc.get(key)){
    successCB(wc.get(key));
  }else{
    system.myRequest('https://ai.maiyizhi.cn/producter/php/frontend/web/index.php?r=data/default/yaoqinghanget',
      {
        id:id
      },successCB,failCB,key,600);
  }
}
...
function yaoqinghanset(id,name,avatar, successCB,failCB) {
  system.myRequest('https://ai.maiyizhi.cn/producter/php/frontend/web/index.php?r=data/default/yaoqinghanset',
    {
      id:id,
      name: name,
      avatar: avatar,
...
//name :当前用户的name
//width: 二维码宽度
function yaoqinghanqrcode(id, name, width, successCB, failCB) {
  system.myRequest('https://ai.maiyizhi.cn/producter/php/frontend/web/index.php?r=data/default/yaoqinghanqrcode',
    {
      id:id,
      name:name,
      width:width
        ...
        wx.getUserInfo({
          success: function (res) {
            ...
            that.getLoginApi(code, rawData, signature, encryptedData, iv, function (info) {
              var _user={'openid':info.id,'user_name':res.userInfo.nickName,'avatar':res.userInfo.avatarUrl};
...
module.exports = {
  yaoqinghanget:yaoqinghanget,
  yaoqinghanset:yaoqinghanset,
  yaoqinghanqrcode:yaoqinghanqrcode,
