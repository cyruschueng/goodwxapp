...
function ScreenshotDeal(pic,systeminfo,cat,title,time,has_pay,successCB,failCB) {
...
function koutu(imageUrl, successCB,failCB) {
    system.myRequest('https://ai.maiyizhi.cn/producter/php/frontend/web/index.php?r=distinguishPic/default/human-body-segment',
        {
            image_url: imageUrl
        },successCB,failCB);
}
