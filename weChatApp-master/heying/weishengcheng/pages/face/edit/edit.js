...
Page(Object.assign({}, Zan.Toast, {
  ...
  onLoad: function (options) {
    ...
    if(options.scene){
      ...
      api.zhuangxinfo(id, function(res) {
        ...
        setTimeout(function(){
          wx.navigateTo({
            url: "/pages/zhuangx/list/list?type=3"
          })
        },1500);
      });
    }else{
      item = wx.getStorageSync('current_face_template');
      this.commonPart();
    }
  },
  ...
  afterAvatarChoose: function (localPic) {
    wx.navigateTo({
      url: '/pages/cutInside/cutInside?src='+localPic+'&model='+this.data.select+'&source='+1
    })
  },
