...
var imgData = require('../../../utils/peopleFilter.js')
...
Page(Object.assign({}, Zan.Toast, {
  ...
  afterAvatarChoose: function (localPic) {
    wx.navigateTo({
      url: '/pages/cutInside/cutInside?src='+localPic+'&model='+this.data.select+'&type='+this.data.type+'&source='+4
    })
  },
