...
Page(Object.assign({}, Zan.Tab, {
  ...
  onShareAppMessage: function () {
    if(type==2) {
      return {
        title: '疯狂变脸',
        path: "/pages/zhuangx/list/list?type=2"
      }
    }else if(type==1){
      return {
        title: '快来装X吧',
          ...
          console.log(res.list)
            ...
            if(currentPage == 1){
                that.data.list = [{
                  ...
                  avatar:{
                    height:400,
                    url:"http://icons.maiyizhi.cn/danliao1.png",
                    width:400
                  }
                },
                  {
                    ...
                    avatar:{
                      height:400,
                      url:"http://icons.maiyizhi.cn/qunliao1.png",
                      width:400
                    }
                  },
                  {
                    ...
                    avatar:{
                      height:400,
                      url:"http://icons.maiyizhi.cn/xiangqing1.png",
                      width:400
                    }
                  },
                  {
                    ...
                    avatar:{
                      height:400,
                      url:"http://icons.maiyizhi.cn/pengyouquan1.png",
                      width:400
                    }
                  }]
            }
