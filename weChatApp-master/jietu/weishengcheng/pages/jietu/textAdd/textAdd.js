...
Page(Object.assign({}, Zan.Toast, {
  ...
  onLoad: function (options) {
    ...
    init:function(){
      ...
      console.log(_app[type].users)
      console.log(_app[type].list[index])
    ...
    bindContent:function (e) {
        this.data[app][type].list[index].content = e.detail.value
  ...
  switchChange:function (e) {
    ...
    formSubmit: function (e) {
        ...
        if(!_app[type].list[index].content){
    ...
    edit:function () {
        editUser.edit(app, type, "textAdd");
    },
