...
using System.Linq;
using System.Web;
using SfSoft.web.wxpay.Activity315;

namespace SfSoft.web.wxpay.activity.server
{
    /// <summary>
    /// _315 的摘要说明
    /// </summary>
    public class _315 : IHttpHandler
    {
        ...
        private string Add(HttpContext context)
        {
            ...
            /**/
            EnumActivity315 enumActivity315 = wxpay.Activity315.Helper.GetBuyState();
            if (price == "315" && EnumActivity315.Activity315 != enumActivity315) {
                return MsgResult("315", "3.15已抢光");
            }
            else if (price == "9900" && EnumActivity315.Activity9900 != enumActivity315) {
                return MsgResult("9900", "99.00已抢光");
            }
