<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestJsApi.aspx.cs" Inherits="SfSoft.web.TestJsApi" %>
...
<body>
                    ...
                    <li class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col-xs-8 text-right">
                                <a href="#editaddress" class=" btn btn-xs btn-default" id="btnEditAddress">选择与编辑收货信息</a>
                            </div>
                        </div>
                    </li>
                    <li class="list-group-item">
    ...
    <!--<script src="../js/testpay.js" type="text/javascript"></script>-->
    <script>
    /*
        var wxJsPayApiParam = jQuery.parseJSON('<%=wxJsPayApiParam %>');
        alert(JSON.stringify(wxJsPayApiParam));
    */
    </script>
