<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qzsf.aspx.cs" Inherits="SfSoft.web.wxpay.order.qzsf" %>
...
<body>
    ...
    <script src="/app/pay/js/qzsf.js" type="text/javascript"></script>
    <script src="/app/pay/js/address.js" type="text/javascript"></script>
    <script>
        var wxJsPayApiParam = jQuery.parseJSON('<%=wxJsPayApiParam %>');
        $("#btnEditAddress").shenerAddress({
            bodyId: "#form1",
            latestAddress: {
                "serverpath": "/app/pay/server/address.ashx?type=latest",
                "openid": $("#hfOpenId").val(),
            ...
            saveAddress: {
                "serverpath": "/app/pay/server/address.ashx?type=add",
                "openid": $("#hfOpenId").val()
            },
            getAllAddress: {
                "serverpath": "/app/pay/server/address.ashx?type=list",
                "openid": $("#hfOpenId").val()
            },
            setLatestAddress: {
                "serverpath": "/app/pay/server/address.ashx?type=set",
                "openid": $("#hfOpenId").val()
            }
        });
    </script>
