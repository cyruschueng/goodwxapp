    ...
    public class Userinfo : IHttpHandler
    {
        ...
        private void GetOpenidAndAccessToken(HttpContext context)
        {
            ...
            if (!string.IsNullOrEmpty(code))
            {
                ...
                SfSoft.Model.WX_UserInfo userInfo = userInfoProvide.AddGardeniaUser(userInfoProvide.ConvertToUserInfo(jsonUserInfo), param.GetQuery("a"), param.GetQuery("id"));
        ...
        {
            string url = string.Format("https://api.weixin.qq.com/sns/oauth2/access_token?appid={0}&secret={1}&code={2}&grant_type=authorization_code", WxBaseConfig.GxAppID, WxBaseConfig.GxAppSecret, code);
