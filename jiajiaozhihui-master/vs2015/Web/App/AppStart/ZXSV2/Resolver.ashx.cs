...
namespace SfSoft.web.AppStart.ZXSV2
{
    /// <summary>
    /// Resolver 的摘要说明
    /// </summary>
    public class Resolver : IHttpHandler
    {
        ...
        private string Out(HttpContext context)
        {
            ...
            try
            {
                ...
                var other = new {
                    ZxsInfo= SfSoft.web.ZXS.Helper.InitZxsProvide.GetZxsInfo(query.GetQuery("a")),
                    ZxsPlayer = SfSoft.web.ZXS.Helper.InitZxsProvide.GetZxsPlayer(query.GetQuery("a"), query.GetQuery("o")),
