...
namespace SfSoft.web.AppStart.ReadV2
{
    /// <summary>
    /// Resolver 的摘要说明
    /// </summary>
    public class Resolver : IHttpHandler
    {
        ...
        private string Out(HttpContext context)
        {
            ...
            try
            {
                ...
                var other = new {
                    ReadInfo= web.Read.Helper.InitReadProvide.GetReadInfo(query.GetQuery("a")),
                    ReadUserInfo= web.Read.Helper.InitReadProvide.GetReadUserInfo(query.GetQuery("a"), query.GetQuery("o")),
                    Award= web.Read.Helper.InitReadProvide.GetAwardList(query.GetQuery("o"))
                };
                ...
                #region 注册用户信息
                SfSoft.web.Read.Helper.InitReadProvide.RegistUser(query.GetQuery("a"), query.GetQuery("o"));
                #endregion
