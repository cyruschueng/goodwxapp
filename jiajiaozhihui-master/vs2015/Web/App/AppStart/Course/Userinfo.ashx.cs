    ...
    public class Userinfo : IHttpHandler
    {
        ...
        private void GetOpenidAndAccessToken(HttpContext context)
        {
            ...
            if (!string.IsNullOrEmpty(code))
            {
                ...
                //加密
                //string o = App.Helper.EncryptUtils.DESEncrypt(Newtonsoft.Json.JsonConvert.SerializeObject(wxParams, new Newtonsoft.Json.JsonSerializerSettings() { ContractResolver = new App.Helper.UnderlineSplitContractResolver() }), WxBaseConfig.DESEncryptKey, WxBaseConfig.DESEncryptIv);
