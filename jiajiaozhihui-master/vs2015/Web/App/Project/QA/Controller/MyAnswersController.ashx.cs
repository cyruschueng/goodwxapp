...
{
    /// <summary>
    /// MyAnswersController 的摘要说明
    /// </summary>
    public class MyAnswersController : IHttpHandler
    {
        ...
        private void Get(HttpContext context)
        {
            ...
            string where = "exists(select 1 from WX_QA_Comment where WX_QA_File.Id=ReadFileId  and OpenId='" + openId + "' ) and Status=1";
