...
namespace SfSoft.web.Read.Helper
{
    ...
    {
        public static SfSoft.Model.WX_Read_User GetReadUser(string appId, string openId)
        {
        ...
        public static void UpdateNumber(string appId)
        {
            ...
            SfSoft.Model.WX_Read_Info model = bll.GetModelList("").AsEnumerable().FirstOrDefault(e => e.AppId == appId);
