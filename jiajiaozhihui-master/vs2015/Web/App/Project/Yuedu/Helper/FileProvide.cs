...
namespace SfSoft.web.Yuedu.Helper
{
    public class FileProvide
    {
        ...
        private static string ImageDomainName = ConfigurationManager.AppSettings["YueduImageDomainName"];
        private static string VoiceDomainName = ConfigurationManager.AppSettings["YueduVoiceDomainName"];
        private static string VoiceDomainNameMp3 = ConfigurationManager.AppSettings["YueduVoiceDomainNameMp3"];
        ...
        {
            SfSoft.BLL.WX_Yuedu_File_Data bll = new SfSoft.BLL.WX_Yuedu_File_Data();
            SfSoft.Model.WX_Yuedu_File_Data model = bll.GetModel(taskId);
            if (taskType == 1) {
        ...
        public string StorePath(int taskType)
        {
            ...
            {
                case 1:
                    path = System.Web.HttpContext.Current.Server.MapPath("~/Files/yuedu/images/");
                    break;
                case 2:
                    path = System.Web.HttpContext.Current.Server.MapPath("~/Files/yuedu/voices/");
                    break;
                default:
                    path = "";
                    break;
