...
namespace SfSoft.web.Yuedu.Helper
{
    ...
    {
        public static SfSoft.Model.WX_Yuedu_Info GetReadInfo(string appId)
        {
        ...
        public static SfSoft.Model.WX_Yuedu_User GetReadUserInfo(string appId, string openId)
        {
        ...
        {
            SfSoft.BLL.WX_Yuedu_Award bll = new BLL.WX_Yuedu_Award();
            Models.Award.AwardInfo awardInfo = new Models.Award.AwardInfo();
             ...
             if (list.Count != 0)
             {
                 ...
                 Model.WX_Yuedu_Grade grade = GetGradeList(awardInfo.Integral);
        ...
        public static void RegistUser(string appId, string openId)
        {
            ...
            if (wxUser != null) {
                ...
                if (readUser == null) {
                    SfSoft.BLL.WX_Yuedu_User bll = new SfSoft.BLL.WX_Yuedu_User();
                    SfSoft.Model.WX_Yuedu_User model = new Model.WX_Yuedu_User();
                    model.AppId = appId;
                    model.IsAct = 1;
                    model.OpenId = openId;
        ...
        private static SfSoft.Model.WX_Yuedu_Grade GetGradeList(int integral)
        {
            SfSoft.BLL.WX_Yuedu_Grade bll = new BLL.WX_Yuedu_Grade();
            ...
            if (model != null)
            {
                ...
                return new Model.WX_Yuedu_Grade();
            }
        }
    }
}