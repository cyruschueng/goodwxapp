app.factory('initService', ['$http', '$q', 'localStorageService', function ($http, $q, localStorageService) {
    ...
    var _init = function () {
        ...
        var url = "http://161s5g6007.51mypc.cn/app/appstart/Basic/Resolver.ashx"
...
app.factory('homeService', ['$http', '$q', 'cacheService', function ($http, $q, cacheService) {
    ...
    var _exist = function () {
        var deferred = $q.defer();
        var url = "http://161s5g6007.51mypc.cn/app/project/online/controller/HomeController.ashx?method=exist";
        $http({
            method: 'POST',
            url: url,
            headers: {
                ...
                return $.param({ openid: base.info.openId, type: base.info.objectId });
            }
        }).success(function (response) {
            deferred.resolve(response);
        }).error(function (err, status) {
    ...
    var _add = function (username,telephone) {
        var deferred = $q.defer();
        var url = "http://161s5g6007.51mypc.cn/app/project/online/controller/HomeController.ashx?method=add";
        $http({
            method: 'POST',
            url: url,
            headers: {
                ...
                return $.param({ openid: base.info.openId, userName: username, telephone: telephone, type: base.info.objectId });
            }
        }).success(function (response) {
            deferred.resolve(response);
        }).error(function (err, status) {
