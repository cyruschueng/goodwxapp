...
namespace SfSoft.web.WxOpen.Provide.Habit
{
    public class Comment
    {
        ...
        /// <returns></returns>
        public int  AddComment(string comment,int detailId,string openId,int habitId,int groupId)
        {
        ...
        /// <param name="openId"></param>
        /// <returns></returns>
        public int RePlyComment(string comment, int detailId,int commentId, string openId,int habitId,int groupId)
        {
            BLL.wx_habit_comment bll = new BLL.wx_habit_comment();
