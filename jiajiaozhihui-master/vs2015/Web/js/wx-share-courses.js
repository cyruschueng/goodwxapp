var imgUrl = "http://weixin.shenertingduji.com/images/card.jpg";  //注意必须是绝对路径
       ...
       var id=document.getElementById("hfCoursesid").value;

       var lineLink = "http://192.168.100.179/courses.aspx?openid="+openid+"&id="+id;   //同样，必须是绝对路径
       var descContent = '【家教智慧】书法课堂'; //分享给朋友或朋友圈时的文字简介
       var shareTitle = '【家教智慧】书法课堂';  //分享title
       var appid = ''; //apiID，可留空
