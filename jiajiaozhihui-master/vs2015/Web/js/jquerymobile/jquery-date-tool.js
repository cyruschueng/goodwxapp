...
(function($, undefined) {
					...
					DateTool.prototype,
					{
						parseDate : function(format, value, settings) {
							...
							if (doy > -1) {
								...
								day = doy;
								do {
									var dim = $.dateTool._getDaysInMonth(year,
											month - 1);
									if (day <= dim)
										break;
									month++;
	...
	$.dateTool = new DateTool(); // singleton instance
