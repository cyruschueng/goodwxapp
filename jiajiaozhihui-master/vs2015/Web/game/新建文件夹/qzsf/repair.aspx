<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="repair.aspx.cs" Inherits="SfSoft.web.game.qzsf.repair" %>
                ...
                <form  runat="server">
                    ...
                    <div class=" form-group" >
                        ...
                        <div class=" col-xs-6 text-center" style=" margin-bottom:15px;">
                            <a id="Span1" href="<%=HTMLLink.CommunityLink %>" class="btn btn-success glyphicon glyphicon-ok">进入亲子书法圈</a>
                        </div>
                    </div>
