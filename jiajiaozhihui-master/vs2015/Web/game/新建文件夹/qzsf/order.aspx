<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order.aspx.cs" Inherits="SfSoft.web.game.qzsf.order" %>
...
-->
        ...
        <div class="row" id="go">
            ...
            <div class="col-xs-12 ">
                <p class=" bg-info" style=" font-size:16px; color:#f00;">学习保证金：￥<span id="txtUnitPrice"><%=HTMLUnitPrice%></span></p>
            </div>
            <div class="col-xs-12">
        ...
        <div class="row">
            <div class=" col-xs-12">
                <div class="col-xs-12" style=" margin-top:15px;">
             	    <div  class=" alert alert-danger">*注：《国学经典书法教材》（一套10册）定价为198元，您只需支付&nbsp;<span style="color:#f00; font-size:16px;"><b><%=HTMLUnitPrice%></b></span>&nbsp;元的学习保证金(包邮)。</div> 
                 </div>
                <ul id="myTab" class="nav nav-tabs">
                   <li class="active"><a data-toggle="tab" href="#home">货到付款</a></li>
                   <li ></li>
		  <!--<a  href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxa0f624ad8cdb46c4&redirect_uri=http%3A%2F%2Fweixin.jiajiaozhihui.cn%2Fwxpay%2Forder%2Fqzsf.aspx&response_type=code&scope=snsapi_base&state=123456789&connect_redirect=1#wechat_redirect" >在线支付</a>-->	
                </ul>
