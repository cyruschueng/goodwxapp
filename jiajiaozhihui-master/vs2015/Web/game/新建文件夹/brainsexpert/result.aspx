<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="result.aspx.cs" Inherits="SfSoft.web.game.brainsexpert.result" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../js/result.js?t=1" type="text/javascript"></script>
		    ...
		    <div class="span12">
                <div >
                    ...
                    <div id="result-do" >
                        ...
                        <a id="btnOther"   href="<%=HTMLNext %>" class="button button-3d button-action button-pill" style=" background:#ffffff; box-shadow: 0px 7px 0px #425980, 0px 8px 3px rgba(0, 0, 0, 0.3); color:#000; margin-right:10px;">换个话题</a>
                        ...
                        <input type="button" id="btnExchange" runat="server"  class="button button-3d button-action button-pill" style=" background:#ff7502; box-shadow: 0px 7px 0px #964502, 0px 8px 3px rgba(0, 0, 0, 0.3);" value="金币兑换" />
                    </div>
                </div>
		    </div>
	    </div>
...
<script>
    ...
    shareTitle="我在《国学达人》中已晋升为【<%=HTMLGradeName %>】,获得<%=HTMLGold %>个金币,快来挑战我吧!"
