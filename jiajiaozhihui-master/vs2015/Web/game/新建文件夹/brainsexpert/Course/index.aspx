<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="SfSoft.web.game.brainsexpert.Course.index" %>
            ...
            <div class="media" style="margin-left:15px;margin-right:15px;">
                ...
                <div class="media-body" style="position: relative">
                    ...
                    <div style="position: absolute; bottom:5px; left: 0;width:100%;">
                        <div class="container">
                            <div class="row">
                                <div class="col-xs-6" style="height: 33px; line-height: 33px;padding-left:0;">
                                ...
                                <div class="col-xs-3 text-center" style="height: 33px; line-height: 33px;padding-left:0;">
