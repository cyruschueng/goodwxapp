<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="SfSoft.web.game.brainsexpert.index" %>
    ...
    <div class="container" style=" padding:0px; position:relative; max-width:640px;">
        ...
        <div class="row" style="margin-right:0px; margin-top:10px;margin-bottom:10px;">
            <div class="span12" style=" text-align:center">
                <a href="http://mp.weixin.qq.com/s?__biz=MzA4MjExMjkwNQ==&mid=211818497&idx=1&sn=f57525dacb85527cf406651aa9c9c7b0#rd">
                    <span class="label">本游戏由【家教智慧】出品  <span class="glyphicon glyphicon-hand-right"></span></span>
                </a>
            </div>
        </div>
    </div>
