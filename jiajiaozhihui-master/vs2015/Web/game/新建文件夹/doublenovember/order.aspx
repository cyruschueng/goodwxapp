<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order.aspx.cs" Inherits="SfSoft.web.game.doublenovember.order" %>
                		...
                		<div  class=" col-sm-12" <%=HTMLRoseberStyle %> >
                			<!--订单信息-->
                    				...
                    				<div class=" form-group">
                        				...
                        				<asp:TextBox ID="remark" name=remark CssClass="form-control" TextMode="MultiLine" placeholder="你可以在这里留下你的备用电话号码，以便快递员与你联系" Rows=3 runat="server"></asp:TextBox>
                    				</div>
                			</div>
                			<div class=" col-xs-12">
                    				<div class="row">
                        				<div class="col-xs-12 text-center">
                            					<a href="javascript:void(0)"  id="btnSubmit"  class=" btn btn-primary btn-lg " >提交订单</a>
                        				</div>
...
<!--
    <nav class="navbar  navbar-fixed-bottom" style="background:#337AB7;">
        <div class="container">
            <div class="row">
                
                <div class="col-xs-12 text-right" style="  padding:5px 3px; height:50px; "><a class=" btn " style="color:#fff; " href="<%=HTMLReturnUrl %>"  >进入亲子书法圈</a></div>
            </div>
        </div>
    </nav>
-->
    ...
    <nav class="navbar  navbar-fixed-bottom" style=" background:#eee; min-height:46px;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-6 text-center" style=" height:46px; line-height:46px;"><a   href="<%=HTMLReturnUrl %>" style=" width:100%; font-size:16px;" >进入亲子书法圈</a></div>
                <div class="col-xs-4 text-right" ><a href="http://weixin.jiajiaozhihui.cn/wxpay/order/qzsf.aspx" class="btn btn-lg btn-success">立即订购</a></div>
            </div>
        </div>
    </nav>
-->
