<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="SfSoft.web.game.doublenovemberII.index" %>
...
<body>
                ...
                <div class="jumbotron" style=" padding-top:5px; padding-bottom:5px; margin-bottom:0">
                    <div class="row">
                        ...
                        <div class="col-xs-9" style=" height:60px;">
                            <div class="row">
                                <div class="col-xs-6" style="height:60px; line-height:60px;">作品：<%=HTMLAllWorksNumber%></div>
                                <div class="col-xs-6" style="height:60px; line-height:60px;">今日新增：<%=HTMLTodayWoksNumber %></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="modal-top" class="modal fade" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <strong>精华</strong>
                ...
                <div class="modal-body">
                    <h4 class="modal-title">是否确认设置精华</h4>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                    <button type="button" id="btnTop" class="btn btn-primary">确认</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="/game/doublenovemberII/js/index.js" type="text/javascript"></script>
