<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="top.aspx.cs" Inherits="SfSoft.web.game.doublenovemberII.top" %>
                ...
                <div class="jumbotron" style=" padding-top:5px; padding-bottom:5px; margin-bottom:0">
                    <div class="row">
                        ...
                        <div class="col-xs-9" style=" height:60px;">
                            <div class="row">
                                <div class="col-xs-4" style="height:60px; line-height:60px;"></div>
                                <div class="col-xs-5 " style="height:60px; line-height:60px;"></div>
