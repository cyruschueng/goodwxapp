<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="partin.aspx.cs" Async="true" Inherits="SfSoft.web.game.doublenovemberII.partin" %>
            ...
            <div class=" col-xs-12" style=" padding-top:15px;">
                ...
                <div class="btn-group" id="bookname">
                    ...
                    <div class="btn-group btn-group-xs">
                        <input type=number class=" form-control" min="1" id="pageindex" placeholder="页码" />
                    </div>
