<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="info-user.aspx.cs" Inherits="SfSoft.web.game.doublenovemberII.info_user" %>
...
<body>
   ...
   <div class="row">
        ...
        <div class="col-xs-6 text-center" ><a  class=" btn btn-success " href="<%=HTMLEditUrl %>"  > <span class="glyphicon glyphicon-edit"></span> 编辑</a></div>
        <div class="col-xs-3"></div>
   </div>
