<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="indexII.aspx.cs" Inherits="SfSoft.web.game.doublenovemberII.indexII" %>
...
<body>
        ...
        <div class="row">
            <div class="col-xs-12" style=" padding-left:0; padding-right:0">
                <div class="jumbotron" style=" padding-top:5px; padding-bottom:5px; margin-bottom:0">
                    <div class="row">
                        <div class="col-xs-3"><img style=" width:60px; height:60px;" src="images/log.jpg" /></div>
                        <div class="col-xs-9" style=" height:60px;">
                            <div class="row">
                                <div class="col-xs-4" style="height:60px; line-height:60px;">作品：<%=HTMLAllWorksNumber%></div>
                                <div class="col-xs-5 " style="height:60px; line-height:60px;">今日新增：<%=HTMLTodayWoksNumber %></div>
    ...
    <script src="js/imgthumbnail.js" type="text/javascript"></script>
    <script src="js/indexII.js" type="text/javascript"></script>
