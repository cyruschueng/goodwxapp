<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="info-activity.aspx.cs" Inherits="SfSoft.web.game.doublenovemberII.info_activity" %>
                    ...
                    <tr>
                        <td colspan="2" >
                            <div class=" alert alert-danger">
                                <strong>提示</strong>
                                只有按规定时间和要求完成后，此项功能才生效
                                <br />
                                <br />
                                <a class=" btn btn-info btn-xs disabled" href="javascript:void(0)">申请退还学习保证金</a> 
                            </div>
                        </td>
                    </tr>
                </table>
