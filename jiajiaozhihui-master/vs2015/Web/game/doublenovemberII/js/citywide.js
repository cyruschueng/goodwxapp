...
Index.prototype.latest = function (orderby) {
    ...
    $.ajax({
        url: "/game/doublenovemberII/server/citywide.ashx",
        type: "POST",
        dataType: "json",
        data: { 'pageindex': this.pageindex, 'pagesize': this.pagesize, 'orderby': '' + orderby + '', 'openid': '' + $("#hfOpenID").val() + '', 'city': '' + $("#hfCity").val() + '', 'method': 'data' },
        beforeSend: function () {
        ...
        success: function (data) {
            if (!$.isEmptyObject(data)) {
                ...
                $("#media-list").append("<li class='list-group-item'>你还没有加入活动，暂无数据</li>");
...
Index.prototype.next = function () {
    ...
    $.ajax({
        ...
        type: "POST",
        dataType: "json",
        data: { 'pageindex': this.pageindex, 'pagesize': this.pagesize, 'orderby': '' + this.orderby + '', 'openid': '' + $("#hfOpenID").val() + '', 'city': '' + $("#hfCity").val() + '', 'method': 'data' },
        success: function (data) {
            if (!$.isEmptyObject(data)) {
                $("#media-list").append(loadData(data));
            } else {
