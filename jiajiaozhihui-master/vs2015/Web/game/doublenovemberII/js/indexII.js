...
var loadData = function (data) {
    ...
    $.each(data.ds, function (i, context) {
        ...
        html += "<p><img    id='img" + context.ID + "' style=' width:100px;'    src='" + context.ImgUrl + "'   /></p>";
        html += "<p>";
        ...
        if ($("#hfA").val() == "1") {
            if (context.IsTop == "1") {
                html += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id='top" + context.ID + "' onclick='topFile(" + context.ID + ")'  class='btn btn-xs btn-success '>精华</span>";
            } else {
                html += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id='top" + context.ID + "' onclick='topFile(" + context.ID + ")'  class='btn btn-xs btn-default '>精华</span>";
            }
        } else {
            if (context.IsTop == "1") {
