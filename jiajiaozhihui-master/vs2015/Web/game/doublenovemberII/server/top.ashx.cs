...
namespace SfSoft.web.game.doublenovemberII.server
{
    ...
    public class top : IHttpHandler
    {
        ...
        private string GetData(HttpContext context)
        {
            ...
            try
            {
                ...
                sb.Append("select top " + pagesize + " *  from (")
                    ...
                    .Append(" from (select * from dbo.WX_Doublenovember_File where isnull(IsAct,1) <> 0 and IsTop=1) a ")
            ...
            {
                WXHelper.WriteNode("game.doublenovember.server.top.ashx(openid1" + context.Request["openid"].ToString() + ")" + ex.Message);
                return result;
            }
        }
        //点赞
        private string Like(HttpContext context)
        {
            ...
            {
                WXHelper.WriteNode("game.doublenovember.server.top.ashx(openid" + openid + ")" + ex.Message);
