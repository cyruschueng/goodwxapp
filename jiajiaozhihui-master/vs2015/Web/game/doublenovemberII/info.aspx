<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="info.aspx.cs" Inherits="SfSoft.web.game.doublenovemberII.info" %>
        ...
        <div class="row" style=" margin-bottom:30px;">
            <div class="header">
                ...
                <div class="row header-img" >
                    <div class="col-xs-3">
                        <img  src="<%=HTMLHeaderImgUrl %>" style=" width:48px; height:48px;" />        
                    </div>
<!--
...
-->
		    <div class="col-xs-9" style=" font-size:medium; margin-top:5px;">
                        <div class="row">
                            <div class="col-xs-12 " style=" color:#23527C"><%=HTMLNickName%></div>
                            <div class="col-xs-12">
                                <span style="  font-size:14px;">LV</span><span style="  font-size:12px; "><%=HTMLGrade %></span>&nbsp;<span style="  color:#A94442; font-size:14px;"><%=HTMLGradeName %></span>&nbsp;&nbsp;&nbsp;
                                <span style="  color:#3C763D" ><%=HTMLIntegralEarn %></span>&nbsp;<span  style=" font-size:12px;">积分</span>&nbsp;&nbsp;&nbsp;
                                <span style=" color:#8A6D3B"><%=HTMLGoldEarn %></span>&nbsp;<span style=" font-size:12px;" >金币</span>&nbsp;&nbsp;&nbsp;
                            </div>
                        </div>
                    </div>	
                </div>
        ...
        <div class="row">
            <div class=" col-xs-12">
                <ul class=" list-group">
                    <li class=" list-group-item list-group-item-success"><a href="<%=HTMLWorksUrl %>" style=" display:block; font-size:14px;">我的作品</a></li>
                    <li class=" list-group-item list-group-item-info"><a href="<%=HTMLAdditionInfoUrl %>" style=" display:block; font-size:14px;">我的资料</a></li>
                    <li class=" list-group-item list-group-item-warning"><a href="<%=HTMLInfoUrl %>" style=" display:block; font-size:14px;">我的活动</a></li>
	 	    <li class=" list-group-item list-group-item-success"><a href="<%=HTMLMyCommentUrl %>" style=" display:block; font-size:14px;">我的评论</a></li>
                    <li class=" list-group-item list-group-item-danger"><a href="<%=HTMLUnscrambleUrl %>" style=" display:block; font-size:14px;">字帖注解</a></li>
                </ul>
            </div>
        </div>
        <div class="row" style=" margin-bottom:30px;">
            <div class=" col-xs-12" style="padding-top:20px;">
                <p class="bg-success" style="padding:5px">
                    您已经收到书法字帖后，如果您在上传作品时，还是显示 <span style='color:#f00'>订单正在审核中。。。</span> ,请点击这里进入
