<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="friend.aspx.cs" Inherits="SfSoft.web.game.doublenovemberII.friend" %>
...
<!--
        <div class="row" style=" background:#eee; margin-bottom:10px;">
           <div class="col-xs-6 text-center" style=" background:#337AB7; padding:8px 2px "><a class=" alert-menu"  href="<%=HTMLFriendManageUrl %>"><span class="glyphicon glyphicon-hand-right"></span>&nbsp;&nbsp; <span style="color:#fff">小伙伴</span><span style=" color:#f00;background-color:#337AB7" class="badge"><%=HTMLNewKindsNumber%></span></a> </div>
           <div class="col-xs-6 text-center" style=" background:#337AB7; padding:8px 2px "><a class=" alert-menu" href="<%=HTMLInviteUrl %>"><span class="glyphicon glyphicon-hand-right"></span>&nbsp;&nbsp; 邀请新朋友</a></div>
        </div>
        <div class="row">
            <div class="col-xs-12">
                <div class=" alert alert-danger">
                    独乐乐，不如众乐乐，快去邀请你的小伙伴一起来学习吧，成长的路上不孤单，点这里开始 <a  class=" btn btn-xs btn-success" href="<%=HTMLInviteUrl %>">邀请</a>
                </div>
            </div>
        </div>
-->
                ...
                <div class="jumbotron" style=" padding-top:5px; padding-bottom:5px; margin-bottom:0">
                    <div class="row">
                        ...
                        <div class="col-xs-9" style=" height:60px;">
                            <div class="row">
                                <div class="col-xs-4" style="height:60px; line-height:60px;"><a   href="<%=HTMLFriendManageUrl %>" > 小伙伴</a></div>
                                <div class="col-xs-5 " style="height:60px; line-height:60px;"><a   href="<%=HTMLInviteUrl %>" style=" width:100%;">邀请新朋友<span style=" color:#f00;background-color:#286090" class="badge"></span></a></div>
    ...
    <script src="/game/doublenovemberII/js/friend.js" type="text/javascript"></script>
    ...
    <script>
        $("#topmenu a").eq(1).css({ 'border-bottom': '1px solid #4CAE4C' })
    </script>
</body>
</html>
