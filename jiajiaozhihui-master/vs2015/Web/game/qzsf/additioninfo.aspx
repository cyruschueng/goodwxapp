<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="additioninfo.aspx.cs" Inherits="SfSoft.web.game.qzsf.additioninfo" %>
                ...
                <form id="Form1" runat="server" >
                    ...
                    <div class=" form-group">
                        ...
                        <div class="btn-group " style=" display:block" id="sex">
                            <input type="radio" name="sex" checked id="sex0" value="女" />&nbsp;女
                            &nbsp;&nbsp;
