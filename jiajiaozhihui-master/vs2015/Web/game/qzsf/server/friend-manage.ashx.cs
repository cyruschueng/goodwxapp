    ...
    public class friend_manage : IHttpHandler
    {
        ...
        private string GetNewData(HttpContext context)
        {
            ...
            sb.Append(" select a.*,b.Number from (")
                /*我邀请我的，但还没有通过的*/
                .Append(" select a.ID, a.FromOpenID as OpenID,a.Content,a.SendDate,isnull(a.ReplyDate,'') as ReplyDate,a.Status,a.IsRead,b.NickName,b.HeadimgUrl,1 as Type from (select * from WX_Doublenovember_Invite where status=0 and ToOpenID='" + openid + "')a left join WX_Items_User b on a.FromOpenID=b.openid")
        ...
        private string GetData(HttpContext context)
        {
            ...
            sb.Append(" select a.*,b.Number from (")
                /*自己*/
                .Append(" select 0 as ID, a.OpenID,'' as Content,'' as SendDate,'' as ReplyDate,1 as Status, 0 as IsRead, case when isnull(b.IsAlias,0)=0 then a.NickName else b.Alias end as NickName ,a.HeadimgUrl,3 as Type from (select * from WX_Items_User where openid='" + openid + "' ) a ")
                ...
                .Append(" left join (select * from dbo.WX_Items_User where ItemsId=1) b on a.ToOpenID=b.openid")
                ...
                .Append(" left join (select * from dbo.WX_Items_User where ItemsId=1) b on a.FromOpenID=b.openid")
