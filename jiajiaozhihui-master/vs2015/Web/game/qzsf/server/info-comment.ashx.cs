...
namespace SfSoft.web.game.qzsf.server
{
    ...
    /// info_comment 的摘要说明
    /// </summary>
    public class info_comment : IHttpHandler
    {
        ...
        private string GetData(HttpContext context)
        {
            ...
            try
            {
                ...
                sb.Append("select top " + pagesize + " *  from (")
                    ...
                    .Append(" where exists(select top 1 * from dbo.WX_Doublenovember_Comment where openid='" + openid + "' and FileID=a.id)")
