<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="repair.aspx.cs" Inherits="SfSoft.web.game.doublenovember.repair" %>
        ...
        <div class="row">
            <div class="col-xs-12">
                <form  runat="server">
                    ...
                    <div class=" form-group" >
                        <div class="col-xs-4 text-center" style=" margin-bottom:15px;">
                        ...
                        <div class=" col-xs-4 text-center" style=" margin-bottom:15px;">
                            <a id="Span1" href="<%=HTMLReturnUrl %>" class="btn btn-success">亲子书法</a>
                        </div>
                    </div>
