<%@ Page Language="C#" MasterPageFile="~/MasterPage/FrameTemplate.Master" AutoEventWireup="true" CodeBehind="error.aspx.cs" Inherits="SfSoft.web.emc.error" Title="系统提醒" %>
                  ...
                  <td width="176" align="center" valign="top" height="182"> 
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" height="182">
                      ...
                      <tr> 
                        ...
                        <div id="divMsg1" runat ="server" style ="width :100%" >
                          <p>系统意外终止，请[<a href ="/login.aspx?loginout=out">点击这里</a>]重新登录！</p>
                          </div>
                          <div id="divMsg2" runat ="server" style ="width :100%" visible ="false"  >
