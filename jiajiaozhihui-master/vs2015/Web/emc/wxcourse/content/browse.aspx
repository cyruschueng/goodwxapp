<%@ Page Language="C#" MasterPageFile="~/MasterPage/PageTemplate.Master" AutoEventWireup="true"
    CodeBehind="browse.aspx.cs" Inherits="SfSoft.web.emc.wxcourse.content.browse" Title="无标题页" %>
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
        <tr>
            ...
            <td style="border-right: #c7c5d9 1px solid; border-top: #c7c5d9 1px solid; border-left: #c7c5d9 1px solid;
                ...
                <iframe id="framename" frameborder="0" name="mainbody" scrolling="auto" src="" style="z-index: 1;
