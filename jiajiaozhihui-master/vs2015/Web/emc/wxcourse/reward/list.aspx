<%@ Page Language="C#" MasterPageFile="~/MasterPage/FrameTemplate.Master" AutoEventWireup="true"
    Codebehind="list.aspx.cs" Inherits="SfSoft.web.emc.wxcourse.reward.list" Title="无标题页" %>
    ...
    <cc1:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        <cc1:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="基础数据">
            <table border="0" cellpadding="0" cellspacing="0" style="width:98%" class="fromtable">
                <tr>
                    <td>开始数据&nbsp;</td>
                    <td  ><asp:TextBox ID="txtStartNumber" runat="server" Width="120px"></asp:TextBox></td>
                    <td  >结束数据&nbsp;</td>
                    <td  ><asp:TextBox ID="txtEndNumber" runat="server" Width="120px"></asp:TextBox></td>
                    <td  >比率&nbsp;</td>
                    <td  ><asp:TextBox ID="txtRate" runat="server" Width="120px"></asp:TextBox></td>
                    <td >
                        <asp:TextBox ID="txtSort" runat="server" Width="30px"  onkeyup="javascript:permitInt(this);"></asp:TextBox>
                        是否启用<asp:CheckBox ID="cbIsAct" runat="server" Checked="True" />
                    </td>
                    <td  >
                ...
                <asp:SmartGridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="98%" SkinID ="sgv2" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="StartNumber" HeaderText="开始数据">
                            <ItemStyle Width="100px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="EndNumber" HeaderText="结束数据">
                            <ItemStyle Width="100px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="EndNumber" HeaderText="比率(%)">
