<%@ Page Language="C#" MasterPageFile="~/MasterPage/PageTemplate.Master" AutoEventWireup="true" CodeBehind="browse.aspx.cs" Inherits="SfSoft.web.emc.sm.s4.browse" Title="数据权限" %>
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
        <tr>
            <td id="frmTitle" align="center" nowrap="nowrap" style="border-right: #c7c5d9 1px solid;
                ...
                <iframe id="IFRAME1" frameborder="0" name="leftbody" scrolling="no" src="dttree.aspx?state=browse"
