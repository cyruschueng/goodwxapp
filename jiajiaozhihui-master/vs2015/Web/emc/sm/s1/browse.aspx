<%@ Page Language="C#" MasterPageFile="~/MasterPage/PageTemplate.Master" AutoEventWireup="true"
    Codebehind="browse.aspx.cs" Inherits="SfSoft.web.emc.sm.s1.browse" Title="无标题页" %>
...
<tr>
    <td id="frmTitle"    nowrap valign="middle" align="center"   style="border-right: 1px solid #C7C5D9;border-top: 1px solid #C7C5D9;border-bottom: 1px solid #C7C5D9;border-left: 1px solid #C7C5D9; height: 425px;"> 
    ...
    <td style="width:10pt; height: 425px;" width="10"  title="关闭/打开左栏" class="navPoint"> 
    ...
    <td style="width:100%; height:425px;border-top: 1px solid #C7C5D9;border-bottom: 1px solid #C7C5D9;border-left: 1px solid #C7C5D9;border-right: 1px solid #C7C5D9;">
