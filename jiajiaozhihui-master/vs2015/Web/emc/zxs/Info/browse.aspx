<%@ Page Language="C#" MasterPageFile="~/MasterPage/PageTemplate.Master" AutoEventWireup="true"
    CodeBehind="browse.aspx.cs" Inherits="SfSoft.web.emc.zxs.info.browse" Title="无标题页" %>
            ...
            <asp:Panel ID="Panel3" GroupingText="" runat="server">
                <asp:SmartGridView ID="GridView1" runat="server"  AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="JoinNumber" HeaderText="好习者"  ReadOnly="true"/>
                        <asp:BoundField DataField="PothuntNumber" HeaderText="挑战者"  ReadOnly="true"/>
