<%@ Page Language="C#" MasterPageFile="~/MasterPage/PageTemplate.Master" AutoEventWireup="true" CodeBehind="update.aspx.cs" Inherits="SfSoft.web.emc.zxs.info.update" Title="无标题页" %>
        ...
        <cc1:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="群信息">
            <asp:Panel ID="Panel1" GroupingText="基本数据" runat="server">
                ...
                <table border="0" cellpadding="2" cellspacing="0" width="100%" class="fromtable">
                    ...
                    <tr>
                        <td class="td">爱好者人数</td>
                        <td ><asp:Label ID="lbJoinNumber" onkeyup="javascript:permitInt(this);" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="td">挑战者人数</td>
                        <td ><asp:Label ID="lbPothuntNumber" onkeyup="javascript:permitInt(this);" runat="server"></asp:Label></td>
                    </tr>
                     <tr>   
                        <td class="td">活动简介</td>
