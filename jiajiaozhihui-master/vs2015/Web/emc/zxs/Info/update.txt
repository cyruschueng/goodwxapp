...
namespace SfSoft.web.emc.zxs.info
{
    public partial class update : SfSoft.SfEmc.EmcDetailPage
    {

        Model.WX_ZXS_Info modelArts = new SfSoft.Model.WX_ZXS_Info();
        BLL.WX_ZXS_Info bllArts = new BLL.WX_ZXS_Info();
        ...
        private void ShowInfo(Model.WX_ZXS_Info model)
        {
            ...
            lbJoinNumber.Text = (model.JoinNumber ?? 0).ToString();
            lbPothuntNumber.Text = (model.PothuntNumber ?? 0).ToString();
        ...
        protected override void VtSave()
        {
            ...
            Model.WX_ZXS_Info model = new Model.WX_ZXS_Info();
            //保存单据
            if (hfMode.Value == "add")
            {
        ...
        private Model.WX_ZXS_Info SetModelValue(Model.WX_ZXS_Info model)
        {
