<%@ Page Language="C#" MasterPageFile="~/MasterPage/FrameTemplate.Master" AutoEventWireup="true" CodeBehind="everyweeks.aspx.cs" Inherits="SfSoft.web.emc.gardenia.task.everyweeks" %>
                    ...
                    <tr>
                        <td>
                            <asp:DropDownList ID="ddlTheme" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlTheme_SelectedIndexChanged">
                                <asp:ListItem Text="---请选择主题---" Value=""></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
            ...
            <asp:Panel ID="Panel4" GroupingText="" runat="server">
                ...
                <asp:SmartGridView ID="GridView3" runat="server"  AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Id" HeaderText="编号" ReadOnly="true" />
                        <asp:BoundField DataField="Name" HeaderText="名称" ReadOnly="true" />
                        <asp:BoundField DataField="Year" HeaderText="年份" ReadOnly="true" />
                        <asp:TemplateField HeaderText="启用周">
                            <ItemTemplate><%# Eval("StartUpDate") %>周</ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="txtStartUpDate"  runat="server" Text='<%# Eval("StartUpDate") %>'></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
