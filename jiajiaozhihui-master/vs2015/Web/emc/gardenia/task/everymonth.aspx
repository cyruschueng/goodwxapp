<%@ Page Language="C#" MasterPageFile="~/MasterPage/FrameTemplate.Master" AutoEventWireup="true" CodeBehind="everymonth.aspx.cs" Inherits="SfSoft.web.emc.gardenia.task.everymonth" %>

<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    <cc1:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        <cc1:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="习惯助手">
            ...
            <asp:Panel ID="Panel1" GroupingText="基础条件" runat="server">
                ...
                <table border="0" cellpadding="2" cellspacing="0" width="100%" class="fromtable">
                    <tr>
                        <td>
                            <asp:DropDownList ID="ddlHabit" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlHabit_SelectedIndexChanged">
                                <asp:ListItem Text="---请选择习惯---" Value=""></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
        ...
        <cc1:TabOptionItem ID="TabOptionItem2" runat="server" Tab_Name="习惯助手任务编排">
                ...
                <asp:SmartGridView ID="GridView2" runat="server"  AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="启用日期">
                            <ItemTemplate><%# Eval("StartUpDate") %>月</ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="txtStartUpDate" onfocus="WdatePicker({dateFmt:'M'})"  runat="server" Text='<%#Eval("StartUpDate") %>'></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
