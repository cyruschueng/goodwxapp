<%@ Page Language="C#" MasterPageFile="~/MasterPage/PageTemplate.Master" AutoEventWireup="true" CodeBehind="update.aspx.cs" Inherits="SfSoft.web.emc.hrm.newemp.update" Title="员工入职" %>

<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">

    <script type="text/javascript" src="/js/emccommon.js"></script>
    ...
    <cc1:TabOptionWebControls ID="TabOptionWebControls1" runat="server" SelectIndex="0">
        <cc1:TabOptionItem ID="TabOptionItem2" runat="server" Tab_Name="基本信息">
              <table border="0" cellpadding="2" cellspacing="0" width="100%" class="fromtable">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td  style="width: 254px; height: 25px" width="*">
                               <asp:DropDownList ID="ddlCBArea" runat ="server" ></asp:DropDownList><font color="red">*</font>
                            </td>
                            <td  style="width: 136px; height: 25px; " width="*">
                                在职状态
                            </td>
            ...
            <asp:HiddenField ID="hfMID" runat="server"></asp:HiddenField>
        </cc1:TabOptionItem>
