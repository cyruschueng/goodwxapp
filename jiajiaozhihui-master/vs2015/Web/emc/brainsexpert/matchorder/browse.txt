...
namespace SfSoft.web.emc.brainsexpert.matchorder
{
    public partial class browse : SfSoft.SfEmc.EmcBrowseBasePage
    {
        ...
        {
            hfMID.Value = "emc.brainsexpert.matchorder";
        }
        #region 初始化工具栏
        ...
        private void BindData(string strWhere)
        {
            ...
            sb.Append("select a.*,b.goodname,c.areaname as provincename,d.areaname as cityname,e.refvalue as PostName,f.refvalue as LogisticsName  from (select * from dbo.WX_PublicOrder where goodstype=8) a ");
        ...
        protected void btn_export_Click(object sender, EventArgs e)
        {
            ...
            string fileName = "("+string.Format("{0:yyyyMMdd}", DateTime.Now)+").xls";
