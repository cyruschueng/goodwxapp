...
namespace SfSoft.web.emc.brainsexpert.order
{
    public partial class browse : SfSoft.SfEmc.EmcBrowseBasePage
    {
        ...
        {
            hfMID.Value = "emc.brainsexpert.order";
        }
        #region 初始化工具栏
        ...
        private void BindData(string strWhere)
        {
            ...
            sb.Append("select a.*,b.goodname,c.areaname as provincename,d.areaname as cityname,e.refvalue as PostName,f.refvalue as LogisticsName  from (select * from dbo.WX_PublicOrder where goodstype=7) a ");
