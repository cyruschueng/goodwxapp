...
namespace SfSoft.web.emc.brainsexpert.activityset
{
    public partial class list : SfSoft.SfEmc.EmcBasePage
    {
        ...
        {
            hfMID.Value = "emc.brainsexpert.activityset";
        }
        protected override void VtPageAccess()
        {
            CheckPageAccess("emc.brainsexpert.activityset.browse");
        }
 
        private void SetTabName()
        {
            BLL.WX_TestQuestion_Activity_Class bllBdc = new BLL.WX_TestQuestion_Activity_Class();
        ...
        {
            BLL.WX_TestQuestion_Activity_Class bllBd = new BLL.WX_TestQuestion_Activity_Class();
        ...
        {
            Model.WX_TestQuestion_Activity_Class modelbd = new Model.WX_TestQuestion_Activity_Class();
            BLL.WX_TestQuestion_Activity_Class bllBd = new BLL.WX_TestQuestion_Activity_Class();
            int RefID = Common.Common.stringToInt(GridView1.DataKeys[e.RowIndex].Value.ToString());
