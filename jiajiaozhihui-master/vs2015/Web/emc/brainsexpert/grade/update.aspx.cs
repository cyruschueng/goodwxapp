...
using SfSoft.SfEmc;
using System.IO;
namespace SfSoft.web.emc.brainsexpert.grade
{
    public partial class update : SfSoft.SfEmc.EmcDetailPage
    {

        Model.WX_TestQuestion_Grade modelArts = new SfSoft.Model.WX_TestQuestion_Grade();
        BLL.WX_TestQuestion_Grade bllArts = new BLL.WX_TestQuestion_Grade();
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                hfMID.Value = "emc.brainsexpert.grade";
        ...
        protected override void VtSave()
        {
            ...
            Model.WX_TestQuestion_Grade model = new Model.WX_TestQuestion_Grade();
            //保存单据
            if (hfMode.Value == "add")
            {
        ...
        private void ShowInfo(Model.WX_TestQuestion_Grade model)
        {
        ...
        private Model.WX_TestQuestion_Grade SetModelValue(Model.WX_TestQuestion_Grade model)
        {
