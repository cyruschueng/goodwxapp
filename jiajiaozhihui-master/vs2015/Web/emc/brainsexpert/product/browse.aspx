<%@ Page Language="C#" MasterPageFile="~/MasterPage/PageTemplate.Master" AutoEventWireup="true"
    CodeBehind="browse.aspx.cs" Inherits="SfSoft.web.emc.brainsexpert.product.browse" Title="无标题页" %>
        ...
        <cc1:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="公益品">
            ...
            <asp:SmartGridView ID="GridView1" runat="server"  AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="兑换" HeaderStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Label Text='<%#Eval("Exchange")+"金币" %>' runat="server"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="Number" HeaderText="数量" HeaderStyle-HorizontalAlign="Center"  ReadOnly="true" />
