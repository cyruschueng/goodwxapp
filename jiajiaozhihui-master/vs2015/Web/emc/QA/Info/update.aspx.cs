...
namespace SfSoft.web.emc.QA.info
{
    public partial class update : SfSoft.SfEmc.EmcDetailPage
    {
        ...
        Model.WX_QA_Info modelArts = new SfSoft.Model.WX_QA_Info();
        BLL.WX_QA_Info bllArts = new BLL.WX_QA_Info();
        ...
        private void ShowInfo(Model.WX_QA_Info model)
        {
        ...
        protected override void VtSave()
        {
            ...
            Model.WX_QA_Info model = new Model.WX_QA_Info();
            //保存单据
            if (hfMode.Value == "add")
            {
        ...
        private Model.WX_QA_Info SetModelValue(Model.WX_QA_Info model)
        {
