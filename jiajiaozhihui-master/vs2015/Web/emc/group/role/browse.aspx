<%@ Page Language="C#" MasterPageFile="~/MasterPage/PageTemplate.Master" AutoEventWireup="true" CodeBehind="browse.aspx.cs" Inherits="SfSoft.web.emc.group.role.browse" Title="无标题页" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    ...
    <cc1:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        ...
        <table class="fromtable"><tr><td>
            ...
            部门：<asp:DropDownList ID="ddlGroupId" AutoPostBack="true" runat="server" 
            ...
            <asp:SmartGridView ID="gvUsers" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="用户名">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lbUserName" ForeColor='black' Text='<%#DataBinder.Eval(Container.DataItem,"OpenId") %>' />
                        </ItemTemplate>
                        <HeaderStyle Height="25px" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="姓名">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lbCnName" ForeColor='black' Text='<%#DataBinder.Eval(Container.DataItem,"NickName") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="是否属于角色">
                        <ItemTemplate>
                            <asp:CheckBox ID="cbUserInRole" runat="server" AutoPostBack="true" ForeColor="blue"
                                OnCheckedChanged="CheckBox_Click" ToolTip='<%#DataBinder.Eval(Container.DataItem,"OpenId") %>' />
                        </ItemTemplate>
                        <HeaderStyle Height="25px" />
                    </asp:TemplateField>
                </Columns>
