<%@ Page Language="C#" MasterPageFile="~/MasterPage/PageTemplate.Master" AutoEventWireup="true" CodeBehind="update.aspx.cs" Inherits="SfSoft.web.emc.sgroup.content.update" Title="无标题页" %>
        ...
        <cc1:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="群信息">
            <asp:Panel ID="Panel1" GroupingText="基本数据" runat="server">
                ...
                <table border="0" cellpadding="2" cellspacing="0" width="100%" class="fromtable">
                    ...
                    <tr>
                        <td class="td">标题</td>
                        <td ><asp:TextBox ID="txt_title" runat="server" Width="95%"></asp:TextBox></td>
                    </tr>
