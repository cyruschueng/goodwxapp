<%@ Page Language="C#" MasterPageFile="~/MasterPage/PageTemplate.Master" AutoEventWireup="true"
    CodeBehind="browse.aspx.cs" Inherits="SfSoft.web.emc.material.jinghua.browse" Title="无标题页" %>
        ...
        <cc1:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="关键字回复">
            <table class="fromtable">
                <tr>
                    ...
                    <td>组标题</td>
                    <td><asp:DropDownList ID="ddlGroupTitle" runat="server"></asp:DropDownList></td>
            ...
            <asp:SmartGridView ID="GridView1" runat="server"  AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="GName" HeaderText="组标题" ReadOnly="true"   />
