<%@ Page Language="C#" MasterPageFile="~/MasterPage/PageTemplate.Master" AutoEventWireup="true" CodeBehind="browse.aspx.cs" Inherits="SfSoft.web.emc.resouce.set.browse" Title="无标题页" %>
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
        <tr>
            <td id="frmTitle" align="center" nowrap="nowrap" style="border-right: #c7c5d9 1px solid;
                ...
                height: 1455px" valign="middle">
                <iframe id="IFRAME1" frameborder="0" name="leftbody" scrolling="no" src="bdtree.aspx?state=browse"
                    style="z-index: 2; width: 180px; height: 100%"></iframe>
            </td>
            <td class="navPoint" style="width: 10pt; height: 1455px" title="关闭/打开左栏" width="10">
            ...
            <td style="border-right: #c7c5d9 1px solid; border-top: #c7c5d9 1px solid; border-left: #c7c5d9 1px solid;
                width: 100%; border-bottom: #c7c5d9 1px solid; height: 1455px">
