<%@ Page Language="C#" MasterPageFile="~/MasterPage/PageTemplate.Master" AutoEventWireup="true" EnableEventValidation = "false"
    CodeBehind="browse.aspx.cs" Inherits="SfSoft.web.emc.exchange.order.browse" Title="无标题页" %>  
        ...
        <cc1:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="公益品">
            ...
            <table class="fromtable">
                <tr>
                    <td >订单类型</td>
                    <td>
                        <asp:DropDownList ID="ddlOrderType" runat="server" CssClass=".select" ></asp:DropDownList>
                    </td>
                    <td >订购人</td>
                ...
                <tr>
                    <td colspan="8" >
                            ...
                            <asp:Button ID="btnVip" runat="server" class="btn" 
                            onmouseover="this.className='btn_mouseover'" onmouseout="this.className='btn'" 
                            Text="标记VIP" onclick="btnVip_Click"     />&nbsp;&nbsp;
