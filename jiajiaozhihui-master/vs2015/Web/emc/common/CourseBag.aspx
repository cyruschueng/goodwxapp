<%@ Page Language="C#" MasterPageFile="~/MasterPage/PageTemplate.Master" AutoEventWireup="true"
    CodeBehind="CourseBag.aspx.cs" Inherits="SfSoft.web.emc.common.CourseBag"
    Title="课程包选择" %>

<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePartialRendering="true" />
    <asp:Panel ID="Panel1" runat="server" GroupingText="" Height="60" Width="100%">
        &nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="txtSelect"  runat="server" Rows="1" TextMode="MultiLine" Width="680px" ></asp:TextBox>
        <asp:HiddenField ID="hfSelect" runat="server" />
        <asp:HiddenField ID="hfSelectTxt" runat="server" />
    </asp:Panel>
    <div class="toolbars">
        课程：<asp:TextBox ID="txtName" runat="server"></asp:TextBox>
    ...
    <div>
        <cc1:TabOptionWebControls ID="TabOption1" runat="server">
            <cc1:TabOptionItem ID="Tab1" runat="server" Tab_Name="选择课程">
