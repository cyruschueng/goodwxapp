...
namespace SfSoft.web.emc.Yuedu.info
{
    public partial class update : SfSoft.SfEmc.EmcDetailPage
    {

        Model.WX_Yuedu_Info modelArts = new SfSoft.Model.WX_Yuedu_Info();
        BLL.WX_Yuedu_Info bllArts = new BLL.WX_Yuedu_Info();
        ...
        private void ShowInfo(Model.WX_Yuedu_Info model)
        {
        ...
        protected override void VtSave()
        {
            ...
            Model.WX_Yuedu_Info model = new Model.WX_Yuedu_Info();
            //保存单据
            if (hfMode.Value == "add")
            {
        ...
        private Model.WX_Yuedu_Info SetModelValue(Model.WX_Yuedu_Info model)
        {
        ...
        {
            string UploadFilesPath = ConfigurationManager.AppSettings["UploadFilesPath"] + "Yuedu/";
        ...
        {
            BLL.WX_Yuedu_Info bll = new BLL.WX_Yuedu_Info();
