    ...
    public partial class browse : SfSoft.SfEmc.EmcBrowseBasePage
    {
        ...
        protected override void VtDelete()
        {
            ...
            for (int i = 0; i < arrID.Length; i++)
            {
                ...
                Model.WX_Yuedu_Info modelMsn = bll.GetModel(id);
                //bll.Delete(id);
            }
            BindData(GetWhere());
        }
        ...
        protected new void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string name = e.Row.Cells[3].Text.Length > 10 ? e.Row.Cells[3].Text.Substring(0, 10) + "..." : e.Row.Cells[3].Text;
                e.Row.Cells[3].Text = "<a href='" + url + "'><font color=#2828FF>" + name + "</font></a>";
                ...
                {
                    e.Row.Cells[7].Text = "<font color=#f00>未启用</font>";
                }
                else if (e.Row.Cells[7].Text == "1")
                {
                    e.Row.Cells[7].Text = "<font color=#2828FF>启用</font>";
                }
            }
        }
