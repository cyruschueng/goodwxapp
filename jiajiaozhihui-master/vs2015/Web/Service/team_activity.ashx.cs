...
namespace SfSoft.web.Service
{
    ...
    /// team_activity 的摘要说明
    /// </summary>
    public class team_activity : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string result = ShowData(pageindex, pagesize);
            context.Response.Write(result);
        }
        private string ShowData(int pageindex, int pagesize)
        {
            string result = "{}";
            ...
            sb.Append(" select a.Title,a.ArticleUrl,a.ImgUrl,a.GroupTitle,a.IsHead,b.RefValue,b.Orderid from  (select * from WX_JingHua where Isnull(ArticleType,0)=2) a");
