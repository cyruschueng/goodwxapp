...
{
    /// <summary>
    /// doublenovember3 的摘要说明
    /// </summary>
    public class doublenovember3 :  IHttpHandler,System.Web.SessionState.IRequiresSessionState
    {
        ...
        private void Init(HttpContext context)
        {
            ...
            {
                FromOpenID = context.Request["from"].ToString();
            }
        }
        private void Run()
        {
            string url = "";
            string redirectUrl = "";
            string state = "{'mode':'" + Mode + "','share':'" + Share + "','openid':'" + OpenID + "','id':'" + ID + "','fromopenid':'" + FromOpenID + "'}";
