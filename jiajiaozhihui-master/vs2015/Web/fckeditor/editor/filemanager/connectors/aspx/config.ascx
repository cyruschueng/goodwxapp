...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        UserFilesPath = "/Files/";// "/userfiles/";"/test/upload/" & year(now())& right("0"& month(now()),2)&right("0" & day(now()),2)
		...
		HtmlExtensions = new string[] { "html", "htm", "xml", "xsd", "txt", "js","doc","xls","ppt" };
        ...
        TypeConfig["File"].DeniedExtensions = new string[] { "exe", "dll", "bat", "cgi", "aspx", "asp" };
        ...
        TypeConfig["Image"].AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pptx", "pps","pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "xml", "zip" }; //new string[] { "bmp", "gif", "jpeg", "jpg", "png" };
