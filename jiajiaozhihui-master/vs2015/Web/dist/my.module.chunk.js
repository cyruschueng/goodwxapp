...
/***/ "../../../../../src/app/my/history/history.component.css":
...
/***/ "../../../../../src/app/my/history/history.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"weui-cells\" style=\"margin-top:0;\">\n    <div class=\"weui-cell\">\n      <div class=\"weui-cell__hd\">\n        <a [routerLink]=\"['/new']\" class=\"fa fa-chevron-left\" style=\"color:#aaa;\"></a>\n      </div>\n      <div class=\"weui-cell__bd\">\n        <p  style=\"text-align:center\">历史</p>\n      </div>\n    </div>\n  </div>\n  <div class=\"weui-panel weui-panel_access\" style=\"padding-bottom:60px\">\n    <div class=\"weui-panel__bd\">\n      <a (click)=\"playAudio(item.id,item.catalogue)\" *ngFor=\"let item of taskList; let idx=index\" href=\"javascript:void(0);\" class=\"weui-media-box weui-media-box_appmsg\">\n        <div class=\"weui-media-box__hd\">\n          <img class=\"weui-media-box__thumb\" src=\"../../assets/tabbar_task.png\">\n        </div>\n        <div class=\"weui-media-box__bd\">\n          <h4 class=\"weui-media-box__title\">{{item.title}}</h4>\n          <p class=\"weui-media-box__desc\">\n            <span [hidden]=\"item.catalogue!=1\" class=\"primary\">初级班</span>\n            <span [hidden]=\"item.catalogue!=2\" class=\"advanced\">高级班</span>\n            <span [hidden]=\"item.catalogue!=3\" class=\"outstanding\">卓越班</span>\n          </p>\n        </div>\n      </a>\n    </div>\n  </div>\n  <div style=\"position:fixed; bottom:0;width:100%; left:0px;\">\n    <app-audio-panel ></app-audio-panel>\n  </div>\n  "

/***/ }),

/***/ "../../../../../src/app/my/history/history.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return HistoryComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__service_history_service__ = __webpack_require__("../../../../../src/app/my/history/service/history.service.ts");
...
var HistoryComponent = (function () {
    function HistoryComponent(historyService, audioService) {
        this.historyService = historyService;
        this.audioService = audioService;
    }
    HistoryComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.historyService.getHistoryTask().subscribe(function (res) {
            console.log(res);
            if (res.success == true) {
                _this.taskList = res.data;
                _this.audioService.AddRange(null);
                // this.ConverToOriginalAudioList(res.data)
                _this.audioService.PreLoad();
            }
        });
    };
    HistoryComponent.prototype.ConverToOriginalAudioList = function (x) {
        var list = [];
    ...
    HistoryComponent.prototype.playAudio = function (id, catalogue) {
        var right = this.historyService.Right();
        if (right.permission == false) {
            var html = "<a ng-reflect-router-link=\"/helper\" href=\"/helper\" style=\"color:#fff;\" >\u64CD\u4F5C\u5931\u8D25:\u4F60\u8FD8\u6CA1\u6709\u52A0\u5165\u73ED\u7EA7 <small style=\"color:#337ab7\">\u70B9\u51FB\u6211,\u67E5\u770B\u5E2E\u52A9</small></a>";
            $.toptip(html, 'error');
        }
        else {
            if (right.check == true) {
                if (+right.type < catalogue) {
                    var html = "<a ng-reflect-router-link=\"/helper\" href=\"/helper\" style=\"color:#fff;\" >\u8B66\u544A:\u4F60\u6CA1\u6709\u6743\u9650\u5B66\u4E60\u5F53\u524D\u6559\u7A0B <small style=\"color:#337ab7\">\u70B9\u51FB\u6211,\u67E5\u770B\u5E2E\u52A9</small></a>";
                    console.log(html);
                    $.toptip(html, 'warning');
                }
                else {
                    var list = this.audioService.PlayList();
                    var data = list.find(function (x) {
                        return x.Id === id;
                    });
                    this.audioService.Toggle(data);
                }
            }
            else {
                var html = "<a ng-reflect-router-link=\"/helper\" href=\"/helper\" style=\"color:#fff;\" >\u64CD\u4F5C\u5931\u8D25:\u4F60\u7684\u6743\u9650\u6B63\u5728\u5BA1\u6838 <small style=\"color:#337ab7\">\u70B9\u51FB\u6211,\u67E5\u770B\u5E2E\u52A9</small></a>";
                $.toptip(html, 'warning');
            }
        }
    };
...
HistoryComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["o" /* Component */])({
        ...
        template: __webpack_require__("../../../../../src/app/my/history/history.component.html"),
        styles: [__webpack_require__("../../../../../src/app/my/history/history.component.css")],
        providers: [__WEBPACK_IMPORTED_MODULE_0__service_history_service__["a" /* HistoryService */]]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__service_history_service__["a" /* HistoryService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__service_history_service__["a" /* HistoryService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__service_audio_service__["a" /* AudioService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__service_audio_service__["a" /* AudioService */]) === "function" && _b || Object])
], HistoryComponent);
...
/***/ "../../../../../src/app/my/history/service/history.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var HistoryService = (function () {
    ...
    HistoryService.prototype.getHistoryTask = function () {
        var data = JSON.parse(localStorage.getItem("appData"));
        var serverUrl = '/app/microlecture/task/history/' + data.info.other.classId;
    ...
    HistoryService.prototype.Right = function () {
        var data = JSON.parse(localStorage.getItem("appData"));
        return {
            permission: __WEBPACK_IMPORTED_MODULE_3_lodash__["isNumber"](data.info.other.classId) ? true : false,
            classId: data.info.other.classId,
            type: data.info.other.catalogue,
            check: data.info.other.isact
        };
    };
...
/***/ "../../../../../src/app/my/member/member.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/my/member/member.component.html":
/***/ (function(module, exports) {
...
/***/ "../../../../../src/app/my/member/member.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
MemberComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        selector: 'app-member',
        template: __webpack_require__("../../../../../src/app/my/member/member.component.html"),
        styles: [__webpack_require__("../../../../../src/app/my/member/member.component.css")]
    }),
...
module.exports = "<form action=\"\">\n  <div class=\"weui-cells topnav\">\n    <div class=\"weui-cell\">\n      <div class=\"weui-cell__hd\">\n        <a [routerLink]=\"['/new']\"><span class=\"fa fa-chevron-left topnav-title\"></span></a>\n      </div>\n      <div class=\"weui-cell__bd\">\n        <p (click)=\"testwx()\" class=\"topnav-title\" style=\"text-align:center\">我的</p>\n      </div>\n      <div class=\"weui-cell_ft\">\n        <!-- <span style=\"background:#f60;color:#fff;\" class=\"weui-btn weui-btn_mini weui-btn_default\">保存</span> -->\n      </div>\n    </div>\n  </div>\n  <div class=\"page\" style=\"background:#eee; \">\n    <div class=\"page__bd\">\n      <div class=\"weui-cells weui-cells_form\" style=\"margin-top:0;\">\n        <div class=\"weui-cell\">\n          <div class=\"weui-cell__hd\">\n            <img style=\"width:60px; border-radius:30px\" src=\"{{member.wxUserInfo.headImgUrl}}\">\n          </div>\n          <div class=\"weui-cell__bd\">\n              <span *ngIf=\"member.other.class_no==''\"  style=\"color:#aaa;\">未加入班级</span>\n              <p><span *ngIf=\"member.other.class_no!=''\" style=\"color:#f60;\">{{member.other.className}}</span></p>\n              <p><small *ngIf=\"member.other.class_no!=''\" style=\"color:#f60;\" >{{member.other.classTypeName}}</small></p>\n          </div>\n          <div class=\"weui-cell__tf\">\n            \n          </div>\n        </div>\n      </div>\n      <!-- <div class=\"weui-cells__title\">个性签名</div>\n      <div class=\"weui-cells\">\n        <div class=\"weui-cell\">\n          <div class=\"weui-cell__bd\">\n            <input class=\"weui-input\" placeholder=\"输入签名...\">\n          </div>\n        </div>\n      </div> -->\n      <div class=\"weui-cells__title\">基础信息</div>\n      <div class=\"weui-cells\">\n        <div class=\"weui-cell\">\n          <div class=\"weui-cell__hd\"><label class=\"weui-label\">昵称</label></div>\n          <div class=\"weui-cell__bd\"><input class=\"weui-input\" value=\"{{member.wxUserInfo.nickName}}\" placeholder=\"昵称\"></div>\n        </div>\n        <div class=\"weui-cell  \">\n          <div class=\"weui-cell__hd\"><label class=\"weui-label\">性别</label></div>\n          <div class=\"weui-cell__bd\">\n              <input class=\"weui-input\" value=\"{{member.wxUserInfo.sex==1?'男':'女' }}\" placeholder=\"昵称\">\n          </div>\n        </div>\n        <div class=\"weui-cell\">\n            <div class=\"weui-cell__hd\"><label class=\"weui-label\">所在地</label></div>\n            <div class=\"weui-cell__bd\"><input class=\"weui-input\" value=\"{{member.wxUserInfo.province}}\" placeholder=\"所在地\"></div>\n          </div>\n      </div>\n    </div>\n  </div>\n</form>\n<div style=\"position:fixed; width:100%; bottom:0;\">\n  <app-nav [currIndex]=\"3\"></app-nav>\n</div>\n<!-- <app-nav [currIndex]=\"3\"></app-nav> -->\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__service_my_service__ = __webpack_require__("../../../../../src/app/my/service/my.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var MyComponent = (function () {
    ...
    MyComponent.prototype.ngOnInit = function () {
        this.member = this.myService.getMember();
        console.log(this.member);
    };
    MyComponent.prototype.testwx = function () {
        this.myService.testwx().subscribe(function (res) {
            console.log(res);
        });
    };
    return MyComponent;
...
MyComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["o" /* Component */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_0__service_my_service__["a" /* MyService */]]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__service_my_service__["a" /* MyService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__service_my_service__["a" /* MyService */]) === "function" && _a || Object])
], MyComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__my_component__ = __webpack_require__("../../../../../src/app/my/my.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__my_router__ = __webpack_require__("../../../../../src/app/my/my.router.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__history_history_component__ = __webpack_require__("../../../../../src/app/my/history/history.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__member_member_component__ = __webpack_require__("../../../../../src/app/my/member/member.component.ts");
...
MyModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* RouterModule */].forChild(__WEBPACK_IMPORTED_MODULE_5__my_router__["a" /* MyRoute */])
        ],
        declarations: [__WEBPACK_IMPORTED_MODULE_4__my_component__["a" /* MyComponent */], __WEBPACK_IMPORTED_MODULE_6__history_history_component__["a" /* HistoryComponent */], __WEBPACK_IMPORTED_MODULE_8__member_member_component__["a" /* MemberComponent */]]
    })
], MyModule);
...
/***/ "../../../../../src/app/my/my.router.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MyRoute; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__history_history_component__ = __webpack_require__("../../../../../src/app/my/history/history.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__my_component__ = __webpack_require__("../../../../../src/app/my/my.component.ts");
...
var MyRoute = [
    ...
    {
        path: 'index',
        component: __WEBPACK_IMPORTED_MODULE_1__my_component__["a" /* MyComponent */]
    },
    {
        path: 'history',
        component: __WEBPACK_IMPORTED_MODULE_0__history_history_component__["a" /* HistoryComponent */]
    }
];
//# sourceMappingURL=my.router.js.map

/***/ }),

/***/ "../../../../../src/app/my/service/my.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var MyService = (function () {
    ...
    MyService.prototype.getMember = function () {
        var data = JSON.parse(localStorage.getItem('appData'));
        return data.info;
    };
    MyService.prototype.testwx = function () {
        // https://hui.shenercloud.com/api/recommend/get
        var url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx7c4f6fbaeb32bbea&redirect_uri=http://192.168.100.76:2016/index.html&response_type=code&scope=snsapi_userinfo&state=d69601f3d4db48d645925e2cd0566095&connect_redirect=1#wechat_redirect';
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]({ 'Content-Type': 'application/json' });
        var options = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["e" /* RequestOptions */]({ headers: headers });
