...
+ function($) {
  ...
  $.login = function(text, title, onOK, onCancel, username, password) {
    ...
    var modal = $.modal({
      text: '<p class="weui-prompt-text">'+(config.text || '')+'</p>' +
            '<input type="text" class="weui-input weui-prompt-input" id="weui-prompt-username" value="' + (config.username || '') + '" placeholder="�����û���" />' +
  ...
  defaults = $.modal.prototype.defaults = {
    ...
    autoClose: true //�����ť�Զ��رնԻ�������㲻ϣ�������ť�͹رնԻ��򣬿��԰��������Ϊfalse
  };
...
+ function($) {
  ...
  $.toast = function(text, style, callback) {
    ...
    show('<i class="' + iconClassName + ' weui-icon_toast"></i><p class="weui-toast_content">' + (text || "�Ѿ����") + '</p>', className);
  ...
  $.showLoading = function(text) {
    ...
    html += '</div>';
    html += '<p class="weui-toast_content">' + (text || "���ݼ�����") + '</p>';
  ...
  var show = function(params) {
    ...
    var tpl = '<div class="weui-actionsheet " id="weui-actionsheet">'+
                ...
                '<div class="weui-actionsheet__action">'+
                  '<div class="weui-actionsheet__cell weui-actionsheet_cancel">ȡ��</div>'+
                  '</div>'+
                '</div>';
    var dialog = $(tpl).appendTo(document.body);
...
+ function($) {
  ...
  var Picker = function (params) {
      ...
      p.initPickerCol = function (colElement, updateItems) {
          ...
          col.updateItems = function (activeIndex, translate, transition, valueCallbacks) {
              ...
              */
              //ȥ�� .picker-after-selected, .picker-before-selected ���������
  ...
  $.openPicker = function(tpl, className, callback) {
    ...
    //���ڲ��ֵ����⣬���ֱ�ӷ���body�ϣ�����������ʱ���ſ�body�߶ȶ����¹������仯��
    var dialog = $(tpl).appendTo(container);
    
    dialog.width(); //ͨ��ȡһ��CSSֵ��ǿ����������ܰ��������д���ϲ�ִ�У���Ϊ�ϲ�֮��ᵼ���޷����ֶ�����
...
+ function($) {
  ...
  Select.prototype.parseInitValue = function() {
    ...
    //���inputΪ�գ�ֻ���ڵ�һ�γ�ʼ����ʱ��ű���Ĭ��ѡ����Ϊ���������û��Լ�ȡ����ȫ��ѡ�񣬲�����Ϊ��ѡ��Ĭ��ֵ��
  ...
  Select.prototype.open = function(values, titles) {
    ...
    // open picker ��Ĭ�Ϲص������ģ����� onClose ���ᱻ���ã����������ȹص�����select
    for (var i = 0; i < selects.length; i++ ) {
      var s = selects[i];
      if (s === this) continue;
      if (s._open) {
        if(!s.close()) return false; // ������select����ĳЩ�������ƹر�ʧ�ܡ�
      }
    }
    ...
    if(!force) {
      ...
      if(this.config.multi) {
        if(this.config.min !== undefined && this.data.length < this.config.min) {
          $.toast("������ѡ��"+this.config.min+"��", "text");
          return false
        }
        if(this.config.max !== undefined && this.data.length > this.config.max) {
          $.toast("���ֻ��ѡ��"+this.config.max+"��", "text");
          return false
        }
      }
    }
...
+function ($) {
  ...
  var Calendar = function (params) {
      ...
      p.addValue = function (value) {
          if (p.params.multiple) {
              ...
              if (typeof inValuesIndex === 'undefined') {
                  ...
                  //p.value.splice(inValuesIndex, 1); 去除注解可能把选择的删除 
              }
              p.updateValue();
          }
          else {
      ...
      p.initCalendarEvents = function () {
          ...
          function handleDayClick(e) {
              ...
              */
			  ...
			  var today=new Date();
			  if(new Date(today.getFullYear(),today.getMonth(),today.getDate() ).getTime()==new Date(dateYear, dateMonth, dateDay).getTime() ){
      ...
      p.close = function () {
          if (!p.opened || p.inline) return;
          p.animating = false;  //�п��ܻ��ж���û���꣬���animating���û�û�ġ�
          if (inPopover()) {
              $.closePicker(p.popover);
              return;
          }
...
+ function($) {
  ...
  defaults = $.fn.datetimePicker.prototype.defaults = {
    input: undefined, // Ĭ��ֵ
    min: undefined, // YYYY-MM-DD �����Сֵֻ�Ƚ������գ����Ƚ�ʱ����
    max: undefined,  // YYYY-MM-DD
    yearSplit: '-',
    monthSplit: '-',
    dateSplit: '',  // Ĭ��Ϊ��
    datetimeSplit: ' ',  // ���ں�ʱ��֮��ķָ��������Ϊ��
    times: function () {
      return [  // �Զ����ʱ��
        {
          values: (function () {
    ...
    parse: function (str) {
      // ���ַ���ת�������飬����������ʼֵ
      // �����Ķ��Ƶĳ�ʼֵ��ʽ�޷������Ĭ�Ϻ������������Զ�������������������ʱ���� '��ʱ' ��ôĬ��������'ʱ'�ᱻ�����ָ�������´�����������Ҫ�Լ�����parse����
      // Ĭ�ϼ��ݵķָ��
      var t = str.split(this.datetimeSplit);
      return t[0].split(/\D/).concat(t[1].split(/:|ʱ|��|��/)).filter(function (d) {
        return !!d;
      })
    }
  }
...
+ function($) {
  ...
  //Popup �� picker ֮��Ĳ�Ҫ����һ��������������Ϊ�����ᵼ�� �� popup ���ٵ��� picker ��ʱ��������⡣
