...
namespace SfSoft.SQLServerDAL
{
	...
	/// 数据访问类:WX_QA_Like
	/// </summary>
	public partial class WX_QA_Like:IWX_QA_Like
	{
		public WX_QA_Like()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "WX_QA_Like"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from WX_QA_Like");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SfSoft.Model.WX_QA_Like model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into WX_QA_Like(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SfSoft.Model.WX_QA_Like model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update WX_QA_Like set ");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from WX_QA_Like ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_QA_Like GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,AppId,ReadFileId,OpenId,CreateDate,NickName,HeadImgUrl from WX_QA_Like ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_QA_Like DataRowToModel(DataRow row)
		{
			SfSoft.Model.WX_QA_Like model=new SfSoft.Model.WX_QA_Like();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from WX_QA_Like T ");
