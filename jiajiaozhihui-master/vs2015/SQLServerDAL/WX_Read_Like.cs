...
namespace SfSoft.SQLServerDAL
{
	...
	/// 数据访问类:WX_Read_Like
	/// </summary>
	public partial class WX_Read_Like:IWX_Read_Like
	{
		public WX_Read_Like()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "WX_Read_Like"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from WX_Read_Like");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SfSoft.Model.WX_Read_Like model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into WX_Read_Like(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SfSoft.Model.WX_Read_Like model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update WX_Read_Like set ");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from WX_Read_Like ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_Read_Like GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,AppId,ReadFileId,OpenId,CreateDate,NickName,HeadImgUrl from WX_Read_Like ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
			...
			SfSoft.Model.WX_Read_Like model=new SfSoft.Model.WX_Read_Like();
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_Read_Like DataRowToModel(DataRow row)
		{
			SfSoft.Model.WX_Read_Like model=new SfSoft.Model.WX_Read_Like();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM WX_Read_Like ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from WX_Read_Like T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "WX_Read_Like";
