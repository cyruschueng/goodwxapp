...
{
	/// <summary>
	/// 数据访问类:WX_Libao_Set_Class
	/// </summary>
	public partial class WX_Libao_Set_Class:IWX_Libao_Set_Class
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "WX_Libao_Set_Class"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from WX_Libao_Set_Class");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SfSoft.Model.WX_Libao_Set_Class model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into WX_Libao_Set_Class(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SfSoft.Model.WX_Libao_Set_Class model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update WX_Libao_Set_Class set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from WX_Libao_Set_Class ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_Libao_Set_Class GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,ClassID,PID,SPID,ClassType,ClassName,IsAct,Sort from WX_Libao_Set_Class ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			SfSoft.Model.WX_Libao_Set_Class model=new SfSoft.Model.WX_Libao_Set_Class();
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_Libao_Set_Class DataRowToModel(DataRow row)
		{
			SfSoft.Model.WX_Libao_Set_Class model=new SfSoft.Model.WX_Libao_Set_Class();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM WX_Libao_Set_Class ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from WX_Libao_Set_Class T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "WX_Libao_Set_Class";
