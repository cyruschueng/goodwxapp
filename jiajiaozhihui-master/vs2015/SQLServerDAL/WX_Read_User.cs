...
namespace SfSoft.SQLServerDAL
{
	...
	/// 数据访问类:WX_Read_User
	/// </summary>
	public partial class WX_Read_User:IWX_Read_User
	{
		public WX_Read_User()
		{}
		#region  BasicMethod
		...
		public bool Exists(string AppId,string OpenId)
		{
			...
			strSql.Append("select count(1) from WX_Read_User");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(SfSoft.Model.WX_Read_User model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into WX_Read_User(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SfSoft.Model.WX_Read_User model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update WX_Read_User set ");
		...
		public bool Delete(string AppId,string OpenId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from WX_Read_User ");
			strSql.Append(" where AppId=@AppId and OpenId=@OpenId ");
			SqlParameter[] parameters = {
					new SqlParameter("@AppId", SqlDbType.NVarChar,50),
					new SqlParameter("@OpenId", SqlDbType.NVarChar,100)			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_Read_User GetModel(string AppId,string OpenId)
		{
			
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select  top 1 AppId,OpenId,UserType,StartDate,EndDate,RegionDate,IsAct,ChildAge,Telephone,BorthDay,Sex from WX_Read_User ");
			strSql.Append(" where AppId=@AppId and OpenId=@OpenId ");
			SqlParameter[] parameters = {
					new SqlParameter("@AppId", SqlDbType.NVarChar,50),
					new SqlParameter("@OpenId", SqlDbType.NVarChar,100)			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_Read_User DataRowToModel(DataRow row)
		{
			SfSoft.Model.WX_Read_User model=new SfSoft.Model.WX_Read_User();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM WX_Read_User ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from WX_Read_User T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "WX_Read_User";
			parameters[1].Value = "OpenId";
