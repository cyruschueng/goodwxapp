...
{
	/// <summary>
	/// 数据访问类:WX_QA_File_Data
	/// </summary>
	public partial class WX_QA_File_Data:IWX_QA_File_Data
	{
		public WX_QA_File_Data()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "WX_QA_File_Data"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from WX_QA_File_Data");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SfSoft.Model.WX_QA_File_Data model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into WX_QA_File_Data(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SfSoft.Model.WX_QA_File_Data model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update WX_QA_File_Data set ");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from WX_QA_File_Data ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_QA_File_Data GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,AppId,ReadFileId,TemporaryUrl,CloudUrl,UrlType,MediaId,FileId from WX_QA_File_Data ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
			...
			SfSoft.Model.WX_QA_File_Data model=new SfSoft.Model.WX_QA_File_Data();
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_QA_File_Data DataRowToModel(DataRow row)
		{
			SfSoft.Model.WX_QA_File_Data model=new SfSoft.Model.WX_QA_File_Data();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM WX_QA_File_Data ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from WX_QA_File_Data T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "WX_QA_File_Data";
