...
namespace SfSoft.SQLServerDAL
{
	...
	/// 数据访问类:WX_Yuedu_File
	/// </summary>
	public partial class WX_Yuedu_File:IWX_Yuedu_File
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "WX_Yuedu_File"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from WX_Yuedu_File");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SfSoft.Model.WX_Yuedu_File model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into WX_Yuedu_File(");
			strSql.Append("AppId,OpenId,LikeNumber,CommentNumber,CreateDate,Sn,IsTop,Status,Comment,FileType)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SfSoft.Model.WX_Yuedu_File model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update WX_Yuedu_File set ");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from WX_Yuedu_File ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_Yuedu_File GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,AppId,OpenId,LikeNumber,CommentNumber,CreateDate,Sn,IsTop,Status,Comment,FileType from WX_Yuedu_File ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
			...
			SfSoft.Model.WX_Yuedu_File model=new SfSoft.Model.WX_Yuedu_File();
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_Yuedu_File DataRowToModel(DataRow row)
		{
			SfSoft.Model.WX_Yuedu_File model=new SfSoft.Model.WX_Yuedu_File();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,AppId,OpenId,LikeNumber,CommentNumber,CreateDate,Sn,IsTop,Status,Comment,FileType ");
			strSql.Append(" FROM WX_Yuedu_File ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,AppId,OpenId,LikeNumber,CommentNumber,CreateDate,Sn,IsTop,Status,Comment,FileType ");
			strSql.Append(" FROM WX_Yuedu_File ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from WX_Yuedu_File T ");
        ...
        public DataSet GetList(int PageSize, int PageIndex, string orderType, string strWhere)
        {
            ...
            parameters[0].Value = "WX_Yuedu_File";
