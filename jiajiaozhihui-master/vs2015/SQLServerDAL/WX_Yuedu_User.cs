...
namespace SfSoft.SQLServerDAL
{
	...
	/// 数据访问类:WX_Yuedu_User
	/// </summary>
	public partial class WX_Yuedu_User:IWX_Yuedu_User
	{
		public WX_Yuedu_User()
		{}
		#region  BasicMethod
		...
		public bool Exists(string AppId,string OpenId)
		{
			...
			strSql.Append("select count(1) from WX_Yuedu_User");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(SfSoft.Model.WX_Yuedu_User model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into WX_Yuedu_User(");
            strSql.Append("AppId,OpenId,UserType,StartDate,EndDate,RegionDate,IsAct,ChildAge,Telephone,BorthDay,Sex)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SfSoft.Model.WX_Yuedu_User model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update WX_Yuedu_User set ");
		...
		public bool Delete(string AppId,string OpenId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from WX_Yuedu_User ");
			strSql.Append(" where AppId=@AppId and OpenId=@OpenId ");
			SqlParameter[] parameters = {
					new SqlParameter("@AppId", SqlDbType.NVarChar,50),
					new SqlParameter("@OpenId", SqlDbType.NVarChar,100)			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_Yuedu_User GetModel(string AppId,string OpenId)
		{
			
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select  top 1 AppId,OpenId,UserType,StartDate,EndDate,RegionDate,IsAct,ChildAge,Telephone,BorthDay,Sex from WX_Yuedu_User ");
			strSql.Append(" where AppId=@AppId and OpenId=@OpenId ");
			SqlParameter[] parameters = {
					new SqlParameter("@AppId", SqlDbType.NVarChar,50),
					new SqlParameter("@OpenId", SqlDbType.NVarChar,100)			};
			...
			SfSoft.Model.WX_Yuedu_User model=new SfSoft.Model.WX_Yuedu_User();
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_Yuedu_User DataRowToModel(DataRow row)
		{
			SfSoft.Model.WX_Yuedu_User model=new SfSoft.Model.WX_Yuedu_User();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select AppId,OpenId,UserType,StartDate,EndDate,RegionDate,IsAct,ChildAge,Telephone,BorthDay,Sex ");
			strSql.Append(" FROM WX_Yuedu_User ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from WX_Yuedu_User T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "WX_Yuedu_User";
			parameters[1].Value = "OpenId";
