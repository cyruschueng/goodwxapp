...
{
	/// <summary>
	/// 数据访问类:WX_Yuedu_Award_Detail
	/// </summary>
	public partial class WX_Yuedu_Award_Detail:IWX_Yuedu_Award_Detail
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "WX_Yuedu_Award_Detail"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from WX_Yuedu_Award_Detail");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SfSoft.Model.WX_Yuedu_Award_Detail model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into WX_Yuedu_Award_Detail(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SfSoft.Model.WX_Yuedu_Award_Detail model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update WX_Yuedu_Award_Detail set ");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from WX_Yuedu_Award_Detail ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_Yuedu_Award_Detail GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,OpenId,AwardType,Award,CreateDate,Origin,OriginRemark from WX_Yuedu_Award_Detail ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
			...
			SfSoft.Model.WX_Yuedu_Award_Detail model=new SfSoft.Model.WX_Yuedu_Award_Detail();
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_Yuedu_Award_Detail DataRowToModel(DataRow row)
		{
			SfSoft.Model.WX_Yuedu_Award_Detail model=new SfSoft.Model.WX_Yuedu_Award_Detail();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM WX_Yuedu_Award_Detail ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from WX_Yuedu_Award_Detail T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "WX_Yuedu_Award_Detail";
