...
namespace SfSoft.SQLServerDAL
{
	...
	/// 数据访问类:WX_Read_File
	/// </summary>
	public partial class WX_Read_File:IWX_Read_File
	{
		public WX_Read_File()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "WX_Read_File"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from WX_Read_File");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SfSoft.Model.WX_Read_File model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into WX_Read_File(");
            strSql.Append("AppId,OpenId,LikeNumber,CommentNumber,CreateDate,Sn,IsTop,Status,Comment,FileType,PlanId)");
            ...
            parameters[10].Value = model.PlanId;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SfSoft.Model.WX_Read_File model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update WX_Read_File set ");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from WX_Read_File ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_Read_File GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select  top 1 Id,AppId,OpenId,LikeNumber,CommentNumber,CreateDate,Sn,IsTop,Status,Comment,FileType,PlanId from WX_Read_File ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_Read_File DataRowToModel(DataRow row)
		{
			SfSoft.Model.WX_Read_File model=new SfSoft.Model.WX_Read_File();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select Id,AppId,OpenId,LikeNumber,CommentNumber,CreateDate,Sn,IsTop,Status,Comment,FileType,PlanId ");
			strSql.Append(" FROM WX_Read_File ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
            ...
            strSql.Append(" Id,AppId,OpenId,LikeNumber,CommentNumber,CreateDate,Sn,IsTop,Status,Comment,FileType,PlanId ");
			strSql.Append(" FROM WX_Read_File ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from WX_Read_File T ");
        ...
        public DataSet GetList(int PageSize, int PageIndex, string orderType, string strWhere)
        {
            ...
            parameters[0].Value = "WX_Read_File";
