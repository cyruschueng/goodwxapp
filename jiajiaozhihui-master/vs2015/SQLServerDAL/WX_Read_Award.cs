...
namespace SfSoft.SQLServerDAL
{
	...
	/// 数据访问类:WX_Read_Award
	/// </summary>
	public partial class WX_Read_Award:IWX_Read_Award
	{
		public WX_Read_Award()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "WX_Read_Award"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from WX_Read_Award");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SfSoft.Model.WX_Read_Award model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into WX_Read_Award(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SfSoft.Model.WX_Read_Award model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update WX_Read_Award set ");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from WX_Read_Award ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
        ...
        public SfSoft.Model.WX_Read_Award GetModel(string openId, int awardType)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,OpenId,AwardType,Earn,Expense from WX_Read_Award ");
            ...
            SfSoft.Model.WX_Read_Award model = new SfSoft.Model.WX_Read_Award();
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_Read_Award GetModel(int Id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,OpenId,AwardType,Earn,Expense from WX_Read_Award ");
			strSql.Append(" where Id=@Id");
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.WX_Read_Award DataRowToModel(DataRow row)
		{
			SfSoft.Model.WX_Read_Award model=new SfSoft.Model.WX_Read_Award();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM WX_Read_Award ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from WX_Read_Award T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "WX_Read_Award";
