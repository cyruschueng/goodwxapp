...
namespace ShenerWeiXin
{
    ...
    /// </summary>
    public partial class CustomMessageHandlerII : MessageHandler<CustomMessageContext>
    {
        /*
        ...
        private string appId = "wxdcc37546ccefc3ef";
        private string appSecret = "1d7b0b50feb6923d583fdab70f5c0e34";

        public CustomMessageHandlerII(Stream inputStream, PostModel postModel, int maxRecordCount = 0)
