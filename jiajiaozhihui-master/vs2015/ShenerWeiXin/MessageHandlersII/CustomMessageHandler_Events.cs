...
namespace ShenerWeiXin
{
    ...
    /// 自定义MessageHandler
    /// </summary>
    public partial class CustomMessageHandlerII
    {
        private string GetWelcomeInfo()
        {
            ShenerWeiXin.Common.Message a = new ShenerWeiXin.Common.Message("pingeyc");
        ...
        public override IResponseMessageBase OnEvent_ClickRequest(RequestMessageEvent_Click requestMessage)
        {
            ...
            switch (requestMessage.EventKey)
            {
                ...
                case "video":
                    {
                        ShenerWeiXin.Common.Message replyMessage = new ShenerWeiXin.Common.Message("pingeyc");
                        var m = replyMessage.Messages.Where(e => e.Tags == "video");
        ...
        public override IResponseMessageBase OnEvent_SubscribeRequest(RequestMessageEvent_Subscribe requestMessage)
        {
            ...
            ShenerWeiXin.Common.Message replyMessage = new ShenerWeiXin.Common.Message("pingeyc");
            var m = replyMessage.Messages.Where(e => e.KeyWord.ToLower() == "subscriberequest").FirstOrDefault<Message>();
            if (m.MsgType == "news") {
                var responseMessage = ResponseMessageBase.CreateFromRequestMessage<ResponseMessageNews>(requestMessage);
                responseMessage.Articles.Add(new Article()
                {
            ...
            {
                var responseMessage = ResponseMessageBase.CreateFromRequestMessage<ResponseMessageText>(requestMessage);
                responseMessage.Content = m.Content;
                return responseMessage;
            }
            else { 
                var responseMessage = ResponseMessageBase.CreateFromRequestMessage<ResponseMessageText>(requestMessage);
                responseMessage.Content = ShenerWeiXin.Common.Message.AutoAttention;
                return responseMessage;
            }
        }
