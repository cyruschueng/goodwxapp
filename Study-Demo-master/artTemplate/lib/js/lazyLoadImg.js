 ...
 * @filedesc lazyLoadImg.js
 * @authors lq
 * @email 610970478@qq.com
 * @date 2017-07-17 09:47:10
 * @version v1.0
*/
...
var loadImgFun = function(target,LazyLoadImg,failImg){
    var lazyLoadImg = new LazyLoadImg({
        el: document.querySelector(target),
        mode: 'diy', //default 默认模式，将显示原图，diy模式，将自定义剪切，默认剪切居中部分
        time: 100, // 设置一个检测时间间隔
        ...
        success: function (el) { // 图片加载成功执行方法
            el.classList.add('loadImgSuccess');
        },
