...
function getYAxisTextList(series, opts, config) {
    ...
    var range = [];
    //y轴的情况
    var between_range = (maxRange - minRange);
   
    var eachRange = (maxRange - minRange) / config.yAxisSplit;

    if (between_range == 1) {
      eachRange= 1;
    } else if (between_range < 5) {
      eachRange= 1;
    } else if (between_range < 10) {
      eachRange = 2;
    } else if (between_range < 20) {
      eachRange = 3;
    } else if (between_range < 30) {
      eachRange = 4;
    } else if (between_range < 40) {
      eachRange = 5;
    } else  {
      eachRange = 6;
    }
