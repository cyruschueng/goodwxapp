...
Page({
  ...
  index_nav_bind:function(e){
    ...
    if(this_name == 'index'){
        ...
        that.setData({
          this_weiba_id:that.data.this_gonggao_id
        })
  ...
  onLoad:function(options){
    ...
    onShow:function(){
      ...
      //获取分享数据
      _function.getShareData('weiba',that.initGetShareData,that)
      //获取公告ID
    ...
    initGetShareData:function(data){
        var that = this
        that.setData({
            g_share_title:data.info.title,
            g_share_desc:data.info.desc
        })
    },
