...
module.exports = {
    ...
    //获取所有门店数据列表
    getcompanylist: WYY_HOST_URL + "/Wap.php/" + c + "/companylist",
    //获取指定门店信息  根据门店id获取门店详情
    getcompanybyid: WYY_HOST_URL + "/Wap.php/" + c + "/getcompanybyid",
    ...
    //根据门店id和餐桌状态获取餐桌列表  根据门店id和餐桌状态获取餐桌列表,cid
    ...
    //外卖关闭或开启
    waimai_isopen: WYY_HOST_URL + "/Wap.php/" + c + "/waimai_isopen",

    //判断是否多门店
    getDishConfig: WYY_HOST_URL + "/Wap.php/" + c + "/getDishConfig",

    //多门店轮播图
    getslide: WYY_HOST_URL + "/Wap.php/" + c + "/getslide",

    //排序
    companyList: WYY_HOST_URL + "/Wap.php/" + c + "/companyList",
