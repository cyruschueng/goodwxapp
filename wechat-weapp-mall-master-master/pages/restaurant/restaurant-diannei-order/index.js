...
Page({
  ...
  goods_info_bind: function(e){
    ...
    wx.navigateTo({
      url: '../restaurant-diannei-detail/detail?id=' + len + "&cid=" + that.data.this_dish_id,
    })
  },
  ...
  go_user_order_bind: function (e) {
    ...
    var that = this;
    wx.navigateTo({
      url: '/pages/restaurant/restaurant-diannei-list/list?diancansn=' + that.data.diancansn + '&totalprice=' + that.data.totalprice + "&cid=" + that.data.this_dish_id
    });
  },
            ...
            if (res.errMsg == 'requestPayment:ok'){
              ...
              wx.showModal({
                ...
                success: function(res){
                    if(res.confirm){
                      wx.redirectTo({
                        url: '../restaurant-diannei-list/list?diancansn=' + that.data.diancansn+"&cid=" + that.data.this_dish_id,
                      });
                    }   
                }
              })
