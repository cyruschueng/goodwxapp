...
class Domain_Share extends Domain_Common{
    ...
    protected $share_weibo_img = 'http://mibores.yahalei.com/img/default/logo80.png';
    ...
    public function shareLive() {
        ...
        $share_info = array(
            ...
            'imgUrl'  => $this->req['share_type'] == 3 ? $this->share_weibo_img : $live_info['cover_url'],
    ...
    public function shareReplay() {
        ...
        $anchor_info = $user_domain->checkUser($live_info['anchor_id']);
        //$share_url = "http://api.mibolive.com/apps/mibo/d.php?a=1000&c=official";
        $share_url = "http://os.mibolive.com/index.php?g=web&m=share&a=seeLive&m3u8_url=" .
                $live_info['replay_url'] . '&cover_url=' . $live_info['cover_url'];

        $title = "【".$anchor_info['nick_name']."】精彩回放";
        $desc = "我在看【".$anchor_info['nick_name']."】直播回放，快来围观！";
    ...
    public function sharePreview() {
        ...
        if(isset($live_info['location']) && !empty($live_info['location']) && $live_info['location'] != '火星') {
            $title = "【".$anchor_info['nick_name']."】即将直播";
            $desc = "我关注的【".$anchor_info['nick_name']."】即将开播，快来围观！";
        } else {
            $title = "【".$anchor_info['nick_name']."】即将直播";
            $desc = "我关注的【".$anchor_info['nick_name']."】即将开播，快来围观！";
        }
