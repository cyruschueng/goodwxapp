...
class Api_App extends PhalApi_Api {
        ...
        return array(
            ...
            'getShareInfo'    => array(
                ...
                'from'       => array('name' => 'from', 'type' => 'int', 'require' => false, 'default'=> 1,
                                      'desc' => '从哪里进行的分享 1：直播间  2：娱乐场  3：PK场房间 4：房间战绩分享 5：每日送卡
                                      6：个人战绩分享 7:分享预告 9：直播回放'),
     ...
     * iOS获取最新版本
     * @desc iOS获取最新版本
     * @request http://mibotest.yahalei.com/mibo30/index.php?service=app.getIosVersion&channel=ss&mibo
     */
    public function getIosVersion() {
        $new_version = $this->appDomain->getIosVersion();
        return $new_version;
    }
     ...
     * @request https://mibo.yahalei.com/mibo27/index.php?service=app.getAppConfig&mibo&channel=official&version_name=aa&version_code=18&device=aa&imei=ss&os=iOS
     */
