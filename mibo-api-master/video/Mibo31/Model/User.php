...
class Model_User extends PhalApi_Model_NotORM {
    ...
    public function searchUser($key_word, $offset, $page_size) {
        $user_list = DI()->notorm->user->where('mb_id like "%' . $key_word . '%" or nick_name like "%' . $key_word . '%"')
            ->limit($offset, $page_size)->fetchPairs('id');
        return $user_list;
    }
    ...
    public function getDealerInfoById($live_id, $user_id) {
        ...
        DI()->redis->set_time('dealer_live_id_'.$live_id, $dealer_info, 22);
        return $dealer_info;
    }
