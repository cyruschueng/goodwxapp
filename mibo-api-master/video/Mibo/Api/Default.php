...
class Api_Default extends PhalApi_Api {
    ...
    public function test() {
        ...
        $live_info = $model->getLiveInfoByLiveId(7);
        print_r($live_info);exit;
...
//        $this->notifyFansWhenLive(3243,503);
    ...
    public function testRedis() {
        ...
        $rs = DI()->redis->get_incr($loop_num_key);
        var_dump($rs);exit;
...
//        var_dump($rs);
    ...
    public function testMsg() {
        ...
        //
        //$rs = $easemob->getChatRecord('2017042706');
        //print_r($rs);exit;

        $domain = new Domain_HalfHourCrond();
        $domain->saveMsgLog();
