...
class Api_Default extends PhalApi_Api {
    ...
    public function test() {
        ...
        //$model = new Model_AppConfig();
        //$ss = $model->getEntryNoticeContent();
        //var_dump($ss);exit;

        $domain = new Domain_DNGame();
        $rs = $domain->reqCard();
        print_r($rs);exit;
    ...
    public function test1() {
        ...
        //$rs = DI()->redis->get_rPop('notify_fans_when_live');
        //print_r($rs);exit;
    ...
    public function testPayback() {
        $aop = new Alipay_AopClient ();
        $aop->gatewayUrl = 'https://openapi.alipay.com/gateway.do';
        $aop->appId = '2017031506233159';
      
        $aop->rsaPrivateKey = '';
      
        $aop->alipayrsaPublicKey='';
        $aop->apiVersion = '1.0';
        $aop->signType = 'RSA2';
        $aop->postCharset='UTF-8';
        $aop->format='json';
        $request = new Alipay_AlipayTradeRefundRequest ();
...
<Delete>
  ...
  <Object>
    <Key>demo.jpg</Key>
        ...
        $content_len = strlen($xml);
        $content_md5 = base64_encode(md5($xml));

        $url = 'miboinput.oss-cn-hangzhou.aliyuncs.com?delete';
        ...
        $header = array(
            ...
            'Authorization: OSS dDrAxYX2oSApfHt5:DMDCEwYjSZBIwhTe4FiyiRUC2jvbXE',
            );
        $body = $xml;
        $type = 'POST';
...
//        $this->notifyFansWhenLive(3243,503);
    ...
    public function testRedis() {
        $redis_key = 'test-list';
        $arr = ['姓名：李四', '米币数量：300', '米钻数量：500'];
        $a = DI()->redis->set_lPush($redis_key, $arr);
        var_dump($a);exit;
    ...
    public function testOss() {
        ...
        $oss = new OSSObject_Lite();
        $oss->listObjects();
        //$ss = $oss->listAllObjects('record/mibo/mb-1221-15543/');
        //print_r($ss);exit;
    }
    ...
    public function testLive() {
        $page_no = DI()->request->get('page_no');
        $page_no = $page_no ? $page_no : 1;
        $page_size = DI()->request->get('page_size');
        $page_size = $page_size && $page_size <= 30 ? $page_size : 20;
        $offset = ($page_no - 1) * $page_size;
        $sql = 'select l.* from mb_live_list as l left join mb_user u on l.anchor_id = u.id ' .
            'where u.channel = "AppStore" and l.status = 3 order by id desc limit ' .
            $offset . ',' . $page_size;
        $list = DI()->notorm->example->queryAll($sql);
        return $list;
    }
...
//        var_dump($rs);
    ...
    public function testMsg() {
        //$emchat = new Emchat_Lite();
        $chatroom_id = '18082648096770';
        //$rs = $emchat->getChatRoomAdmin('17277407789057');
        //$rs = $emchat->addChatRoomAdmin($chatroom_id, 'mibokf1000');
        //print_r($rs);exit;
        //exit;
        $domain_im = new Domain_IM();
        $ss = $domain_im->isMute('ss', $chatroom_id);
        var_dump($ss);exit;
        exit;
        $emchat = new Emchat_Lite();
        $rs = $emchat->getRoomMuteList($chatroom_id);
        print_r($rs);exit;
...
//        $rs = $im_domain->sendUserMsg(2, 11660, $msg);
    ...
    public function testSql() {
        ...
        foreach($arr as $channel) {
            ...
            $down_url = 'http://cdn88.mibolive.com/apk/mibo3510/mibo_3.5.10_' . $channel . '.apk';
            $data = [
                'name' => $channel,
                'channel' => $channel,
                'version_code' => 30,
