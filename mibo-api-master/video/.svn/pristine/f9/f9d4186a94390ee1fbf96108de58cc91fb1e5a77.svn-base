...
<div class="maincontainer">
        ...
        <div class="author-cover js_author_cover">
            <div class="author-wrap">
                <div class="video_pic">
                    ...
                    <a class="click-play-btn" href="./play.php?m3u8_url=<?php echo $live_info['m3u8_url'] ?>&cover_url=<?php $live_info['cover_url'] ?>"><img src="../res/img/play-btn.png" alt=""></a>
                </div>
                <div class="top-wrap">
                <span class="typeTest ">
    ...
    <?php
        if(isset($_GET['anchor_id']) && is_numeric($_GET['anchor_id']) && isset($_GET['live_id'])) {
            ...
            'user.level, user.avatar, user.mb_id from mb_live_list as live left join mb_user as user on ' .
            'live.anchor_id = user.id where live.status = 0 or live.status = 1 or (live.status = 2 and ' .
            ...
            'order by live.type ASC, live.status DESC';
             ...
             $sql = 'select live.*, user.nick_name, user.sex, user.address, user.signature, ' .
            'user.level, user.avatar, user.mb_id from mb_live_list as live left join mb_user as user on ' .
            'live.anchor_id = user.id where live.status = 0 or live.status = 1 or live.status = 2 ' .
            'order by live.type';
        }
    ...
    <?php }elseif($live['status'] == 2) { ?>
            ...
            <div class="author-wrap">
                <div class="video_pic">
                    ...
                    <div class="live-mask"></div>
                    <?php if($live['type'] == 0){ ?>
                    <a class="click-play-btn" href="./play.php?m3u8_url=<?php echo $live['m3u8_url'] ?>&cover_url=<?php $live['cover_url'] ?>"><img src="./res/img/play-btn.png" alt=""></a>
                    <?php } ?>
                </div>
                <div class="top-wrap">
                <span class="typeTest ">
...
//        ifr.src = "mblive://mibo.yahalei.com/live?type=1&id=<?// echo $live_info['id']; ?>//";
