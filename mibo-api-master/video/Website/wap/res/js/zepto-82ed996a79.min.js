var Zepto = function() {
	...
	function p(t) {
		return "children" in t ? A.call(t.children) : j.map(t.childNodes, function(t) {
	...
	return J.matches = function(t, e) {
		...
		var r, i, a;
		return $.test(t) && (r = j(M.createElement(RegExp.$1))), r || (t.replace && (t = t.replace(R, "<$1></$2>")), e === E && (e = F.test(t) && RegExp.$1), e in _ || (e = "*"), a = _[e], a.innerHTML = "" + t, r = j.each(A.call(a.childNodes), function() {
			a.removeChild(this)
		...
		filter: function(t) {
			return e(t) ? this.not(this.not(t)) : j(D.call(this, function(e) {
		...
		not: function(t) {
			...
			if (e(t) && t.call !== E) this.each(function(e) {
				...
				var r = "string" == typeof t ? this.filter(t) : a(t) && e(t.item) ? A.call(t) : j(t);
		...
		removeClass: function(t) {
			return this.each(function(e) {
				if ("className" in this) {
					...
					S = w(this), v(this, t, e, S).split(/\s+/g).forEach(function(t) {
						S = S.replace(l(t), " ")
					}), w(this, S.trim())
				}
			})
		...
		offsetParent: function() {
			return this.map(function() {
				for (var t = this.offsetParent || M.body; t && !q.test(t.nodeName) && "static" == j(t).css("position");) t = t.offsetParent;
				return t
			})
		}
	...
	}), J.Z.prototype = d.prototype = j.fn, J.uniq = N, J.deserializeValue = b, j.zepto = J, j
}();
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
	function(t) {
		...
		function n(t, n, r, i) {
			return t.global ? e(n || w, r, i) : void 0
		}
		...
		C.href = window.location.href, t.active = 0, t.ajaxJSONP = function(e, n) {
			...
			r(u), u.crossDomain || (n = w.createElement("a"), n.href = u.url, n.href = n.href, u.crossDomain = C.protocol + "//" + C.host != n.protocol + "//" + n.host), u.url || (u.url = window.location.toString()), (i = u.url.indexOf("#")) > -1 && (u.url = u.url.slice(0, i)), p(u);
			var m = u.dataType,
				y = /\?.+=\?/.test(u.url);
	...
	function(t) {
		...
		t(document).ready(function() {
			...
			"MSGesture" in window && (f = new MSGesture, f.target = document.body), t(document).bind("MSGestureEnd", function(t) {
				...
				(!(v = a(t, "move")) || o(t)) && (g = v ? t : t.touches[0], r(), h.x2 = g.pageX, h.y2 = g.pageY, y += Math.abs(h.x1 - h.x2), w += Math.abs(h.y1 - h.y2))
				...
				(!(v = a(n, "up")) || o(n)) && (r(), h.x2 && Math.abs(h.x1 - h.x2) > 30 || h.y2 && Math.abs(h.y1 - h.y2) > 30 ? c = setTimeout(function() {
					...
					var e = t.Event("tap");
					e.cancelTouch = i, h.el && h.el.trigger(e), h.isDoubleTap ? (h.el && h.el.trigger("doubleTap"),
