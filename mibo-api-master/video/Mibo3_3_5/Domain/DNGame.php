    ...
    public function getCardStyle($card_info) {
        ...
        switch ($rate) {
            case NIU_WU:
                ...
                break;
            case NIU_1:
                $style = DN_CARD_STYLE_NIU1;
                break;
            case NIU_2:
                $style = DN_CARD_STYLE_NIU2;
                break;
            case NIU_3:
                $style = DN_CARD_STYLE_NIU3;
                break;
            case NIU_4:
                $style = DN_CARD_STYLE_NIU4;
                break;
            case NIU_5:
                $style = DN_CARD_STYLE_NIU5;
                break;
            case NIU_6:
                $style = DN_CARD_STYLE_NIU6;
                break;
            case NIU_7:
                $style = DN_CARD_STYLE_NIU7;
                break;
            case NIU_8:
                $style = DN_CARD_STYLE_NIU8;
                break;
            case NIU_9:
                $style = DN_CARD_STYLE_NIU9;
                break;
            case NIU_NIU:
