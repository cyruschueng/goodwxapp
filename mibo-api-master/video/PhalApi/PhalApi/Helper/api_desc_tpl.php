...
echo <<<EOT
            ...
            <table class="ui yellow celled striped table" >
                ...
                <tbody>
EOT;
    echo "<tr><td>$request &nbsp;&nbsp;<a href='$request' target='_blank' class='ui green buttom label' >查看结果</a>
                           &nbsp;&nbsp;<a href='$request&__sql__=1' target='_blank' class='ui yellow buttom label' >分析</a></td></tr>";
echo <<<EOT
            </tbody>
        </table>
