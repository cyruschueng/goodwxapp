...
Page({
  ...
  onShow: function () {
    ...
    var question_list_item = {num:1,option:'环党还德国商人奥斯卡珠辛德勒格连姆格格连姆格连照不同的方式来分割姆格'.split(''),length:4};
    question_list = [];
    question_list.push(question_list_item);
    ...
    //for test
    app.AppMusic.src = "https://w.kuaiduodian.com/Track5.mp3";//question_list[title - 1].content;
