...
<script>
    ...
    export default {
        data() {
            return {
                userAvatar: window.YS_USER_AVATAR['wx_ewm'],
                shearPicture: false,
                option: {
                    size: 1,
                    outputType: 'png',
        ...
        methods: {
            ...
            cancelUploadAvatar() {
                ...
                this.userAvatar = window.YS_USER_AVATAR['wx_ewm']
            },
            uploadAvatar() {
                const _this = this
                ...
                this.$refs.cropper.getCropData((data) => {
                    // do something
                    this.$axios.upload({
                        url: '/agent/user/services/doUploaUserQRCardSrc',
                        data: {
                            file: data
                        },
                        isloadding: true,
                        ...
                        window.YS_USER_AVATAR['wx_ewm'] = data
                        this.$vux.toast.show({
                            text: '二维码上传成功!',
                            time: 1000,
                            onHide() {
