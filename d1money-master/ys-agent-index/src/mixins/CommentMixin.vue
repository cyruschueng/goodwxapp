...
//                console.log('取消')
            ...
            ajaxComment(index) {
                this.$axios.post({
                    url: 'submitCommentByVisitId',
                    data: {
                        userid: this.list[index].userid,
                        visitId: this.list[index].id,
                        comment: this.commentModal.text,
...
//                    console.log(this.list[index])
                    this.list[index].commentlist ? this.list[index].commentlist.push({
                        comment: this.commentModal.text,
                        name: res.userName,
                        id: res.id,
                        userid: res.userid,
                        commentReplylist: []
                    }) : this.$set(this.list[index], 'commentlist', [{
                        comment: this.commentModal.text,
                        name: res.userName,
                        id: res.id,
                        userid: res.userid,
