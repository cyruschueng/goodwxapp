...
<template>
    <div>
        ...
        <div style="padding: 20px 15px 10px;">
            <h5 style="font-weight: normal;color: #969696;font-size: 12px;">注意事项</h5>
            <p style="font-size:12px;color: #aaaaaa;">
                1. 导出数据将以excel文件的形式发送到您输入的邮箱地址，请注意查收 <br/>
                2. 请确保您输入的邮箱地址是您个人，防止信息泄露<br/>
            </p>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            checkCode(value) {
                return {
                    valid: value.toLocaleUpperCase() === this.code,
                    msg: '验证码不正确'
                }
            },
            // 绘制验证码
...
//                this.submitLoadding = true
                this.formMixin_submit('doExportAllVisitingRecord2Email')
                    .then(() => {
