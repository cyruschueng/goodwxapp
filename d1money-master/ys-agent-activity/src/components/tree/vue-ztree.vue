<style>
    ...
    .ztree li ul.line {
        background: url('./../../assets/ztree/line_conn.gif') 0 0 repeat-y;
    }
    ...
    .ztree li span.button {
        ...
        background-attachment: scroll;
        background-image: url("./../../assets/ztree/zTreeStandard.png");
        *background-image: url("./../../assets/ztree/zTreeStandard.gif")
    }
        ...
        <div class="zTreeDemoBackground left">
            <ul class="ztree">
                <ztree-item v-for='(m,i) in treeDataSource' :key='i' :model.sync="m" :num.sync='i' root='0'
                            :nodes.sync='treeDataSource.length' :callback='func' :expandfunc='expand'
