...
function showProvince(){
  ...
  for (var i = 0;i<provinceList.length;i++){
    array.push(provinceList[i].name)
  }
  return array
}
  ...
  for (var i = 0; i < provinceList.length; i++) {
    if (provinceList[i].name == province){
        ...
        for (var j = 0; j < provinceList[i].cityList.length; j++) {
          if (provinceList[i].cityList[j].name != '市辖区' && provinceList[i].cityList[j].name != '县') {
            array.push(provinceList[i].cityList[j].name)
          }else{
            for (var k = 0; k < provinceList[i].cityList[j].areaList.length;k++){
              array.push(provinceList[i].cityList[j].areaList[k])
            }
...
function showArea(province,city) {
  for (var i = 0; i < provinceList.length; i++) {
    if (provinceList[i].name == province) {
      for (var j = 0; j < provinceList[i].cityList.length; j++) {
        if (provinceList[i].cityList[j].name == city){
          return provinceList[i].cityList[j].areaList
        }
      }
    }
  }
