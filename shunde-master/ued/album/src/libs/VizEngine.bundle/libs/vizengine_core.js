module("vizengine_class.js",function(){
    com.vizengine.core = {};

    com.vizengine.core.Platform = {
        ...
        vizengineiOS: navigator.userAgent.indexOf("vizengine-iOS") > -1,
        vizengineAndroid: navigator.userAgent.indexOf("vizengine-android") > -1,
        vizengineMobile: navigator.userAgent.indexOf("vizengine-") > -1
    };
    var Platform = com.vizengine.core.Platform;

    /**
     * @class com.vizengine.core.Object
     * 所有对象的基类
     */
    Class.extend("com.vizengine.core.Object",{
        init: function () {
        },
        /**
         * 拦截方法
    ...
    /**
     * @class com.vizengine.core.LRUCache
     * LRUCache，当超出缓冲容量之后会自动移除最久没有使用的数据
     */
    Object.extend("com.vizengine.core.LRUCache",{
    ...
    var Base64 = com.vizengine.core.Base64;

    com.vizengine.core.RequestUtil = {
