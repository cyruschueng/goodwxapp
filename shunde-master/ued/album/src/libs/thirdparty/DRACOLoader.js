...
var dracoDecoder = new DracoModule();
...
THREE.DRACOLoader.prototype = {
    ...
    convertDracoGeometryTo3JS: function(wrapper, geometryType, buffer) {
       ...
       // fileDisplayArea.innerText += ' decode:' + (decode_end - start_time);
        ...
        var material = null;
        if(this.materials && this.materials.materials){
            for(var key in this.materials.materials)
            {
                material = this.materials.materials[key];
                break;
            }
        }
