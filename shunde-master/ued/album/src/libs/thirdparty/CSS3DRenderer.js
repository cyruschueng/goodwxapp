...
THREE.CSS3DObject = function ( elementCreator ) {
    ...
    this.getElementByRender = function(render) {
        if (this.elementCache[render.id] != null) {
            return this.elementCache[render.id];
        }
        var element = elementCreator();
        this.elementCache[render.id] = element;
...
THREE.CSS3DRenderer = function () {
    this.id = (css3dRenderInstanceCount++) + "";
    ...
    this.renderObject = function ( object, camera ) {
        ...
        if ( object instanceof THREE.CSS3DObject ) {
            ...
            var element = object.getElementByRender(this);
