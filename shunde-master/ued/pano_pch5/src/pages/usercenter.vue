<template xmlns="http://www.w3.org/1999/html">
  <div class="user-center">
    <div class="header"  >
      <div class="name-header" style="color:#ffffff ">{{showStageName}}</div>
      <el-button class="el-button-header" @click="alertPassword('updatePasswordForm')" size="small" round>修改密码</el-button>
    </div>
    <user-logan class="user-logan"></user-logan>
    <div class="user-table-access" v-if="userInfo.roleId === 3 ">
      <div class="table-header" >
        <div class="name-table-header">权限管理</div>
        <el-button class="el-button-table" plain size="small"  @click="doAddRegister()">添加账户</el-button>
      </div>
      <el-table :data="tableData" border  max-height="400"  >
        ...
        <el-table-column  label="已拥有权限"  prop="power" width="500">
          <template slot-scope="scope">
        ...
        <el-table-column fixed="right" align="center" header-align="center" label="操作" width="150">
          <template  slot-scope="scope">
            <template v-if="scope.row.isEditEnable">
              ...
              <el-button class="delete-icon" type="text" size="small" @click="deleteClomn(scope.$index, scope.row)">
        ...
        <el-form :inline="true" :model="addUseForm"
          ...
          <div class="content">
            ...
            <el-form-item class="comment-btn">
              ...
              <!--<el-button  @click="resetForm('addUseForm')">重置</el-button>-->
            </el-form-item>
          </div>
        </el-form>
      </div>
