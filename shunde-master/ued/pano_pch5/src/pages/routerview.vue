<template>
  <div class="pagesRouterview">
    <div id="topBanner">
      <div id="titleBox" :title="title" @click.stop="jumToMain">
        <div style="width: 80px;background: #fff;top:0;box-shadow: 0px 0px 10px 1px #d3d3d3; position: absolute;text-align: center">
          <img id="grid-image-main" src="static/shunde_logo.png"/>
        </div>
        <div style="margin-left: 120px">{{title}}</div>
      </div>
      <div id="routerBox" style="display: flex;justify-content: flex-end;padding-right: 20px">
...
<script>
  export default {
    ...
    mounted () {
      this.$router.push('/pages/gridAlbum')
    },
    data () {
      return {
