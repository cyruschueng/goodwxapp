...
var bucket = {
  local: 'panoresourcestest',
  dev: 'panoresourcestest',
  test: 'panoresourcestest',
  online: 'panoresources',
  pre: 'panoresources'
}
// 万象优图的路径
var resourPicShow = {
...
const apiUri = {
   ...
   * 手机端pc版接口
   * */
  getPoiListForPhone: '/shunde/poi/searchPoi',
  getPanoListForPhone: '/shunde/pano/getPanoInfoListByPoi',
  searchPoiListForPhone: '/shunde/poi/searchPoi',
  commitMarkerData: '/shunde//pano/savePanoSign',
  getMarkerData: '/shunde/pano/getPanoSign',
  commitCanvasData: '/shunde/pano/savePanoLine',
  getCanvasData: '/shunde/pano/getPanoLine',
  deleteCanvasData: '/shunde/pano/deletePanoLine'
}
export {apiUri}
