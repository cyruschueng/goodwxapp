...
// base = 'http://111.231.53.151:8088/shunde/'// 本地测试
base = '//shunde.vizen.cn:8088/shunde/'
var interceptor = {
  success (res) {
    ...
    Vue.prototype.$api = {
      ...
      _uploadFileToCos (file, url = '', callback = () => {
        ...
        let cos = new cosJs.CosCloud({
          appid: 10002033, // APPID 必填参数
          bucket: myBucket, // bucketName 必填参数
          region: 'sh', // 地域信息 必填参数 华南地区填gz 华东填sh 华北填tj
          getAppSign: function (callback) { // 获取签名 必填参数
            self.getSignature({params: {remotePath: remotePath}}).then(res => {
      ...
      getPublishedList (params) {
         ...
         */
        console.log(params)
        return axios.get('http://111.231.53.151/pano-viewer-web/rest/album/search', params)
      },
      ...
      searchPoiPage (params) {
         ...
         * gridCode
         */
        return axios.post('/poi/searchPoiPage', params)
      },
      ...
      poiListSort (params) {
         ...
         * 根据网格获取poi信息
         * */
        return axios.post('/shunde/space/adjustmentPanoIndex', params)
      },
       ...
       * pc版手机端接口
       * */
      getPoiListForPhone (params) {
        return axios.post('/poi/searchPoi', params)
      },
      getPanoListForPhone (params) {
        return axios.post('/pano/getPanoInfoListByPoi', params)
      },
      searchPoiListForPhone (params) {
        return axios.post('/poi/searchPoi', params)
      },
      commitMarkerData (params) {
        return axios.post('/pano/savePanoSign', params)
      },
      getMarkerData (params) {
        return axios.post('/pano/getPanoSign', params)
      },
      commitCanvasData (params) {
        return axios.post('/pano/savePanoLine', params)
      },
      getCanvasData (params) {
        return axios.post('/pano/getPanoLine', params)
      },
      deleteCanvasData (id) {
        return axios.post('/pano/deletePanoLine/' + id)
      }
    }
    // 权限管理
