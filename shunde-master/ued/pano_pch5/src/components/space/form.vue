<template>
  <div id="container" direction="vertical">
    <div id="container2" direction="horizontal">
      ...
      <el-button id="dragBtn" type="primary" v-on:click="dragEnable" size="small">{{dragBtnText}}</el-button>
    </div>
    ...
    <div id="bottom" v-show="isShowBottom">
      <el-button id="saveBtn" :plain="true" type="primary" v-on:click="save" size="small">保存
      </el-button>
    </div>
