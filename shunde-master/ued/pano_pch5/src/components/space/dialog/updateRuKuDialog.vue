  ...
  <my-dialog v-if="selfShow">
    <div class="dialog-container">
      <div class="dialog-head">
        <span class="dialog-head-title">修改入库单</span>
      ...
      <div class="dialog-body">
        <div class="dialog-title-bar">
          ...
          <div class="change-bar">
            <btn class="change" v-if="isUpdatePoi" @click="isUpdatePoi=false" text="取消"></btn>
            <btn class="change" v-if="isUpdatePoi" text="保存poi信息" @click="savePoiClick"></btn>
            <btn class="change" v-if="!isUpdatePoi" @click="updatePoiClick" text="修改"></btn>
          </div>
        </div>
        <div class="dialog-body-top" v-if="isUpdatePoi">
          ...
          <div class="row">
            ...
            <div class="row-content jwd-container">
              <div class="jwd">
                <el-select v-model="tempPoiData.coordsys" placeholder="地图坐标系" size="small" class="jwd-son">
                  <el-option
              ...
              <div class="jwd">
                <el-select class="jwd-son" v-model="tempSelectedProvince" :placeholder="$store.state.zone.province" size="small" @change="tempProvinceChange">
                  <el-option
                ...
                <el-select class="jwd-son" v-model="tempSelectedCity" :placeholder="$store.state.zone.city" size="small"  @change="tempCityChange">
                  <el-option
                ...
                <el-select class="jwd-son" v-model="tempSelectedCounty" :placeholder="$store.state.zone.county" size="small"  @change="tempCountyChange">
                  <el-option
                ...
                <el-select class="jwd-son" v-model="tempSelectedArea" :placeholder="$store.state.zone.area" size="small">
                  <el-option
        ...
        <div class="dialog-body-top" v-if="!isUpdatePoi">
          <div class="row">
            ...
            <div class="row-content"><h3>{{selfPoiData.name}}</h3></div>
          </div>
          <div class="row">
            <div class="row-title"><h3>格网号：</h3></div>
            <div class="row-content">
              ...
              <div class="chaoxiang-son cx-input-container">
                <div class="input-row">
                  ...
                  <div class="input-row-right">
                    <el-select class="jwd-son" v-model="selfPanoData.cameraType" placeholder="请选择" size="small">
                      <el-option
                ...
                <div class="input-row">
                  ...
                  <div class="input-row-right">
                    <el-input class="jwd-son" v-model="selfPanoData.height" placeholder="请输入拍摄高度" size="small"></el-input>
                  </div>
                </div>
                <div class="input-row">
                  <div class="input-row-left">
                  ...
                  <div class="input-row-right">
                    <el-input class="jwd-son" v-model="selfPanoData.photographer" placeholder="请输入拍摄人员" size="small"></el-input>
                  </div>
                </div>
                <div class="input-row">
                  <div class="input-row-left">
