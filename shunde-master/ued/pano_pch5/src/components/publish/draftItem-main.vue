<template>
  <div class="mosaicitem-0" :class="{uploaded: uploaded}">
    <div class="mosaicitemContent-0" @click.stop="previewAlbum">
      ...
      <div class="content-text-1">
        ...
        <div id="publishContent">
          <span class="date-info-1">发布于：
        </span>
          <span class="grayContent">{{createTime1}}</span>
        </div>
        <div id="brefContent">
          <span class="date-info-1">简介：
        </span>
