module("/libs/appengine_location.js",
    "/libs/appengine_engine3d.js",
    "/libs/appengine_engine3d_webgl.js",
    "/libs/appengine_engine3d_css3d.js",
    function() {
    ...
    if(com.appengine.core.Platform.appengineMobile) {
        ...
        View.extend("com.appengine.view.PanoView", {
    ...
    /**
     * @class com.appengine.animation.PanoAnimation
     * @extends com.appengine.animation.Animation
     *
     * 全景pano旋转/缩放动画, 通常旋转heading, pitch, fov用作缩放效果
     *
     */
    Animation.extend("com.appengine.animation.PanoAnimation", {
        init: function () {
    ...
    var  PanoAnimation = com.appengine.animation.PanoAnimation;

    /**
     * @class com.appengine.animation.PanoFlyAnimation
     * @extends com.appengine.animation.Animation
     *
     * 全景pano旋转动画, 通常旋转heading, pitch
     *
     */
    Animation.extend("com.appengine.animation.PanoFlyAnimation", {
        init: function () {
            Animation.prototype.init.apply(this,arguments);
            /** 起始heading */
            this.fromHeading = 0;
    ...
    var PanoFlyAnimation = com.appengine.animation.PanoFlyAnimation;

    /**
     * @class com.appengine.animation.PanoScaleAnimation
     * @extends com.appengine.animation.Animation
     *
     * 全景pano缩放动画, 通过camera fov控制缩放大小
     *
     */
    Animation.extend("com.appengine.animation.PanoScaleAnimation", {
        init: function () {
            Animation.prototype.init.apply(this,arguments);
            /** 起始fov */
            this.fromFov = 0;
    ...
    var PanoScaleAnimation = com.appengine.animation.PanoScaleAnimation;
    ...
    Object.extend("BoxPano", {
        init: function (panoView) {
            ...
            if (com.appengine.core.Platform.mobile) {
                ...
                this._maxVisibleTileCount = 2048;
                this._maxCacheTileCount = 5024;
            }
            ...
            this.urlProvider = function (panoId, level, row, column) {
                ...
                if(panoId.substring(0,4) == "[QQ]") {
                    return "http://webapp.visualbusiness.cn/appengine/v1.0.46/PanoViewer/TileProxy.jsp?panoId=" + panoId + "&level=" + level + "&column=" + column + "&row=" + row;
                }

                var baseUrl = "http://tiles.pano.visualbusiness.cn/";

                if(panoId.substring(0,4) == "[TT]") {
                    baseUrl = "http://tilestest.pano.visualbusiness.cn/";
    ...
    Animation.extend("com.appengine.animation.PanoViewFadeAnimation", {
        animateFrame: function (view, progress) {
            view.snapDiv.style.opacity = 1 - progress;
        }
    });
    var PanoViewFadeAnimation = com.appengine.animation.PanoViewFadeAnimation;


    Animation.extend("com.appengine.animation.PanoViewAlphaAnimation", {
        animateFrame: function (view, progress) {
    ...
    var PanoViewAlphaAnimation = com.appengine.animation.PanoViewAlphaAnimation;

    /**
     * @class com.appengine.view.PanoView
     * @extends com.appengine.view.View
     *
     * 全景类PanoView, 使用方式非常简单, 如:
     * @examples
     * 1. 代码添加
     * var panoView = new com.appengine.view.PanoView();
     ...
     *
     */
    View.extend("com.appengine.view.PanoViewInternal", {
                ...
                if (self.drag) {
                    ...
                    if (event.state == 0) {
                        ...
                        for (var i = 0; i < self.subViews.length; i++) {
                            ...
                            if (subView.isTouchInside(event) && subView.visible) {
                                isDragMarker = true;
                                _view = subView;
                        ...
                        if (isDragMarker) {
                            if (_view != null) {
                                ...
                                var dx = x - self.frame.width/2 ;//- _view.panoAnchorX * _view.frame.width;
                                var dy = y - self.frame.height/2 ;//- _view.panoAnchorY * _view.frame.height;
                                var heading = self.getHeading() + 180*Math.atan(dx/cameraLen)/Math.PI;
                                var pitch = self.getPitch() + 180*Math.atan(dy/cameraLen)/Math.PI;
                                _view.setPanoHeading(heading);
                                _view.setPanoPitch(pitch);
                            }
                            if(event.state == 2) {
                                if(self.onMarkerDragCallback != null) {
        ...
        dispatchTouch: function (event) {
            ...
            if(this.touchable)
            {
                for (var i in this.panoGestureDetectors) {
                    var gestureDetector = this.panoGestureDetectors[i];
        ...
        setHDEnable: function (value) {
            ...
            if (this.hd) {
                this.pano._maxVisibleTileCount = 160;
            }
            else {
                this.pano._maxVisibleTileCount = 44;
            }
        ...
        _checkIfTryWebgl : function() {
            ...
            if(com.appengine.core.Platform.android) {
                if(navigator.userAgent.indexOf("HM NOTE 1TD Build/JDQ39;") > 0) {
                    // 红米note发现css3d兼容性问题
                    return true;
                }
                // 其他手机默认使用css3d
        ...
        _createNativeView: function () {
            ...
            leftRenderer.setClearColor(0x000000, 1.0);
            rightRenderer.setClearColor(0x000000, 1.0);
            this.loader = new THREE.TextureLoader();
            this.loader.crossOrigin = "*";
            this.scene = null;
            this.camera = camera;
...
//            }
        ...
        addPatch : function(imageUrl,heading,pitch,width,height) {
            ...
            if(imageUrl.substring(0,4) != "http" && imageUrl.substring(0,5) != "data:") {
...
//            com.appengine.UPXMLUtil.loadXMLDoc(metaUrl, function (doc) {
...
//            });
        ...
        setPanoId: function (panoId, callback, animation) {
            ...
            if (com.appengine.core.StringUtil.isEmpty(this.panoId)) {
                if(callback) {
                    callback.call(this);
                }
                return;
...
//                    }
    ...
    View.extend("com.appengine.view.PanoView", {
        init : function() {
            ...
            this.onHeadingChangeCallback = null;
            this.onFovChangeCallback = null;
            this.panoViewInternal = new com.appengine.view.PanoViewInternal();
            this.panoViewInternal.onPitchChangeCallback = function() {
                if(self.onPitchChangeCallback) {
                    self.onPitchChangeCallback();
                }
            ...
            var moushwheeled = function (event) {
                ...
                if (delta < 0) {
                    ...
                    animation.toFov = animation.fromFov + 20;
                    animation.duration = 600;
                    animation.timeInterplator = deac;
                    animation.callback=function () {
                        if(self.onScaleCallBack!=null)
                ...
                children : [
                    {
                        ...
                        width : "wrap",
                        height : "fill",
                        src : encodeURIComponent(cursorImageSrc)
                    }
                ]
            }
...
//            })
        ...
        setAutoplayEnable : function(enable) {
            this.panoViewInternal.setAutoplayEnable(enable);
        },
    ...
    var PanoView = com.appengine.view.PanoView;

    /**
     * @static
     * @method com.appengine.UPPanoView.getHeadingByLatLon
     * 根据经纬度计算heading
     *
    ...
    /**
     * @static
     * @method com.appengine.UPPanoView.getPitchByLatLon
     * 根据经纬度计算pitch
     *
     * @param {number} fromLat 当前全景所在维度
     * @param {number} fromLon 当前全景所在经度
    ...
    PanoView.extend("com.appengine.view.EarthPanoView", {
        init: function () {
