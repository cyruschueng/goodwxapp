module("/libs/appengine_core.js","/libs/appengine_math.js",function(){
    var Object = com.appengine.core.Object;
    var Matrix4 = com.appengine.math.Matrix4;

    /**
     * @class com.appengine.engine3d.DataBuffer
     *
     */
    Object.extend("com.appengine.engine3d.DataBuffer",{
    ...
    var DataBuffer = com.appengine.engine3d.DataBuffer;

    /**
     * @class com.appengine.engine3d.Object3D
     */
    Object.extend("com.appengine.engine3d.Object3D",{
        init : function() {
        ...
        /**
         * 获取当前对象相对于世界坐标系的变换矩阵
         * @returns {com.appengine.math.Matrix4}
         */
    ...
    var Object3D = com.appengine.engine3d.Object3D;

    /**
     * @class com.appengine.engine3d.Camera
     */
    Object3D.extend("com.appengine.engine3d.Camera",{
        init : function() {
            Object3D.prototype.init.apply(this,arguments);
            this.projectionMatrix = new Matrix4();
        }
    });
    var Camera = com.appengine.engine3d.Camera;

    /**
     * @class com.appengine.engine3d.Plane
     */
    Object3D.extend("com.appengine.engine3d.Plane",{
        init : function() {
            Object3D.prototype.init.apply(this,arguments);
        },
    ...
    /**
     * @class com.appengine.engine3d.Render
     * 渲染器的基类
     */
    Object.extend("com.appengine.engine3d.Render",{
        init : function() {
            Object.prototype.init.apply(this,arguments);
