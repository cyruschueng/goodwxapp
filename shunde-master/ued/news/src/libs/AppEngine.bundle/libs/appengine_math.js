module("appengine_core.js",function(){
    var Object = com.appengine.core.Object;

    /**
     * @class com.appengine.math.Matrix4
     * 矩阵
     */
    Object.extend("com.appengine.math.Matrix4",{
        init : function() {
            this.elements = [];
            this.identity();
        },
        ...
        clone: function () {
            return new com.appengine.math.Matrix4().fromArray( this.elements );
        },
        copyFrom: function ( m ) {
            var te = this.elements;
            var me = m.elements;
    ...
    Object.extend("com.appengine.math.Vector3",{
        init : function(x,y,z) {
            this.set(x,y,z);
        },
        set : function(x,y,z) {
    ...
    var Vector3 = com.appengine.math.Vector3;
})