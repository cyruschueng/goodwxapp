module("appengine_global.js",function(){
    var Object = com.appengine.core.Object;
    var $ = com.appengine.$;

    Object.extend("com.appengine.location.LocationManager",{

    });

    var LocationManager = com.appengine.location.LocationManager;


    // h5版本不会调用这个方法，这只会在app内部调到这里，
    // 因为h5版本已经带有除经纬度以外的其他信息了
    var wareLocInfo = function(locInfo,callback) {
        $.get("http://apis.map.qq.com/ws/geocoder/v1/?location="+locInfo.latitude+","+locInfo.longitude+"&key=DGPBZ-7V6RX-ANC4R-ZLIA3-ROB7F-ESBTM",{},function(data){
