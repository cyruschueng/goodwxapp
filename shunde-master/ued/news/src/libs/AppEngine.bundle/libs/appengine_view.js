module("appengine_animation.js",function(){
    com.appengine.view = {};

    var Object = com.appengine.core.Object;
    var StringUtil = com.appengine.core.StringUtil;
    ...
    var Layout = com.appengine.view.Layout;
     ...
     * </pre>
     */
    com.appengine.view.LayoutConstrain = {
        /**
         * 填充慢父亲的剩余空间
         */
        FILL            : -1,
    ...
    var LayoutConstrain = com.appengine.view.LayoutConstrain;

    /**
     *  @class com.appengine.view.Gravity
     *  View的对齐方式
     */
    com.appengine.view.Gravity = {
        /** 不指定对其方式 */
        NONE                : 0,
        /** 左对齐 */
        LEFT                : 1 << 0,
         ...
         *
         * @param {string} value
         * @return {com.appengine.view.Gravity}
         */
        parseElement : function(value) {
            if ("top" == value) {
                return com.appengine.view.Gravity.TOP;
            }
            if ("right" == value) {
                return com.appengine.view.Gravity.RIGHT;
            }
            if ("bottom" == value) {
    ...
    var Gravity = com.appengine.view.Gravity;

    /**
     * @class com.appengine.view.Rect
     * @extends com.appengine.core.Object
     * 表示一个二维的矩形区域
     */
    Object.extend("com.appengine.view.Rect",{
        init: function () {
    ...
    var Rect = com.appengine.view.Rect;

    /**
     * @class com.appengine.view.Space
     * @extends com.appengine.core.Object
     * 描述Margin或者Padding的空间数据
     */
    Object.extend("com.appengine.view.Space",{
        init: function () {
            this.left = 0;
            this.top = 0;
            this.right = 0;
    ...
    var Space = com.appengine.view.Space;

    /**
     * @class com.appengine.view.LayoutParam
     * @extends com.appengine.core.Object
     * View的布局参数
     */
    Object.extend("com.appengine.view.LayoutParam",{
        init: function () {
            /**
             * @property {com.appengine.view.Layout} layout 布局类型
             */
            this.layout = com.appengine.view.Layout.FRAME;
            /**
             * @property {com.appengine.view.Layout} layout 在父亲基础上定制布局类型
             */
            this.layoutInParent = null;
            /**
             * @property {com.appengine.view.LayoutConstrain} width 视图宽度
             */
            this.width = com.appengine.view.LayoutConstrain.FILL;
            /**
             * @property {number} widthWeight 视图宽度比重
             */
            this.widthWeight = 1;
            /**
             * @property {com.appengine.view.LayoutConstrain} height 视图高度
             */
            this.height = com.appengine.view.LayoutConstrain.FILL;
            /**
             * @property {number} heightWeight 视图宽度比重
             */
            this.heightWeight = 1;
            /**
             * @property {com.appengine.view.Space} margin 视图外边距
             */
            this.margin = new com.appengine.view.Space();
            /**
             * @property {com.appengine.view.Space} padding 视图内边距
             */
            this.padding = new com.appengine.view.Space();
            /**
             * @property {com.appengine.view.Gravity} gravity 视图在父视图中的对齐方式
             */
            this.gravity = com.appengine.view.Gravity.NONE;
            /**
             * @property {com.appengine.view.Gravity} contentGravity 视图中的子视图中的对齐方式
             */
            this.contentGravity = com.appengine.view.Gravity.NONE;
        }
    });
    var LayoutParam = com.appengine.view.LayoutParam;

    /**
     * @class com.appengine.view.VelocityTracker
     * @extends com.appengine.core.Object
     * 速度追踪器
     * 可以最终手势滑动或者任意变化的数值的瞬时速率
     *
     */
    Object.extend("com.appengine.view.VelocityTracker",{
        init: function () {
    ...
    /**
     * @class com.appengine.view.Color
     * @extends com.appengine.core.Object
     * 颜色
     */
    Object.extend("com.appengine.view.Color",{
        init: function () {
            this.r = 0;
            this.g = 0;
            this.b = 0;
    ...
    var Color = com.appengine.view.Color;
     ...
     * @return {com.appengine.view.Color} 颜色
     */
     ...
     *
     */
    Object.extend("com.appengine.view.View",{
        ...
        findViewById : function(id) {
            ...
            for(var i = 0 ; i < this.subViews.length; i++) {
                var finded = this.subViews[i].findViewById(id);
                if(finded != null) {
                    return finded;
                }
            }
        ...
        startAnimation : function(animation,terminateCurrent) {
            ...
            if(terminateCurrent && this.animation != null) {
                com.appengine.animation.Animation.terminateAnimation(this);
            }
            this.animation = animation;
            if(this.animation != null) {
                com.appengine.animation.Animation.requestAnimation(this);
            }
        },
        ...
        triggerClick: function(){
            ...
            if(this.onClickCallback != null) {
                ...
                var self = this;
                setTimeout(function(){
                    self.onClickCallback.call(self);
                },0);
            }
        ...
        setOnClick: function (value) {
            ...
            if (this.onTapGestureDetector == null) {
                ...
                this.onTapGestureDetector.callback = function () {
                    return self.trigerClick();
                };
        ...
        /**
         * 获取当前View相对于根View的坐标
         * @returns {com.appengine.view.Rect}
         */
        ...
        _transformEventToChild : function(subview,touchEvent) {
            ...
            var anchorTrans = new com.appengine.math.Matrix4();
            ...
            var scale = new com.appengine.math.Matrix4();
            scale.setScale(1/subview.scaleX,1/subview.scaleY,1);
            matrix.multiply(scale);
            var translate = new com.appengine.math.Matrix4();
...
//            }
    ...
    View._resolveClass = function(className) {
        ...
        var classInFramework = eval("try{eval('com.appengine.view."+className+"')}catch(e){}");
    ...
    View.parse = function(json,instance,data,contextPath) {
        ...
        if(type == "include") {
            ...
            if(attData != null) {
                ...
                data = com.appengine.mergeObject(data,attData);
            }
            if(com.appengine.Module.isViewTemplate(src)) {
                var path = com.appengine.view.View.resolvePath(contextPath,src);
                var module = com.appengine.moduleManager[path];
    ...
    /**
     * @class com.appengine.view.ImageView
     * @extends com.appengine.view.View
     * 图片控件。支持显示本地或者网络的图片内容
     * 支持指定横向和纵向拉伸区域进行屏幕适配，
     * 支持指定图片像素(px)与设备独立像素的比例(通过在图片文件名增加后缀如@2x.png来实现)
     */
    View.extend("com.appengine.view.ImageView", {
        init: function () {
        ...
        measureWidth: function () {
            if (this.layoutParam.width == LayoutConstrain.WRAP) {
                ...
                if (this.layoutParam.height == LayoutConstrain.WRAP) {
                    ...
                    return imageWidth + this.layoutParam.padding.hspace();
                }
        ...
        measureHeight: function () {
            if (this.layoutParam.height == LayoutConstrain.WRAP) {
                ...
                if (this.layoutParam.width == LayoutConstrain.WRAP) {
                    // 如果宽度也是wrap 则返回图片实际高度
                    return imageHeight + this.layoutParam.padding.vspace();
                }
                if (imageHeight == 0 || imageWidth == 0) {
                    return 0;
                }
    ...
    ImageView = com.appengine.view.ImageView;

    /**
     * @class com.appengine.view.Button
     * @extends com.appengine.view.View
     * 按钮类, 支持指定按下和抬起的背景。
     */
    View.extend("com.appengine.view.Button",{
        init : function() {
            View.prototype.init.apply(this,arguments);
    ...
    var Button = com.appengine.view.Button;

    /**
     * @class com.appengine.view.ToggleButton
     * @extends com.appengine.view.View
     * 开关按钮。支持第一次点击按下，第二次点击抬起的效果。
     * 还可以和com.appengine.view.ToggleButtonGroup组合
     * 使用实现底部Tabbar的功能。
     */
    View.extend("com.appengine.view.ToggleButton",{
        init : function() {
            View.prototype.init.apply(this,arguments);
            this.setLayout("frame");
            this.toggle = false;
    ...
    var ToggleButton = com.appengine.view.ToggleButton;

    /**
     * @class com.appengine.view.ToggleButtonGroup
     * @extends com.appengine.view.View
     ...
     */
    View.extend("com.appengine.view.ToggleButtonGroup",{
        init : function() {
            View.prototype.init.apply(this,arguments);
            this.onToggleChangeCallback = null;
            this.toggle = -1;
    ...
    var ToggleButtonGroup = com.appengine.view.ToggleButtonGroup;


    /**
     * @class com.appengine.view.SelectView
     * @extends com.appengine.view.View
     * 选择视图。同一时间该视图的子View只有一个处于可见状态，
     * 当通过select方法将某一个子View显示出来时，其余子View
     * 将自动隐藏。
     */
    View.extend("com.appengine.view.SelectView",{
        /**
         * @method
         * 选择可见的子View
         * @param index
    ...
    var SelectView = com.appengine.view.SelectView;

    /**
     * @class com.appengine.view.TextView
     * @extends com.appengine.view.View
     * 文本控件。实现了基本的纯文本展示和html文本展示。
     *
     */
    View.extend("com.appengine.view.TextView", {
        text : null,
        html : null,
        init: function () {
            View.prototype.init.apply(this,arguments);
        ...
        measureWidth: function () {
            if (this.layoutParam.width == LayoutConstrain.WRAP) {
                return this._nativeView.measureTextWidth() + this.layoutParam.padding.hspace();
            }
            return View.prototype.measureWidth.apply(this,arguments);
        },
        measureHeight: function () {
    ...
    /**
     * @class com.appengine.view.InputView
     * @extends com.appengine.view.View
     * 输入框控件。支持文本，数字，密码等内容输入。
     */
    View.extend("com.appengine.view.InputView", {
        init: function () {
            View.prototype.init.apply(this,arguments);
    ...
    var InputView = com.appengine.view.InputView;
    ...
    /**
     * @class com.appengine.view.ScrollView
     * @extends com.appengine.view.View
     * 滚动视图。
     * 允许水平或者垂直滚动内容。支持翻页模式。
     *
     */
    View.extend("com.appengine.view.ScrollView",{
        init: function () {
            View.prototype.init.apply(this,arguments);
...
//                }
        ...
        getMinTranslateY: function () {
            ...
            for (var i in this.subViews) {
                var subView = this.subViews[i];
                var current = -subView.frame.getBottom() + this.frame.height - this.layoutParam.padding.bottom;
                if (current < min) {
                    min = current;
                }
            }
        ...
        getMinTranslateX: function () {
            ...
            for (var i in this.subViews) {
                var subView = this.subViews[i];
                var current = -subView.frame.getRight() + this.frame.width - this.layoutParam.padding.right;
                if (current < min) {
                    min = current;
                }
            }
         ...
         * @param distance
         */
        scrollToSmoothly : function (distance) {
            var self = this;
            if(!this.verticalScroll) {
                var trans = new CustomScrollViewTranslateAnimation();
                trans.timeInterplator = new DecelerateInterpolator(2);
                trans.fromTranslateX = this.translateX;
                trans.toTranslateX = distance;
                trans.duration = 500;
                trans.callback = function() {
                    self.onScrollEnd();
                }
    ...
    var ScrollView = com.appengine.view.ScrollView;


    /**
     * @class com.appengine.view.ListViewAdaptor
     * @extends com.appengine.core.Object
     * ListViewAdaptor是ListView数据源
     */
    Object.extend("com.appengine.view.ListViewAdaptor",{
        /**
         * @method
         * 需要子类重写此方法提供CellView
         * @param reuseView
    ...
    var ListViewAdaptor = com.appengine.view.ListViewAdaptor;

    /**
     * @class com.appengine.view.ListView
     * @extends com.appengine.view.ScrollView
     * 列表类
     */
    ScrollView.extend("com.appengine.view.ListView",{
        init : function() {
    ...
    /**
     * @class com.appengine.view.PullToRefreshView
     * @extends com.appengine.view.View
     * 下拉刷新控件。
     */
    View.extend("com.appengine.view.PullToRefreshView",{
        init : function(){
            View.prototype.init.apply(this,arguments);
         ...
         * @method
         * 获取头部视图
         * @returns {com.appengine.view.View}
         */
    ...
    var PullToRefreshView = com.appengine.view.PullToRefreshView;


    /**
     * @class com.appengine.view.ScannerView
     */
    View.extend("com.appengine.view.ScannerView",{
        init :function () {
            View.prototype.init.apply(this,arguments);
        },
        _createNativeView :function () {
    ...
    /**
     * @class com.appengine.view.WebView
     */
    View.extend("com.appengine.view.WebView",{
        _createNativeView: function () {
            return createNativeObject("NativeWebView");
        },
        setSrc : function(url) {
            this._nativeView.setSrc(url);
        },
        /**
         * 设置html片段
    ...
    View.extend("com.appengine.view.Page", {
        _backPage : null,
        init : function() {
             View.prototype.init.apply(this,arguments);
        },
        updateStatusBarLight : function() {
            ...
            com.appengine.$.setStatusBarLight(light);
        }
        ,
        ...
        backward : function(paramStr) {
            if(Page.pageStack.length < 2) {
                return;
            }
            if(Page.peek().pageInstance != this) {
                return;
            }
            if(Page._switching) {
            ...
            Page._switching = true;
            Page.pop();
            var backPage = Page.peekAndRestore();

            var param = com.appengine.core.RequestUtil.getRequestParam(paramStr);
        ...
        forwardTo : function(path,callback) {
            ...
            var self = this;
            Page.loadPage(path,callback,function(page){
    ...
    var Page = com.appengine.view.Page;
    ...
    Page.peek = function(index) {
        if(index == null) {
            index = 0;
        }
        if(Page.pageStack.length == 0) {
            return null;
        }
        var page = Page.pageStack[Page.pageStack.length-1-index];
        return page;
    }

    Page.peekAndRestore = function(index) {
        var page = Page.peek(index);
    ...
    Page.pop = function() {
        ...
        var page = Page.pageStack.pop();
        return page;
    }

    Page.backward = function() {
        if(window.rootView.subViews.length > 0) {
            var page = window.rootView.subViews[0];
    ...
    Page.loadPage = function(path,pageCallback,loadCallback) {
        var param = com.appengine.core.RequestUtil.getRequestParam(path);
        ...
        module(path,function(page){
            ...
            if(!(pageinstance instanceof Page)) {
                throw new TypeError(path + " should return a Page instance!!");
            }
            ...
            if(param.frameworkParams["launchMode"] == "clearTop") {
                for(var i = 0 ; i < Page.pageStack.length; i++) {
                    if(Page.pageStack[i].pageInstance.getContextPath() == pageinstance.getContextPath()) {
                        Page.pageStack.length = i;
                        break;
                    }
                }
            }
    ...
    View.extend("com.appengine.view.MapViewInternal",{
        _createNativeView: function () {
    ...
    if(com.appengine.core.Platform.appengineAndroid) {
        /**
         * android 版本存在marker拖出地图被裁剪的bug
         * 因此实现时需要增加markerLayer层，并设置背景色#00000000来解决。
         * 然后如果增加markerLayer层，iOS版本的地图无法拖动，
         * 因此这个bug修复只能针对android版本这样修改。
         */
        View.extend("com.appengine.view.MapView",{
            init : function() {
                View.prototype.init.apply(this,arguments);
                this.viewportChangeCallback = null;
                this.viewportChangeChecking = false;
                this.lastViewportChangeTime = 0;
                this.innerMapView = new com.appengine.view.MapViewInternal();
                View.prototype.addView.call(this,this.innerMapView);

                this.markerLayer = new com.appengine.view.View();
                this.markerLayer.setBackground("#00000000");
                View.prototype.addView.call(this,this.markerLayer);

                var self = this;
                this.innerMapView._nativeView.setViewportChangeCallback(function(){
                    self.updateMarkers();
                    self.lastViewportChangeTime = new Date().getTime();
                    self._startCheckingViewport();
                });
            },
            clearViews : function(requestLayout) {
                this.markerLayer.clearViews();
            },
            start : function() {
            ...
            _startCheckingViewport : function() {
                if(this.viewportChangeChecking) {
                    return;
                }
                this.viewportChangeChecking = true;
                this._checkAndNotifyViewportChange();
            }
            ,
            _checkAndNotifyViewportChange : function() {
                var checkInterval = 600;
                var now = new Date().getTime();
                var deltaAfterViewportChange = now - this.lastViewportChangeTime;
                if(deltaAfterViewportChange > checkInterval) {
                ...
                var self = this;
                setTimeout(function(){
                    self._checkAndNotifyViewportChange();
                },checkInterval);
            }
            ,
            dispatchLayout : function() {
            ...
            addView : function(view) {
                this.markerLayer.addView(view);
                return ret;
            },
            updateMarkers : function() {
                // 更新Marker的位置
                for(var i = 0; i < this.markerLayer.subViews.length; i++) {
                    var marker = this.markerLayer.subViews[i];
                    if(marker.latitude != null && marker.longitude != null) {
                        var point = this.innerMapView._nativeView.getPoint({latitude:marker.latitude,longitude:marker.longitude});
                        marker.setTranslateX(point.x-marker.frame.width*marker.anchorX);
                        marker.setTranslateY(point.y-marker.frame.height*marker.anchorY);
                    }
                }
            },
    ...
    window.rootView = new View(window.nativeRootView);


    window.rootView.onKeyboardChange = function(keyboardHeight) {
    ...
    window.initRootView = function(view) {
        if(view instanceof Function) {
            view = view();
        }
        window.rootView.clearViews();
        window.rootView.addView(view);
    ...
    window.rootView.isLayouting = false;
    window.rootView.isLayoutDirty = true;
    window.rootView.resize = function() {
    ...
    window.rootView.interceptMethod("requestLayout",function() {
