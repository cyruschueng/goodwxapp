...
(function (factory) {
  ...
  $.extend($.summernote.lang, {
    'en-US': {
      ...
      image: {
        ...
        resizeFull: '重设尺寸（默认）',
        resizeHalf: '重设尺寸（50%）',
        resizeQuarter: '重设尺寸（25%）',
        floatLeft: '左对齐',
        floatRight: '右对齐',
        floatNone: '取消对齐',
        shapeRounded: '形状：环形',
        shapeCircle: '形状：圆形',
        shapeThumbnail: '形状：缩略',
        shapeNone: '形状：无',
        dragImageHere: '拖拽图文到此处',
        dropImage: '放置图文',
        selectFromFiles: '从文件中选择',
        maximumFileSize: '最大尺寸',
        maximumFileSizeError: '超过尺寸限制',
        url: '请输入图片地址链接，或直接拖拽图片到编辑器内',
        remove: '删除图片'
      },
      video: {
        video: '视频',
        ...
        insert: '插入视频',
        url: '视频URL？',
        providers: '(YouTube, Vimeo, Vine, Instagram, DailyMotion 或者 Youku)'
      },
      link: {
        link: '链接',
        insert: '插入链接',
  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      var $container = options.dialogsInBody ? $(document.body) : $editor;
      // var $container = $(top.document.body);
