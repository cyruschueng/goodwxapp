    ...
    <div id="godownentry" class="compopup">
      ...
      <div class="compopup-body">
        <div class="editPoiBox" v-show="isEditPoi">
          <div class="underLineText poiHeader">
            ...
            <div class="poiHeaderBtns">
              <div class="colorText cursor-pointer" @click="editCancel">取消</div>
        ...
        <!--<div class="compopup-btns" v-show="!onlyRead">-->
          ...
          <!--<div class="commonbtn" :class="{'commonbtn-disabled': !isSaveAble}" @click.stop="saveEvent">保存</div>-->
          <!--<div class="commonbtn" :class="{'commonbtn-disabled': !isSaveAble}" @click.stop="saveAndEntry">保存并入库</div>-->
          <!--&lt;!&ndash; <div class="commonbtn commonbtn-disabled" @click.stop="saveAndEntry">保存并入库</div> &ndash;&gt;-->
        <!--</div>-->
        <div class="compopup-btns" v-show="onlyRead">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      editPoi () {
        this.editPoiInfo.id = this.panoInfo.poiId
        this.isEditPoi = true
      },
      createPoi () {
        this.editPoiInfo.id = ''
    ...
    watch: {
      ...
      isEditPoi () {
        if (this.isEditPoi === true) {
          this.dialogTitle = '新建Poi'
          this.updatePanoInfo()
        } else {
          this.dialogTitle = '修改入库单'
        }
      },
      editId (newValue) {
