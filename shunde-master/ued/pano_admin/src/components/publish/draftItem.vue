  ...
  <div class="mosaicitem-1" :class="{uploaded: uploaded}" @click.stop="previewAlbum">
    <div class="mosaicitemContent-1">
      ...
      <div class="content-text">
        <div class="idTitle-1">
          <div class="right-1">
            <div class="el-icon-edit publish-net-1 cursor-pointer" @click.stop="publish($event)"></div>
            <p class="publish-net-2" v-show="!canClick">已发布</p>
        ...
        <span class="date-info">创建于：{{createTime1}}  更新于：{{from}}
        </span>
  ...
  export default {
    ...
    methods: {
      ...
      publish (e) {
        // 事件拦截
        e.stopPropagation()
        this.$router.push('/pages/album')
//        window.open(window.location.toString().split('publish')[0] + 'publishEdit')
        this.$cookie.set('albumId', this.publishId)
      },
      delete () {
