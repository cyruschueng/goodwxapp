...
(function(){
    ...
    NativeImageView.prototype.getRatio = function() {
    ...
    NativeImageView.prototype.setRatio = function(ratio) {
    ...
    NativeImageView.prototype.getImageWidth = function() {
        return this.imgWidth / this.getRatio();
    }

    NativeImageView.prototype.getImageHeight = function() {
        return this.imgHeight / this.getRatio();
    }
    ...
    NativeImageView.prototype.setFrame = function(x,y,width,height) {
        ...
        if(this.div.children.length > 0 && width > 0 && height > 0) {
            ...
            if(this.image != null) {
                ...
                var tx0 = x0/ratio;
                var tx1 = x1/ratio;
                var tx2 = targetWidth - (x3-x2)/ratio;
                var tx3 = targetWidth;
                var ty0 = y0/ratio;
                var ty1 = y1/ratio;
                var ty2 = targetHeight - (y3-y2)/ratio;
    ...
    NativeTextView.prototype.setFontFamily = function(family) {
        this.textDiv.style.fontFamily=family;
    }
    ...
    NativeTextView.prototype.setMaxLine = function (maxLine) {
        ...
        this.textDiv.style.setProperty("text-overflow","ellipsis");
    }
...
//        })
    ...
    com.vizengine.App = function(div,bundleOrMain,entry){
        ...
        (function(){
            ...
            document.onkeydown = function(event) {
                ...
                var focusableViews = [];
                getFocusableViews(self.nativeRootView.div.virtualView,focusableViews);
                if(event.keyCode == 37) {
                    // left
                    ...
                    if(self.nativeRootView.div.virtualView.focusedView != null) {
                        self.nativeRootView.div.virtualView.focusedView.triggerClick();
                    }
                }
                ...
                self.nativeRootView.div.virtualView.dispatchKey(keyEvent);
        ...
        (function() {
            ...
            var updateHover = function(x,y) {
                ...
                var views = [];
                self.nativeRootView.div.virtualView.findViewsByXY(x, y, views);
            ...
            function touch(e) {
                ...
                var touches = [];
                var rootView = self.nativeRootView.div.virtualView;
                ...
                switch (event.type) {
                    case "touchstart":
                        ...
                        rootView.nativeTouch(0,touches);
                        break;
                    case "touchend":
                        for ( var i = 0; i < event.touches.length; i++) {
                            var t = event.touches[i];
                        ...
                        rootView.nativeTouch(2,touches);
                        break;
                    case "touchmove":
                        for ( var i = 0; i < event.touches.length; i++) {
                            var t = event.touches[i];
                        ...
                        rootView.nativeTouch(1,touches);
                        break;
                    case "mousedown":
                        if(useTouchEvent) {
                            break;
            ...
            var getScrollView = function(x,y,verticalScroll) {
                ...
                var scrollView = null;
                var view = self.nativeRootView.div.virtualView.findViewByXY(x,y);
                while(view != null) {
    ...
    nativeSetStatusBarHidden = function (hidden) {
