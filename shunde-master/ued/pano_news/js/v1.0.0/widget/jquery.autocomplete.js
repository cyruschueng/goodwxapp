...
(function($){
    ...
    var _setupSearchView = function(){
        ...
        if(that.option.follow){
            this.inputView.after(this.searchView);
        }else{
            this.searchView.appendTo(document.body);
        }
        this.searchView.on('mouseenter', 'li', function(){
    ...
    var _locateSearchView = function(){
        ...
        if(this.option.follow){
            this.searchView.css({
                "z-index": "99",
                "top": top - this.inputView.offset().top +"px",
                "left": "0px",
                "overflow-x": "hidden"
            });
        }else{
    ...
    var _ajaxSend = function(keyword, callback){
    ...
    var _search = function(){
        ...
        if (loadDataFlag){
            if ($.isArray(this.option.data)) {
                ...
                try{
                    _ajaxSend.apply(this, [keyword, function(data){
