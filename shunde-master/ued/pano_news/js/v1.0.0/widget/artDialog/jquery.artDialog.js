...
(function($, window, undefined) {
    ...
    var artDialog = function(config, ok, cancel) {
        ...
        if (config.ok) {
            config.button.push({
                ...
                callback: config.ok,
                focus: true,
                customerBtn: config.okClass || '',  //自定义按钮样式
            });
        };
        ...
        if (config.cancel) {
            config.button.push({
                ...
                customerBtn: config.cancelClass || '',  //自定义按钮样式
            });
        };
        ...
        */
        button: function() {
            ...
            var dom = this.dom,
                $buttons = dom.buttons,
                elem = $buttons[0],
                strongButton = 'but-border-blue-big',
                defaultBtn = 'btn-gray',
                listeners = this._listeners = this._listeners || {},
                ags = [].slice.call(arguments);

            var i = 0,
                val, value, id, isNewButton, button,customerBtn;

            for (; i < ags.length; i++) {

                val = ags[i];
                customerBtn = val.customerBtn||"";
                value = val.value;
                id = val.id || value;
    ...
    artDialog._templates =
        '<div class="d-outer" role="dialog" tabindex="-1" aria-labelledby="d-title-{id}" aria-describedby="d-content-{id}">' + '<table class="d-border">' + '<tbody>' + '<tr>' + '<td class="d-nw"></td>' + '<td class="d-n"></td>' + '<td class="d-ne"></td>' + '</tr>' + '<tr>' + '<td class="d-w"></td>' + '<td class="d-c">' + '<div class="d-inner">' + '<table class="d-dialog">' + '<tbody>' + '<tr>' + '<td class="d-header">' + '<div class="d-titleBar">' + '<div id="d-title-{id}" class="d-title"></div>' + '<a class="d-close" href="javascript:;" title="{cancelValue}">×</a>' + '</div>' + '</td>' + '</tr>' + '<tr>' + '<td class="d-main">' + '<div id="d-content-{id}" class="d-content"></div>' + '</td>' + '</tr>' + '<tr>' + '<td class="d-footer">' + '<div class="d-buttons"></div>' + '</td>' + '</tr>' + '</tbody>' + '</table>' + '</div>' + '</td>' + '<td class="d-e"></td>' + '</tr>' + '<tr>' + '<td class="d-sw"></td>' + '<td class="d-s"></td>' + '<td class="d-se"></td>' + '</tr>' + '</tbody>' + '</table>' + '</div>';
