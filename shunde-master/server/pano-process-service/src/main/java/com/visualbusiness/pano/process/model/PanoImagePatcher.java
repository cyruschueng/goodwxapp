...
/**
 * The persistent class for the PANO_IMAGE_PATCHER database table.
 * 
 */
@Entity
@Table(name="PANO_IMAGE_PATCHER")
public class PanoImagePatcher extends AbstractBaseEntity  {
