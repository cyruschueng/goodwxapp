...
Page({
  ...
  getDataList:function (){
    var that = this
    requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanShop/FenxiaoApi/fxrecord', { pagesize: that.data.pagesize, pagenum: that.data.pagenum }, (info) => {
      console.log(info)
      if (info == null) {
