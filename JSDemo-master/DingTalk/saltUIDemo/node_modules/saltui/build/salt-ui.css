...
.t-action-sheet-panel-title,
.t-action-sheet-panel-message,
.t-action-sheet-share-panel-title,
...
.t-action-sheet-share-panel-item-split {
  height: 10px;
  background: #fff;
}
.t-action-sheet-panel-item-cancel,
.t-action-sheet-share-panel-item-cancel {
  margin: 0;
  border-top: 1px solid #e4e4e4;
  color: #222;
...
.t-action-sheet-share-panel-item-list-split-line {
  border-top: 1px solid #e4e4e4;
  margin: 0 10px;
}
...
.t-action-sheet-share-panel-item-icon > img > svg,
.t-action-sheet-share-panel-item-icon > .t-icon > svg {
  width: 24px;
  height: 24px;
}
...
.hairline .t-action-sheet-panel-item-cancel,
.hairline .t-action-sheet-share-panel-item-cancel,
.hairline .t-action-sheet-panel-item,
.hairline .t-action-sheet-share-panel-item-list-split-line {
  border-width: 0.5px;
}
.t-avatar {
  border-radius: 50px;
...
.t-button-secondary {
  background: #fff;
  color: #f37327;
  border: 1px solid rgba(243,115,39,0.6);
}
.hairline .t-button-secondary {
  border: 0.5px solid rgba(243,115,39,0.6);
}
...
@font-face {
  font-family: 'iconfont'; /* project id 353381 */
...
.t-employee-field-foldable-pane {
  border-top: rgba(31,56,88,0.1) 1px solid;
  padding: 0 0 8px 0;
}
.hairline.dpr2 .t-employee-field-foldable-pane {
...
.hairline .t-field-layout-v-label {
  border-bottom: 0.5px solid #e3e3e3;
}
.t-field-layout-h-label,
.t-field-layout-v-label {
...
.t-photo-list {
  border-top: 1px solid rgba(31,56,88,0.1);
  padding: 4px 4px 30px 16px;
  width: 100%;
  overflow: hidden;
}
.hairline .t-photo-list {
  border-top: 0.5px solid rgba(31,56,88,0.1);
}
...
.t-timeline-header .t-timeline-header-dot.active {
  width: 18px;
  height: 18px;
  border: 2px solid rgba(243,115,39,0.4);
  background-color: #fff;
}
