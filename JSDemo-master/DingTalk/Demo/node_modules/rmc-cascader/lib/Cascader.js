    ...
    (0, _createClass3['default'])(Cascader, [{
        ...
        value: function getCols() {
            ...
            return childrenTree.map(function () {
                ...
                return _react2['default'].createElement(_Picker2['default'], { key: level, prefixCls: pickerPrefixCls, style: { flex: 1 }, disabled: disabled, indicatorStyle: indicatorStyle, pickerItemStyle: pickerItemStyle }, children.map(function (item) {
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(_MultiPicker2['default'], { style: multiStyle, prefixCls: prefixCls, className: className, selectedValue: this.state.value, rootNativeProps: rootNativeProps, onValueChange: this.onValueChange }, cols);
        }
    }]);
    return Cascader;
