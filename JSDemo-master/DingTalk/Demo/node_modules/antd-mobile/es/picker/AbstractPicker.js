...
var AbstractPicker = function (_React$Component) {
    ...
    _createClass(AbstractPicker, [{
        ...
        value: function render() {
            ...
            var popupMoreProps = {};
            if (cascade) {
                cascader = React.createElement(RMCCascader, { prefixCls: prefixCls, pickerPrefixCls: pickerPrefixCls, data: data, cols: cols, onChange: onPickerChange, pickerItemStyle: itemStyle, indicatorStyle: indicatorStyle });
            } else {
