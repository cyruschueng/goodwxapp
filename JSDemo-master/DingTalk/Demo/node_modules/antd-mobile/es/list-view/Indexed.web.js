    ...
    _createClass(MIndexedList, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                IndexedList,
                _extends({ ref: 'indexedList', sectionHeaderClassName: prefixCls + '-section-header ' + listPrefixCls + '-body', sectionBodyClassName: prefixCls + '-section-body ' + listPrefixCls + '-body' }, restProps, extraProps),
                this.props.children
            );
        }
    }]);
