        ...
        value: function render() {
            ...
            if (mode === 'number') {
                ...
                for (var i = 0; i < total; i++) {
                    arr.push(_react2['default'].createElement(_reactNative.View, { key: 'dot-' + i, style: [styles.pointStyle, styles.spaceStyle, i === current ? styles.pointActiveStyle : undefined] }));
                }
                markup = _react2['default'].createElement(
                    _reactNative.View,
