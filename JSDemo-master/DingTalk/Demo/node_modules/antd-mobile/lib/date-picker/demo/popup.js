...
var defaultDate = (0, _moment2['default'])().locale('zh-cn').utcOffset(8); /* tslint:disable:no-console */
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        ...
                        { defaultDate: defaultDate, value: this.state.value, mode: 'date', minDate: this.date1MinDate || (this.date1MinDate = (0, _moment2['default'])('2015-08-06', 'YYYY-MM-DD')), maxDate: this.date1MaxDate || (this.date1MaxDate = (0, _moment2['default'])('2016-12-06', 'YYYY-MM-DD')), onChange: this.onChange, format: function format(val) {
                                return val.fromNow();
                            } },
                        _react2['default'].createElement(
