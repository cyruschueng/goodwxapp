    ...
    (0, _createClass3['default'])(AbstractPicker, [{
        ...
        value: function render() {
            var _a = this.props,
                ...
                restProps = __rest(_a, ["children", "value", "extra", "okText", "dismissText", "popupPrefixCls", "itemStyle", "indicatorStyle", "cascade", "prefixCls", "pickerPrefixCls", "data", "cols", "onPickerChange"]);
            var cascader = void 0;
            var popupMoreProps = {};
            if (cascade) {
                cascader = _react2['default'].createElement(_Cascader2['default'], { prefixCls: prefixCls, pickerPrefixCls: pickerPrefixCls, data: data, cols: cols, onChange: onPickerChange, pickerItemStyle: itemStyle, indicatorStyle: indicatorStyle });
            } else {
