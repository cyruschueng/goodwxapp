        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        _antdMobile.Popover,
                        { ref: 'mc', name: 'm', style: { backgroundColor: '#eee' }, overlay: overlay, contextStyle: styles.contextStyle, overlayStyle: [styles.overlayStyle, _reactNative.Platform.OS === 'android' && styles.androidOverlayStyle], triggerStyle: styles.triggerStyle, onSelect: this.onSelect },
                        _react2['default'].createElement(
                            _reactNative.Text,
                            null,
                            '\u83DC\u5355'
