...
Page({
  ...
  data: {
    ...
    carnum: '',       //挂车牌
    carhangnum: '',    //无挂正车牌
    _number:false,     //用来提示填写地区车牌信息
    _hangNumber: false   //用来提示填写无挂地区车牌信息
  },
 ...
 /***********无挂状态开始***********************/
  ...
  noneKeyboard: function (e) {
    ...
    if (tapVal == '巛') {
      ...
      if (self.data.noneHangArr.length == 0) {
        this.specialBtn = false;
        this.tapNum = false;
        this.keyboardNoneValue = self.data.keyboard1;
      }
      ...
      self.setData({
        ...
        keyboardNoneValue: this.keyboardNoneValue,
        specialBtn: this.specialBtn,
        tapNum: this.tapNum
      });
      return false;
    ...
    if (self.data.noneHangArr.length == 0) {
      ...
      this.tapNum = false;
      this.specialBtn = true;
      this.keyboardNoneValue = self.data.keyboard2;
    } else {
      this.specialBtn = true;
      this.tapNum = true;
      this.keyboardNoneValue = self.data.keyboard2;
    ...
    self.setData({
      noneHangValue: self.data.noneHangValue,
      keyboardNoneValue: self.data.keyboard2,
      specialBtn: true,
      noneHangArr: self.data.noneHangArr
    });
  ...
  noneHang: function (e) {
    this.setData({
      ...
      textHangArr: [],   //挂车牌,
      noneKeyboard:true,
      keyboardNoneValue: this.data.keyboard1,
      specialBtn:false
