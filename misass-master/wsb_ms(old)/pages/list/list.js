...
Page({
  ...
  data: {
    ...
    day: date.getDate() ,
    value: [9999, 1, 1],
    stateArr:['全部','代付款','已付款','已生效','作废无效','已过期'],
    state: ['全部'],
    detailAerr:[
      {'title':'本月已付','num':'20单'},
    ...
    personArr:[
      { 'wsbNum': 'WSB1000010001', 'ZAorder': '众安保险订单号:WSB1000013001', 'ZAbail': '众安保险保单号 :W1140_EC105010001', 'carNum': '粤AJ22310g挂-234532', 'date': '2017-04-12 16:00', 'payDate': '支付时间:2017-04-11 17:00', 'money': '￥100', 'payState': '已付款', 'payClass': 'green', 'changeState': '订单完成代生效', 'orderPerson':'下单人: 陈三'},
