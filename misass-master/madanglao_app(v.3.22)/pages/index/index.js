...
Page({
 ...
 //点击蒙版时候让总价详情隐藏
  ...
  addCount(e) {                                              //分别获取所有数组的index值  
    ...
    // console.log(teaArray[i].listArr[j].sizeArr[index].money)
    detailArray.push({
        name: teaArray[i].listArr[j].sizeArr[index].cupZize + teaArray[i].listArr[j].teaName,
        //price: teaArray[i].listArr[j].money,    //价格一致时候
        price: teaArray[i].listArr[j].sizeArr[index].money,  //同样总价格
        num: teaArray[i].listArr[j].sizeArr[index].num,
        simileTotal : (teaArray[i].listArr[j].sizeArr[index].money)*(teaArray[i].listArr[j].sizeArr[index].num),
    })
  ...
  detailAdd(e) {                                                   //分别获取所有数组的index值  
    ...
    detailArray[index].simileTotal = detailArray[index].price * num
    this.setData({
