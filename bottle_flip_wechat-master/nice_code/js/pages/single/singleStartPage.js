define("js/pages/single/singleStartPage.js", (dataAndEvents, deepDataAndEvents, obj) => {
  /**
   * @param {?} dataAndEvents
   * @param {Function} obj
   * @return {undefined}
  ...
  const value = (() => {
    ...
    return HOP(save, [{
       ...
       */
      value() {
        const model = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        model.hideRank = this.model.firstBlood;
        if (this.full2D) {
          this.full2D.showStartPage(model);
        }
        /** @type {boolean} */
        this.model.firstBlood = false;
      }
    }, {
      key : "hide",
      /**
