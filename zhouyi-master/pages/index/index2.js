...
Page({
  ...
  formSubmit: function (e) {
    ...
    let a = ["txtFname=" + escape(that.data.txtFname) + "&=txtLname" + escape(that.data.txtLname) + "&sex=" + that.data.sex + "&yinyangli=" + escape(that.data.date_type) + "&years=" + escape(that.data.years) + "&months=" + escape(that.data.months) + "&days=" + escape(that.data.days) + "&sc=" + escape(that.data.sc) + "&hours=" + escape(that.data.hours) + "&minutes=" + escape(that.data.minutes) + "&prov=" + escape(that.data.index1) + "&city=" + escape(that.data.citysid) + "&county=" + escape(that.data.countysid) + "&act=addsm" + "&uid=0" + "&rt=" + escape(that.data.rt) + "&provstr=" + escape(that.data.provinces[that.data.index1].name) + "&citystr=" + escape(that.data.citys[that.data.index2].name) + "&countystr=" + escape(that.data.countys[that.data.index3].name)].join("");
    console.log("0000:", a);
