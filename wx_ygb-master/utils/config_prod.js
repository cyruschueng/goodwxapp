...
if (isProduction) {
    ...
    config.websocket_data_src = `http://cdn.s.weshaketv.com/ygb/images`;
   
    //査Api地址
    config.websocket_url = `wss://ygb.s.weshaketv.com/broadcast`;
    config.https_url = `https://ygb.s.weshaketv.com/broadcast`;


    //超哥Api地址
    config.zc_url = `https://ygb.s.weshaketv.com/broadcast`;
...
// 默认头像 
config.icon = `https://1251097942.cdn.myqcloud.com/1251097942/tv/scws/wozhidao/images/head/touxiang2.jpg`;
config.nickName = '匿名';
