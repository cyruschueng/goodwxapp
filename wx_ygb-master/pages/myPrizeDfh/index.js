    ...
    onLoad: function(options) {
        ...
        app.getWatermark((watermark) => {
            api.getUserEntityDetail(watermark, entityId, (res) => {
                var { advertiserName, advertiserIcon, entityIcon, entityName, userAddresss, userName, userPhone } = res.data;
                //少商品数量字段

                advertiserIcon = utils.getUrl(advertiserIcon);
                entityIcon = utils.getUrl(entityIcon);

                this.setData({ advertiserName, advertiserIcon, entityIcon, entityName, userAddresss, userName, userPhone });
            });
        });
    },
