...
// 达人文章管理
import appContentOutArticleIndex from "./components/app/content/outArticle/index.vue";//引入内容管理的达人文章管理首页
import appContentOutArticleAdd from "./components/app/content/outArticle/add.vue";//引入内容管理的达人文章编辑首页

// 达人权限管理
import appContentOutLimitIndex from "./components/app/content/outLimit/index.vue";//引入内容管理的达人权限管理首页
// import appContentOutLimitAdd from "./components/app/content/outLimit/add.vue";//引入内容管理的新增达人权限管理首页
//公告
import appContentNoticeIndex from "./components/app/content/notice/index.vue";//引入内容管理公告首页
import appContentNoticeAdd from "./components/app/content/notice/add.vue";//引入内容管理的新增公告
//评论管理中的文章评论
...
*/
let finalUrl = ajaxLink + 'picooc-background/aliyun/get?'+token;
$.ajax({
	type:'get',
	url:finalUrl,
			...
			children:[
				{
					path:'appRight',name:'appRight',components:{appRight:appRight},children:[
						...
						{path:'appContentOutArticleIndex',name:'appContentOutArticleIndex',component:appContentOutArticleIndex},
						{path:'appContentOutArticleAdd',name:'appContentOutArticleAdd',component:appContentOutArticleAdd},
						{path:'appContentOutLimitIndex',name:'appContentOutLimitIndex',component:appContentOutLimitIndex},
						{path:'appContentNoticeIndex',name:'appContentNoticeIndex',component:appContentNoticeIndex},
						{path:'appContentNoticeAdd',name:'appContentNoticeAdd',component:appContentNoticeAdd},
