                ...
                for(var j=0;j<optionLength;j++){
                    if(questionList[i].items[j].item == "其他"){
                        contentHtml +=  '<div value="'+j+'" index="'+questionList[i].items[j].id+'" class="radio_item other">'
                                        ...
                                        +'</div>'
                                        +'<div class="otherText">'
                                            +'<textarea id="textContent" maxlength="25"></textarea>'
                ...
                if(selectResult != ""){
                    ...
                    if($(".active").hasClass("yesSelect")){
                        ...
                        for(var i=0;i<otherSelect.length;i++){
                            otherSelect[i] = parseInt(otherSelect[i]);
                            $(".otherSelect .otherSelect_item").eq(otherSelect[i]).click();
                        }
    ...
    if(type == "radio"){
        ...
        if($(".content .active").eq(0).hasClass("yesSelect")){
            ...
            $(".otherContent .active").each(function(){
                items.push({ "itemId": $(this).attr("index"),"itemText": ""});
            });
