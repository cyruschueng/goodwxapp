				...
				if(data.code == 200){
					...
					if(data.resp.checkList.length>0){
						...
						for(var i=0;i<data.resp.checkList.length;i++){
							...
							var strDelete='';
							var shareStr='<a class="partRight-type1-share"  checkId="'+data.resp.checkList[i].id+'" checkRoleId="'+data.resp.checkList[i].roleId+'"><img src="http://cdn2.picooc.com/web/res/fatburn/image/cardShare/share.png" /></a>';
							if(hasDelete=="hasDelete"){
									...
									'<div class="col-xs-12 col-sm-12 partRight" part="'+(count*pageIndex1+parseInt(i))+'">'+
										'<div class="row partRight-paddingleft">'+
											...
											'<div class="col-xs-12 col-sm-12 partRight-type1">'+
												...
												'<span class="partRight-type1-msg" checkId="'+data.resp.checkList[i].id+'" replyId="0" replyRoleId="'+data.resp.checkList[i].roleId+'" partIndex="'+(count*pageIndex1+parseInt(i))+'"><img src="http://cdn2.picooc.com/web/res/fatburn/image/student/student-7.png" /></span>'+
											'</div>'+strMsgTotol+
										'</div>'+
									'</div>'+
								'</aside>';
