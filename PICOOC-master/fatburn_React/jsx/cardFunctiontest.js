...
//删除打卡记录方法
cardFunction.deletePart(deleteIndex,deleteCheckId,type){
	if(type==2){
...
cardFunction.setMessageStatus(replyId,searchLink,checkId,object,shareType){
    console.info(searchLink);
...
//添加评论方法
cardFunction.addmsg(dataAddMsg){
	if(msgBtn){
		msgBtn=false;
...
cardFunction.getKeyBoard(open,height){
