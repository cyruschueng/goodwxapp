...
var absoluteUrlTrainer="https://a.picooc.com/web/trainer1.7/";
...
if (window.location.host == "pm.picooc.com:444" || window.location.host == "pm.picooc.com:445" || window.location.host == "") {
	...
	var absoluteUrlTrainer="http://pm.picooc.com:9989/web/trainer1.7/";
	var absoluteUrl = "http://pm.picooc.com:9989" + locationStr;
}
	...
	var absoluteUrlTrainer="https://a.picooc.com:10000/web/trainer1.7/";
}
else {
...
////获得一周的运动计划
appFc.getWeekTrain = function (data) {
	if (getParamByUrl("os") == "android" && (typeof mobileApp != "undefined")) {
		mobileApp.getWeekTrain(data);
	} else if (getParamByUrl("os") == "iOS" && (typeof window.webkit != "undefined")) {
		iOSMobileAPP.getWeekTrain.postMessage(data);
	}
};
...
//唤起评论框
appFc.popupComment = function (data) {
	if (getParamByUrl("os") == "android" && (typeof mobileApp != "undefined")) {
		//mobileApp.popupComment(data);
		if((typeof mobileApp.popupComment != "undefined")){
			mobileApp.popupComment(data);
		}
	} else if (getParamByUrl("os") == "iOS" && (typeof window.webkit != "undefined")) {
		//iOSMobileAPP.popupComment.postMessage(data);
		if((typeof window.webkit.messageHandlers != "undefined")){
			if((typeof window.webkit.messageHandlers.popupComment != "undefined")){
				iOSMobileAPP.popupComment.postMessage(data);
			}
		}
	}
...
//返回评论状态
appFc.commentStatusCallback = function (data) {
	if (getParamByUrl("os") == "android" && (typeof mobileApp != "undefined")) {
		//mobileApp.commentStatusCallback(data);
		if((typeof mobileApp.commentStatusCallback != "undefined")){
			mobileApp.commentStatusCallback(data);
		}
	} else if (getParamByUrl("os") == "iOS" && (typeof window.webkit != "undefined")) {
		//iOSMobileAPP.commentStatusCallback.postMessage(data);
		if((typeof window.webkit.messageHandlers != "undefined")){
			if((typeof window.webkit.messageHandlers.commentStatusCallback != "undefined")){
				iOSMobileAPP.commentStatusCallback.postMessage(data);
			}
		}
	}
