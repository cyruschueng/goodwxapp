...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "jsv2/" + chunkId + ".js";
...
var Public_error = React.createClass({
    displayName: "Public_error",

    ErrorClick: function ErrorClick(event) {
    ...
    render: function render() {
        return React.createElement(
            "div",
            { className: "row errorAlert", ref: "errorAlert" },
            React.createElement(
                "div",
                { className: "col-xs-12 col-sm-12 error-main" },
                React.createElement(
                    "div",
                    { className: "row" },
                    React.createElement("div", { className: "col-xs-12 col-sm-12 error-main-t" }),
                    React.createElement(
                        "div",
                        { className: "col-xs-12 col-sm-12 error-main-btn" },
                        React.createElement(
                            "div",
                            { className: "row" },
                            React.createElement(
                                "div",
                                { className: "col-xs-12 col-sm-12 error-main-btn1", onClick: this.ErrorClick },
                                "\u6211\u77E5\u9053\u4E86"
                            )
                        )
                    )
