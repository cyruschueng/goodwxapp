...
;$(function(){
    ...
    var cookieName="";
    if(window.location.search.split("aid/")[1]!=undefined){
        cookieName=window.location.search.split("aid/")[1].split(".html")[0];
        var timeCookie=setInterval(function(){
            console.log(window.location.href);
            setCookie(cookieName,$(".ke-edit-iframe").contents().find(".ke-content").eq(0).html(),1);
            //$(".ke-edit-iframe").contents().find(".ke-content").eq(0).html("sssssss");
            console.log($(".ke-edit-iframe").contents().find(".ke-content").eq(0).html());
        },2000);
    }
    
    /*if(getCookie(cookieName)!="false" && getCookie(cookieName)!=""){
        setTimeout(function(){
            $(".ke-edit-iframe").contents().find(".ke-content").eq(0).html(getCookie(cookieName));
            console.log($(".ke-edit-iframe").contents().find(".ke-content").eq(0).html());
        },1000)
    }*/
