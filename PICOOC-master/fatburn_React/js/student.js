		...
		success:function(data){
			if(data.code == 200){
				...
				if(data.resp.wFlag!=undefined ){
					$(".info-change1-p2").eq(0).html("<span class=\"num\"></span>");
					$(".info-change1-p2").eq(1).html("<span class=\"num\"></span>");
					...
					$(".info-change1-p2").eq(0).html('<span class=\"num\">'+data.resp.wChange+'</span>');
					$(".info-change1-p2").eq(1).html('<span class=\"num\">'+data.resp.fChange+'</span>');
				}
