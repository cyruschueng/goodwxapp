...
function rightBtnShow(){
	if(getParamByUrl('webver')!="false" && getParamByUrl('webver')>1){
		if(getParamByUrl("os")=="android"){
		 	var data={
				rightImg: "http://cdn2.picooc.com/web/res/fatburn/image/icon/right1-an.png",//右上角图片
				function:"getControl"//右上角点击后需要调的h5的方法名
			};
	 	}else{
		 	var data={
		 		rightImg: "http://cdn2.picooc.com/web/res/fatburn/image/icon/right1-ios.png",
		...
		if(getParamByUrl("os")=="android"){
		 	var data={
				rightImg: "http://cdn2.picooc.com/web/res/fatburn/image/figureContrast/right1-an.png",//右上角图片
				function:"getControl"//右上角点击后需要调的h5的方法名
			};
	 	}else{
		 	var data={
		 		rightImg: "http://cdn2.picooc.com/web/res/fatburn/image/figureContrast/right1-ios.png",
				//rightImg: "http://cdn2.picooc.com/web/res/fatburn/image/figureContrast/share-right1.png",//右上角图片
				function:"getControl"//右上角点击后需要调的h5的方法名
			};
	 	}
