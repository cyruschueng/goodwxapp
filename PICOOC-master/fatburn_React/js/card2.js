										...
										'<div class="col-xs-12 col-sm-12 partRight">'+
											'<div class="row ">'+
												...
												'<div class="col-xs-12 col-sm-12 partRight-type1">'+strDelete+
													...
													'<span class="partRight-type1-msg" msgType="'+msgType+'" checkId="'+data.resp.checkList[i].id+'" replyId="0" replyRoleId="'+data.resp.checkList[i].roleId+'" partIndex="'+(count*pageIndex2+parseInt(i))+'"><img src="http://cdn2.picooc.com/web/res/fatburn/image/student/student-7.png" /></span>'+
												'</div>'+strMsgTotol+
											'</div>'+
										'</div>'+
									'</aside>';
