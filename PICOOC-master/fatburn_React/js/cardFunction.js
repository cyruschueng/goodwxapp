...
var cardTypeBg=["http://cdn2.picooc.com/web/res/fatburn/image/student/student-20.png","http://cdn2.picooc.com/web/res/fatburn/image/student/student-21.png","http://cdn2.picooc.com/web/res/fatburn/image/student/student-22.png","http://cdn2.picooc.com/web/res/fatburn/image/student/student-23.png","http://cdn2.picooc.com/web/res/fatburn/image/student/student-24.png"];
...
var cardTypeBg2=["http://cdn2.picooc.com/web/res/fatburn/image/cardShare/info-1.png","http://cdn2.picooc.com/web/res/fatburn/image/cardShare/info-2.png","http://cdn2.picooc.com/web/res/fatburn/image/cardShare/info-3.png","http://cdn2.picooc.com/web/res/fatburn/image/cardShare/info-4.png","http://cdn2.picooc.com/web/res/fatburn/image/cardShare/info-5.png"]
				...
				success:function(data){
					if(data.code == 200){
						...
						if($(".partRight-msg:eq("+index+") div").eq(0).hasClass("msgZan")){
							...
							if(data.resp.isCoach){
								$(".partRight-msg:eq("+index+")").prepend('<div class="row msgZan"><img src="http://cdn2.picooc.com/web/res/fatburn/image/student/student-6.png" /><a class="msgZanName2" targetRoleId="'+data.resp.praiseRoleId+'">'+data.resp.praiseRoleName+'</a></div>');
							}
							else{
								$(".partRight-msg:eq("+index+")").prepend('<div class="row msgZan"><img src="http://cdn2.picooc.com/web/res/fatburn/image/student/student-6.png" /><a class="msgZanName1" targetRoleId="'+data.resp.praiseRoleId+'">'+data.resp.praiseRoleName+'</a></div>');
							}
