...
/***/ function(module, exports, __webpack_require__) {
	...
	var DatePicker = __webpack_require__(159);
	...
	var App = React.createClass({
		...
		handleSelect: function handleSelect(time) {
	...
	ReactDOM.render(React.createElement(App, null), document.getElementById('react-box'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	    ( false ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory(__webpack_require__(1), __webpack_require__(158)) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(158)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : global.reactMobileDatePicker = factory(global.React, global.ReactDOM);
	    ...
	    var DatePickerItem = function (_Component) {
	        ...
	        DatePickerItem.prototype.renderDatepickerItem = function renderDatepickerItem(date, index) {
	            ...
	            return React__default.createElement('li', {
	                key: index,
	                className: className }, convertDate(date, this.props.format));
	        };
	        ...
	        DatePickerItem.prototype.render = function render() {
	            ...
	            return React__default.createElement('div', { className: 'datepicker-col-1' }, React__default.createElement('div', {
	                ref: function ref(viewport) {
	                    return _this3.viewport = viewport;
	                } // eslint-disable-line
	                , className: 'datepicker-viewport' }, React__default.createElement('div', { className: 'datepicker-wheel' }, React__default.createElement('ul', {
	                ref: 'scroll',
	                className: 'datepicker-scroll',
	                style: scrollStyle }, this.state.dates.map(this.renderDatepickerItem)))));
	        };
	    ...
	    var DatePicker = function (_Component) {
	        ...
	        DatePicker.prototype.render = function render() {
	            ...
	            return React__default.createElement('div', {
	                className: 'datepicker ' + themeClassName }, React__default.createElement('div', { className: 'datepicker-header' }, convertDate(value, 'YYYY/MM/DD')), React__default.createElement('div', { className: 'datepicker-content' }, React__default.createElement(DatePickerItem, {
	                value: value,
	                min: min,
	                max: max,
	                typeName: 'Year',
	                format: dateFormat[0],
	                onSelect: this.handleDateSelect }), React__default.createElement(DatePickerItem, {
	                value: value,
	                min: min,
	                max: max,
	                typeName: 'Month',
	                ...
	                typeName: 'Date',
	                format: dateFormat[2],
	                onSelect: this.handleDateSelect })), React__default.createElement('div', { className: 'datepicker-navbar' }, React__default.createElement('a', {
	                className: 'datepicker-navbar-btn',
	                onClick: this.handleFinishBtnClick }, '完成'), React__default.createElement('a', {
	                className: 'datepicker-navbar-btn',
	                onClick: this.props.onCancel }, '取消')));
	        };
	    ...
	    function EnhanceDatePicker(_ref) {
	        ...
	        return React__default.createElement('div', {
	            ...
	            className: 'datepicker-modal' }, React__default.createElement(DatePicker, props));
	    }
