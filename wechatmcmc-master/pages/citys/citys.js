...
Page({
    ...
    onLoad: function (options) {
      ...
      wx.showToast({
        ...
        // 获取数据
        wx.request({
          url: 'https://www.mcmchw.com/index.php?m=Home&c=Mcmc&a=jianlikucitys', //真实的接口地址
            data: {
            },
            method:'get',
            header: {
    ...
    scrollToViewFn: function (e) {
      ...
      var zimu = e.currentTarget.dataset.id; 
    ...
    wxSortPickerViewItemTap: function(e){
        ...
        if(token == 1){
            ...
            wx.redirectTo({
                url: '../jianliku/jianliku?city=' + city
            })
        }
