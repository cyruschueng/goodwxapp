 ...
 */
var tplurl = "http://c-htmls.yshfresh.com/api/tpl/";
var yshurl = "http://api2.yshfresh.com/api/ysh/";
var authurl = "http://api2.yshfresh.com/authority/";
var seturl = "http://f.yshfresh.com/";
 ...
 */
function ysh_msg(msg, time, callback) {
	var smsg = '',
		stime = 2000,
		scallback = null;
	var sh = $(window.parent.document).find('body').scrollTop() + 250 + 'px';
...
function setIframeHeight() {
	...
	//	$parent.find('body').animate({ "scrollTop": "0" }, 200);
}
...
function checkPermission() {
	if(!getuserInfo()[0]) {
		...
		//		getDataList(yshurl + "Admin_CheckPermission", {}, function(d) {
		//			if(d && d.state == 0 && d.aaData && d.aaData.length > 0) {} else {
		//				top.window.location.href = 'Admin_Login.html';
		//			}
		//		});
	}
