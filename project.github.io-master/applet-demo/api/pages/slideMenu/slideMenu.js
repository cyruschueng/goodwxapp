// pages/slideMenu/slideMenu.js
const MENU_WIDTH_SCALE = 0.82;  //menu_width_scale
const FAST_SPEED_SECOND = 300;  //fast_speed_secode
const FAST_SPEED_DISTANCE = 5;  //fast_speed_distance
const FAST_SPEED_EFF_Y = 50;    //fast_speed_eff_y
const app = getApp();
