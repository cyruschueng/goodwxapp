  ...
  onShow: function () {
    ...
    setList: function(data){
      ...
      data.forEach(function(item,index){
          //替换一些不必要的大信息
          let reg = new RegExp(item.ad_info.province + item.ad_info.city + item.ad_info.district);
          let briefAddr = item.address.replace(reg,"");
          //组装数组
          result.push({
    ...
    tapItem: function(e){
        ...
        let toilet = that.findMarkerById(id);
        //跳转传输的值
        var param = {
            //基本的信息
