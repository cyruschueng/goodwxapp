<template>
	<el-table :data="userData" border style="width: 100%">
		...
		<el-table-column label="操作">
			<template scope="scope">
				<el-button :plain="true" size="small" type="success" @click="agree(scope.$index, scope.row)"
				:disabled="scope.row.auth_flag===1?true:false">同意</el-button>
				<el-button :plain="true" size="small" type="danger" @click="refuse(scope.$index, scope.row)"
				:disabled="scope.row.auth_flag===1?true:false">拒绝</el-button>
				<el-button :plain="true" size="small" type="danger" @click="refuse(scope.$index, scope.row)"
				:disabled="scope.row.auth_flag===2?true:false">移除</el-button>
			</template>
		</el-table-column>
	</el-table>
</template>
