...
Page({
  ...
  getMycollection: function (isShowLoading) {
    ...
    requestUtil.get(_DuoguanData.duoguan_host_api_url + "/index.php?s=/addon/DuoguanBigCms/Api/myPayArticleList.html", requestData, (data) => {
      console.log(data)
      if (data == null || data == '') {
  ...
  onPullDownRefresh: function () {
    var that = this;
    that.setData({ this_page_size: 1, c_data: [] });
    that.getMycollection();//请求我的文章列表
  },
  //触底加载
  onReachBottom: function () {
    ...
    if (that.data.is_load_more == false) {
      ...
      that.getMycollection(true);//请求我的文章列表
    }
  },
